...
#endif
#ifdef GENERATOR_FILE
extern int flag_disable_hsa_gridification;
#else
  int x_flag_disable_hsa_gridification;
#define flag_disable_hsa_gridification global_options.x_flag_disable_hsa_gridification
#endif
#ifdef GENERATOR_FILE
...
enum opt_code
{
  ...
  OPT_fchkp_check_incomplete_type = 549,     /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 550,                /* -fchkp-check-read */
  OPT_fchkp_check_write = 551,               /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 552,/* -fchkp-first-field-has-own-bounds */
  OPT_fchkp_instrument_calls = 553,          /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 554,    /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 555,             /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 556, /* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 557,                  /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 558,              /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 559,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 560, /* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 561,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 562,         /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 563,   /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 564,              /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 565,/* -fchkp-zero-input-bounds-for-main */
  OPT_fcilkplus = 566,                       /* -fcilkplus */
  OPT_fclasspath_ = 567,                     /* -fclasspath= */
  OPT_fcoarray_ = 568,                       /* -fcoarray= */
  OPT_fcombine_stack_adjustments = 569,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 570,                         /* -fcommon */
  OPT_fcompare_debug = 571,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 572,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 573,                 /* -fcompare-debug= */
  OPT_fcompare_elim = 574,                   /* -fcompare-elim */
  OPT_fcompile_resource_ = 575,              /* -fcompile-resource= */
  OPT_fconcepts = 576,                       /* -fconcepts */
  OPT_fcond_mismatch = 577,                  /* -fcond-mismatch */
  OPT_fconserve_space = 578,                 /* -fconserve-space */
  OPT_fconserve_stack = 579,                 /* -fconserve-stack */
  OPT_fconstant_string_class_ = 580,         /* -fconstant-string-class= */
  OPT_fconstexpr_depth_ = 581,               /* -fconstexpr-depth= */
  OPT_fconvert_ = 582,                       /* -fconvert= */
  OPT_fcprop_registers = 583,                /* -fcprop-registers */
  OPT_fcray_pointer = 584,                   /* -fcray-pointer */
  OPT_fcrossjumping = 585,                   /* -fcrossjumping */
  OPT_fcse_follow_jumps = 586,               /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 587, */          /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 588,               /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 589,               /* -fcx-limited-range */
  OPT_fd_lines_as_code = 590,                /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 591,            /* -fd-lines-as-comments */
  OPT_fdata_sections = 592,                  /* -fdata-sections */
  OPT_fdbg_cnt_list = 593,                   /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 594,                       /* -fdbg-cnt= */
  OPT_fdce = 595,                            /* -fdce */
  OPT_fdebug_cpp = 596,                      /* -fdebug-cpp */
  OPT_fdebug_prefix_map_ = 597,              /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 598,            /* -fdebug-types-section */
  ...
  OPT_fdiagnostics_show_caret = 614,         /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_location_ = 615,     /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 616,        /* -fdiagnostics-show-option */
  OPT_fdirectives_only = 617,                /* -fdirectives-only */
  OPT_fdisable_ = 618,                       /* -fdisable- */
  OPT_fdisable_assertions = 619,             /* -fdisable-assertions */
  OPT_fdisable_assertions_ = 620,            /* -fdisable-assertions= */
  OPT_fdisable_hsa_gridification = 621,      /* -fdisable-hsa-gridification */
  ...
  OPT_flive_range_shrinkage = 787,           /* -flive-range-shrinkage */
  ...
  OPT_fmain_ = 807,                          /* -fmain= */
  OPT_fmath_errno = 808,                     /* -fmath-errno */
  OPT_fmax_array_constructor_ = 809,         /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 810,                    /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 811,         /* -fmax-identifier-length= */
  OPT_fmax_stack_var_size_ = 812,            /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 813,          /* -fmax-subrecord-length= */
  OPT_fmem_report = 814,                     /* -fmem-report */
  OPT_fmem_report_wpa = 815,                 /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 816,            /* -fmerge-all-constants */
  OPT_fmerge_constants = 817,                /* -fmerge-constants */
  OPT_fmerge_debug_strings = 818,            /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 819,                /* -fmessage-length= */
  OPT_fmodule_private = 820,                 /* -fmodule-private */
  OPT_fmodulo_sched = 821,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 822,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 823,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 824,                  /* -fms-extensions */
  /* OPT_fmudflap = 825, */                  /* -fmudflap */
  /* OPT_fmudflapir = 826, */                /* -fmudflapir */
  /* OPT_fmudflapth = 827, */                /* -fmudflapth */
  /* OPT_fname_mangling_version_ = 828, */   /* -fname-mangling-version- */
  /* OPT_fnew_abi = 829, */                  /* -fnew-abi */
  OPT_fnext_runtime = 830,                   /* -fnext-runtime */
  OPT_fnil_receivers = 831,                  /* -fnil-receivers */
  /* OPT_fno_vect_cost_model = 832, */       /* -fno-vect-cost-model */
  ...
  OPT_fopenmp = 849,                         /* -fopenmp */
  OPT_fopenmp_simd = 850,                    /* -fopenmp-simd */
  OPT_foperator_names = 851,                 /* -foperator-names */
  OPT_fopt_info = 852,                       /* -fopt-info */
  OPT_fopt_info_ = 853,                      /* -fopt-info- */
  /* OPT_foptimize_register_move = 854, */   /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 855,         /* -foptimize-sibling-calls */
  OPT_foptimize_static_class_initialization = 856,/* -foptimize-static-class-initialization */
  OPT_foptimize_strlen = 857,                /* -foptimize-strlen */
  /* OPT_foptional_diags = 858, */           /* -foptional-diags */
  OPT_foutput_class_dir_ = 859,              /* -foutput-class-dir= */
  OPT_fpack_derived = 860,                   /* -fpack-derived */
  OPT_fpack_struct = 861,                    /* -fpack-struct */
  OPT_fpack_struct_ = 862,                   /* -fpack-struct= */
  OPT_fpartial_inlining = 863,               /* -fpartial-inlining */
  OPT_fpcc_struct_return = 864,              /* -fpcc-struct-return */
  OPT_fpch_deps = 865,                       /* -fpch-deps */
  OPT_fpch_preprocess = 866,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 867,                     /* -fpeel-loops */
  OPT_fpeephole = 868,                       /* -fpeephole */
  OPT_fpeephole2 = 869,                      /* -fpeephole2 */
  OPT_fpermissive = 870,                     /* -fpermissive */
  OPT_fpic = 871,                            /* -fpic */
  OPT_fpie = 872,                            /* -fpie */
  OPT_fplan9_extensions = 873,               /* -fplan9-extensions */
  OPT_fplt = 874,                            /* -fplt */
  OPT_fplugin_arg_ = 875,                    /* -fplugin-arg- */
  OPT_fplugin_ = 876,                        /* -fplugin= */
  OPT_fpost_ipa_mem_report = 877,            /* -fpost-ipa-mem-report */
  OPT_fpre_ipa_mem_report = 878,             /* -fpre-ipa-mem-report */
  OPT_fpredictive_commoning = 879,           /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 880,           /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 881,                   /* -fpreprocessed */
  OPT_fpretty_templates = 882,               /* -fpretty-templates */
  OPT_fprofile = 883,                        /* -fprofile */
  OPT_fprofile_arcs = 884,                   /* -fprofile-arcs */
  OPT_fprofile_correction = 885,             /* -fprofile-correction */
  OPT_fprofile_dir_ = 886,                   /* -fprofile-dir= */
  OPT_fprofile_generate = 887,               /* -fprofile-generate */
  OPT_fprofile_generate_ = 888,              /* -fprofile-generate= */
  OPT_fprofile_reorder_functions = 889,      /* -fprofile-reorder-functions */
  OPT_fprofile_report = 890,                 /* -fprofile-report */
  OPT_fprofile_use = 891,                    /* -fprofile-use */
  OPT_fprofile_use_ = 892,                   /* -fprofile-use= */
  OPT_fprofile_values = 893,                 /* -fprofile-values */
  OPT_fprotect_parens = 894,                 /* -fprotect-parens */
  OPT_frandom_seed = 895,                    /* -frandom-seed */
  OPT_frandom_seed_ = 896,                   /* -frandom-seed= */
  OPT_frange_check = 897,                    /* -frange-check */
  OPT_freal_4_real_10 = 898,                 /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 899,                 /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 900,                  /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 901,                 /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 902,                 /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 903,                  /* -freal-8-real-4 */
  OPT_frealloc_lhs = 904,                    /* -frealloc-lhs */
  OPT_freciprocal_math = 905,                /* -freciprocal-math */
  OPT_frecord_gcc_switches = 906,            /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 907,                /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 908,                /* -frecord-marker=8 */
  OPT_frecursive = 909,                      /* -frecursive */
  OPT_freduced_reflection = 910,             /* -freduced-reflection */
  OPT_free = 911,                            /* -free */
  OPT_freg_struct_return = 912,              /* -freg-struct-return */
  /* OPT_fregmove = 913, */                  /* -fregmove */
  OPT_frename_registers = 914,               /* -frename-registers */
  OPT_freorder_blocks = 915,                 /* -freorder-blocks */
  OPT_freorder_blocks_algorithm_ = 916,      /* -freorder-blocks-algorithm= */
  OPT_freorder_blocks_and_partition = 917,   /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 918,              /* -freorder-functions */
  OPT_frepack_arrays = 919,                  /* -frepack-arrays */
  OPT_freplace_objc_classes = 920,           /* -freplace-objc-classes */
  OPT_frepo = 921,                           /* -frepo */
  OPT_freport_bug = 922,                     /* -freport-bug */
  OPT_frequire_return_statement = 923,       /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 924,           /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 925, */           /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 926,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 927,                    /* -fresolution= */
  OPT_frounding_math = 928,                  /* -frounding-math */
  OPT_frtti = 929,                           /* -frtti */
  OPT_fsanitize_recover = 930,               /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 931,              /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 932,             /* -fsanitize-sections= */
  OPT_fsanitize_undefined_trap_on_error = 933,/* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 934,                      /* -fsanitize= */
  OPT_fsaw_java_file = 935,                  /* -fsaw-java-file */
  OPT_fsched_critical_path_heuristic = 936,  /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 937,      /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 938,          /* -fsched-group-heuristic */
  OPT_fsched_interblock = 939,               /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 940,      /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 941,                 /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 942,           /* -fsched-rank-heuristic */
  OPT_fsched_spec = 943,                     /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 944,      /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 945,                /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 946,      /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 947,            /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 948,        /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 949,       /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 950,           /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 951,                 /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 952,         /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 953, */        /* -fsched2-use-traces */
  OPT_fschedule_fusion = 954,                /* -fschedule-fusion */
  OPT_fschedule_insns = 955,                 /* -fschedule-insns */
  OPT_fschedule_insns2 = 956,                /* -fschedule-insns2 */
  OPT_fsecond_underscore = 957,              /* -fsecond-underscore */
  OPT_fsection_anchors = 958,                /* -fsection-anchors */
  /* OPT_fsee = 959, */                      /* -fsee */
  OPT_fsel_sched_pipelining = 960,           /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 961,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 962, /* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 963,           /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 964,          /* -fselective-scheduling2 */
  OPT_fsemantic_interposition = 965,         /* -fsemantic-interposition */
  OPT_fshort_double = 966,                   /* -fshort-double */
  OPT_fshort_enums = 967,                    /* -fshort-enums */
  OPT_fshort_wchar = 968,                    /* -fshort-wchar */
  OPT_fshow_column = 969,                    /* -fshow-column */
  OPT_fshrink_wrap = 970,                    /* -fshrink-wrap */
  OPT_fsign_zero = 971,                      /* -fsign-zero */
  OPT_fsignaling_nans = 972,                 /* -fsignaling-nans */
  OPT_fsigned_bitfields = 973,               /* -fsigned-bitfields */
  OPT_fsigned_char = 974,                    /* -fsigned-char */
  OPT_fsigned_zeros = 975,                   /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 976,               /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 977,      /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 978,             /* -fsized-deallocation */
  OPT_fsource_filename_ = 979,               /* -fsource-filename= */
  OPT_fsource_ = 980,                        /* -fsource= */
  OPT_fsplit_ivs_in_unroller = 981,          /* -fsplit-ivs-in-unroller */
  OPT_fsplit_stack = 982,                    /* -fsplit-stack */
  OPT_fsplit_wide_types = 983,               /* -fsplit-wide-types */
  /* OPT_fsquangle = 984, */                 /* -fsquangle */
  OPT_fssa_phiopt = 985,                     /* -fssa-phiopt */
  OPT_fstack_arrays = 986,                   /* -fstack-arrays */
  /* OPT_fstack_check = 987, */              /* -fstack-check */
  OPT_fstack_check_ = 988,                   /* -fstack-check= */
  OPT_fstack_limit = 989,                    /* -fstack-limit */
  OPT_fstack_limit_register_ = 990,          /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 991,            /* -fstack-limit-symbol= */
  OPT_fstack_protector = 992,                /* -fstack-protector */
  OPT_fstack_protector_all = 993,            /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 994,       /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 995,         /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 996,                   /* -fstack-reuse= */
  OPT_fstack_usage = 997,                    /* -fstack-usage */
  OPT_fstats = 998,                          /* -fstats */
  OPT_fstdarg_opt = 999,                     /* -fstdarg-opt */
  OPT_fstore_check = 1000,                   /* -fstore-check */
  /* OPT_fstrength_reduce = 1001, */         /* -fstrength-reduce */
  OPT_fstrict_aliasing = 1002,               /* -fstrict-aliasing */
  OPT_fstrict_enums = 1003,                  /* -fstrict-enums */
  OPT_fstrict_overflow = 1004,               /* -fstrict-overflow */
  /* OPT_fstrict_prototype = 1005, */        /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 1006,     /* -fstrict-volatile-bitfields */
  OPT_fsync_libcalls = 1007,                 /* -fsync-libcalls */
  OPT_fsyntax_only = 1008,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1009,                      /* -ftabstop= */
  /* OPT_ftarget_help = 1010, */             /* -ftarget-help */
  OPT_ftarget_ = 1011,                       /* -ftarget= */
  OPT_ftemplate_backtrace_limit_ = 1012,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1013, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1014,               /* -ftemplate-depth= */
  OPT_ftest_coverage = 1015,                 /* -ftest-coverage */
  /* OPT_fthis_is_variable = 1016, */        /* -fthis-is-variable */
  OPT_fthread_jumps = 1017,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1018,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1019,                   /* -ftime-report */
  OPT_ftls_model_ = 1020,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1021,              /* -ftoplevel-reorder */
  OPT_ftracer = 1022,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1023,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1024,        /* -ftrack-macro-expansion= */
  OPT_ftrapping_math = 1025,                 /* -ftrapping-math */
  OPT_ftrapv = 1026,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1027,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1028,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1029,                      /* -ftree-ccp */
  OPT_ftree_ch = 1030,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1031, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1032,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1033,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1034, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1035,                   /* -ftree-cselim */
  OPT_ftree_dce = 1036,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1037,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1038,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1039,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1040,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1041, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1042,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1043,          /* -ftree-loop-if-convert */
  OPT_ftree_loop_if_convert_stores = 1044,   /* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1045,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1046,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1047, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1048,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1049,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1050,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1051,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1052,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1053,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1054,                      /* -ftree-pre */
  OPT_ftree_pta = 1055,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1056,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1057, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1058,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1059,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1060,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1061,                     /* -ftree-slsr */
  OPT_ftree_sra = 1062,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1063, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1064, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1065,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1066,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1067,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1068, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1069,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1070, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1071,                      /* -ftree-vrp */
  OPT_funderscoring = 1072,                  /* -funderscoring */
  OPT_funit_at_a_time = 1073,                /* -funit-at-a-time */
  OPT_funroll_all_loops = 1074,              /* -funroll-all-loops */
  OPT_funroll_loops = 1075,                  /* -funroll-loops */
  OPT_funsafe_loop_optimizations = 1076,     /* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1077,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1078,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1079,                 /* -funsigned-char */
  OPT_funswitch_loops = 1080,                /* -funswitch-loops */
  OPT_funwind_tables = 1081,                 /* -funwind-tables */
  OPT_fuse_atomic_builtins = 1082,           /* -fuse-atomic-builtins */
  OPT_fuse_boehm_gc = 1083,                  /* -fuse-boehm-gc */
  OPT_fuse_cxa_atexit = 1084,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1085,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_divide_subroutine = 1086,         /* -fuse-divide-subroutine */
  OPT_fuse_ld_bfd = 1087,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1088,                   /* -fuse-ld=gold */
  OPT_fuse_linker_plugin = 1089,             /* -fuse-linker-plugin */
  OPT_fvar_tracking = 1090,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1091,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1092,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1093,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1094,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1095, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1096,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1097,                   /* -fverbose-asm */
  /* OPT_fversion = 1098, */                 /* -fversion */
  OPT_fvisibility_inlines_hidden = 1099,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1100,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1101,                   /* -fvisibility= */
  OPT_fvpt = 1102,                           /* -fvpt */
  /* OPT_fvtable_gc = 1103, */               /* -fvtable-gc */
  /* OPT_fvtable_thunks = 1104, */           /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1105,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1106,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1107,                     /* -fvtv-debug */
  OPT_fweak = 1108,                          /* -fweak */
  OPT_fweb = 1109,                           /* -fweb */
  /* OPT_fwhole_file = 1110, */              /* -fwhole-file */
  OPT_fwhole_program = 1111,                 /* -fwhole-program */
  OPT_fwide_exec_charset_ = 1112,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1113,             /* -fworking-directory */
  OPT_fwpa = 1114,                           /* -fwpa */
  OPT_fwpa_ = 1115,                          /* -fwpa= */
  OPT_fwrapv = 1116,                         /* -fwrapv */
  /* OPT_fxref = 1117, */                    /* -fxref */
  /* OPT_fzee = 1118, */                     /* -fzee */
  OPT_fzero_initialized_in_bss = 1119,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1120,                     /* -fzero-link */
  OPT_g = 1121,                              /* -g */
  OPT_gant = 1122,                           /* -gant */
  OPT_gcoff = 1123,                          /* -gcoff */
  OPT_gdwarf = 1124,                         /* -gdwarf */
  OPT_gdwarf_ = 1125,                        /* -gdwarf- */
  OPT_gen_decls = 1126,                      /* -gen-decls */
  OPT_ggdb = 1127,                           /* -ggdb */
  OPT_ggnu_pubnames = 1128,                  /* -ggnu-pubnames */
  OPT_gnat = 1129,                           /* -gnat */
  OPT_gnatO = 1130,                          /* -gnatO */
  OPT_gno_pubnames = 1131,                   /* -gno-pubnames */
  OPT_gno_record_gcc_switches = 1132,        /* -gno-record-gcc-switches */
  OPT_gno_split_dwarf = 1133,                /* -gno-split-dwarf */
  OPT_gno_strict_dwarf = 1134,               /* -gno-strict-dwarf */
  OPT_gpubnames = 1135,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1136,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1137,                   /* -gsplit-dwarf */
  OPT_gstabs = 1138,                         /* -gstabs */
  OPT_gstabs_ = 1139,                        /* -gstabs+ */
  OPT_gstrict_dwarf = 1140,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1141,                        /* -gtoggle */
  OPT_gvms = 1142,                           /* -gvms */
  OPT_gxcoff = 1143,                         /* -gxcoff */
  OPT_gxcoff_ = 1144,                        /* -gxcoff+ */
  OPT_gz = 1145,                             /* -gz */
  OPT_gz_ = 1146,                            /* -gz= */
  OPT_h = 1147,                              /* -h */
  OPT_idirafter = 1148,                      /* -idirafter */
  OPT_imacros = 1149,                        /* -imacros */
  OPT_imultiarch = 1150,                     /* -imultiarch */
  OPT_imultilib = 1151,                      /* -imultilib */
  OPT_include = 1152,                        /* -include */
  OPT_iplugindir_ = 1153,                    /* -iplugindir= */
  OPT_iprefix = 1154,                        /* -iprefix */
  OPT_iquote = 1155,                         /* -iquote */
  OPT_isysroot = 1156,                       /* -isysroot */
  OPT_isystem = 1157,                        /* -isystem */
  OPT_iwithprefix = 1158,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1159,              /* -iwithprefixbefore */
  OPT_k8 = 1160,                             /* -k8 */
  OPT_l = 1161,                              /* -l */
  OPT_lang_asm = 1162,                       /* -lang-asm */
  OPT_m128bit_long_double = 1163,            /* -m128bit-long-double */
  OPT_m16 = 1164,                            /* -m16 */
  OPT_m32 = 1165,                            /* -m32 */
  OPT_m3dnow = 1166,                         /* -m3dnow */
  OPT_m3dnowa = 1167,                        /* -m3dnowa */
  OPT_m64 = 1168,                            /* -m64 */
  OPT_m80387 = 1169,                         /* -m80387 */
  OPT_m8bit_idiv = 1170,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1171,             /* -m96bit-long-double */
  OPT_mabi_ = 1172,                          /* -mabi= */
  OPT_mabm = 1173,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1174,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1175,                 /* -maddress-mode= */
  OPT_madx = 1176,                           /* -madx */
  OPT_maes = 1177,                           /* -maes */
  OPT_malign_data_ = 1178,                   /* -malign-data= */
  OPT_malign_double = 1179,                  /* -malign-double */
  OPT_malign_functions_ = 1180,              /* -malign-functions= */
  OPT_malign_jumps_ = 1181,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1182,                  /* -malign-loops= */
  OPT_malign_stringops = 1183,               /* -malign-stringops */
  OPT_mandroid = 1184,                       /* -mandroid */
  OPT_march_ = 1185,                         /* -march= */
  OPT_masm_ = 1186,                          /* -masm= */
  OPT_mavx = 1187,                           /* -mavx */
  OPT_mavx2 = 1188,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1189,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1190,  /* -mavx256-split-unaligned-store */
  OPT_mavx512bw = 1191,                      /* -mavx512bw */
  OPT_mavx512cd = 1192,                      /* -mavx512cd */
  OPT_mavx512dq = 1193,                      /* -mavx512dq */
  OPT_mavx512er = 1194,                      /* -mavx512er */
  OPT_mavx512f = 1195,                       /* -mavx512f */
  OPT_mavx512ifma = 1196,                    /* -mavx512ifma */
  OPT_mavx512pf = 1197,                      /* -mavx512pf */
  OPT_mavx512vbmi = 1198,                    /* -mavx512vbmi */
  OPT_mavx512vl = 1199,                      /* -mavx512vl */
  OPT_mbionic = 1200,                        /* -mbionic */
  OPT_mbmi = 1201,                           /* -mbmi */
  OPT_mbmi2 = 1202,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1203,                  /* -mbranch-cost= */
  OPT_mcld = 1204,                           /* -mcld */
  OPT_mclflushopt = 1205,                    /* -mclflushopt */
  OPT_mclwb = 1206,                          /* -mclwb */
  OPT_mcmodel_ = 1207,                       /* -mcmodel= */
  /* OPT_mcpu_ = 1208, */                    /* -mcpu= */
  OPT_mcrc32 = 1209,                         /* -mcrc32 */
  OPT_mcx16 = 1210,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1211,            /* -mdispatch-scheduler */
  OPT_mdump_tune_features = 1212,            /* -mdump-tune-features */
  OPT_mf16c = 1213,                          /* -mf16c */
  OPT_mfancy_math_387 = 1214,                /* -mfancy-math-387 */
  OPT_mfentry = 1215,                        /* -mfentry */
  OPT_mfma = 1216,                           /* -mfma */
  OPT_mfma4 = 1217,                          /* -mfma4 */
  OPT_mforce_drap = 1218,                    /* -mforce-drap */
  OPT_mfp_ret_in_387 = 1219,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1220,                       /* -mfpmath= */
  OPT_mfsgsbase = 1221,                      /* -mfsgsbase */
  /* OPT_mfused_madd = 1222, */              /* -mfused-madd */
  OPT_mfxsr = 1223,                          /* -mfxsr */
  OPT_mglibc = 1224,                         /* -mglibc */
  OPT_mhard_float = 1225,                    /* -mhard-float */
  OPT_mhle = 1226,                           /* -mhle */
  OPT_miamcu = 1227,                         /* -miamcu */
  OPT_mieee_fp = 1228,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1229,      /* -mincoming-stack-boundary= */
  OPT_minline_all_stringops = 1230,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1231,  /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 1232, */            /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 1233,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1234,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1235,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1236,                /* -mlong-double-80 */
  OPT_mlwp = 1237,                           /* -mlwp */
  OPT_mlzcnt = 1238,                         /* -mlzcnt */
  OPT_mmemcpy_strategy_ = 1239,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1240,              /* -mmemset-strategy= */
  OPT_mmmx = 1241,                           /* -mmmx */
  OPT_mmovbe = 1242,                         /* -mmovbe */
  OPT_mmpx = 1243,                           /* -mmpx */
  OPT_mms_bitfields = 1244,                  /* -mms-bitfields */
  OPT_mmusl = 1245,                          /* -mmusl */
  OPT_mmwaitx = 1246,                        /* -mmwaitx */
  OPT_mno_align_stringops = 1247,            /* -mno-align-stringops */
  OPT_mno_default = 1248,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1249,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1250,                  /* -mno-push-args */
  OPT_mno_red_zone = 1251,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1252,                       /* -mno-sse4 */
  OPT_mnop_mcount = 1253,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 1254,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1255,                          /* -mpc32 */
  OPT_mpc64 = 1256,                          /* -mpc64 */
  OPT_mpc80 = 1257,                          /* -mpc80 */
  OPT_mpclmul = 1258,                        /* -mpclmul */
  OPT_mpcommit = 1259,                       /* -mpcommit */
  OPT_mpopcnt = 1260,                        /* -mpopcnt */
  OPT_mprefer_avx128 = 1261,                 /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 1262,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1263,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1264,                        /* -mprfchw */
  OPT_mpush_args = 1265,                     /* -mpush-args */
  ...
  OPT_msha = 1276,                           /* -msha */
  OPT_mskip_rax_setup = 1277,                /* -mskip-rax-setup */
  OPT_msoft_float = 1278,                    /* -msoft-float */
  OPT_msse = 1279,                           /* -msse */
  OPT_msse2 = 1280,                          /* -msse2 */
  OPT_msse2avx = 1281,                       /* -msse2avx */
  OPT_msse3 = 1282,                          /* -msse3 */
  OPT_msse4 = 1283,                          /* -msse4 */
  OPT_msse4_1 = 1284,                        /* -msse4.1 */
  OPT_msse4_2 = 1285,                        /* -msse4.2 */
  OPT_msse4a = 1286,                         /* -msse4a */
  /* OPT_msse5 = 1287, */                    /* -msse5 */
  OPT_msseregparm = 1288,                    /* -msseregparm */
  OPT_mssse3 = 1289,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1290,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_ = 1291,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1292,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1293,            /* -mstringop-strategy= */
  OPT_mstv = 1294,                           /* -mstv */
  OPT_mtbm = 1295,                           /* -mtbm */
  OPT_mtls_dialect_ = 1296,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1297,           /* -mtls-direct-seg-refs */
  OPT_mtune_ctrl_ = 1298,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1299,                         /* -mtune= */
  OPT_muclibc = 1300,                        /* -muclibc */
  OPT_mveclibabi_ = 1301,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1302,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1303,                    /* -mvzeroupper */
  OPT_mx32 = 1304,                           /* -mx32 */
  OPT_mxop = 1305,                           /* -mxop */
  OPT_mxsave = 1306,                         /* -mxsave */
  OPT_mxsavec = 1307,                        /* -mxsavec */
  OPT_mxsaveopt = 1308,                      /* -mxsaveopt */
  OPT_mxsaves = 1309,                        /* -mxsaves */
  OPT_n = 1310,                              /* -n */
  OPT_no_canonical_prefixes = 1311,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1312,              /* -no-integrated-cpp */
  OPT_no_pie = 1313,                         /* -no-pie */
  OPT_nocpp = 1314,                          /* -nocpp */
  OPT_nodefaultlibs = 1315,                  /* -nodefaultlibs */
  ...
  OPT_static_libgcj = 1357,                  /* -static-libgcj */
  ...
  OPT_time = 1407,                           /* -time */
  OPT_time_ = 1408,                          /* -time= */
  OPT_tno_android_cc = 1409,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1410,                 /* -tno-android-ld */
