...
enum opt_code
{
  ...
  OPT_mmmx = 1242,                           /* -mmmx */
  OPT_mmovbe = 1243,                         /* -mmovbe */
  OPT_mmpx = 1244,                           /* -mmpx */
  OPT_mms_bitfields = 1245,                  /* -mms-bitfields */
  OPT_mmusl = 1246,                          /* -mmusl */
  ...
  OPT_mpopcnt = 1261,                        /* -mpopcnt */
  OPT_mprefer_avx128 = 1262,                 /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 1263,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1264,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1265,                        /* -mprfchw */
  OPT_mpush_args = 1266,                     /* -mpush-args */
  OPT_mrdrnd = 1267,                         /* -mrdrnd */
  OPT_mrdseed = 1268,                        /* -mrdseed */
  OPT_mrecip = 1269,                         /* -mrecip */
  OPT_mrecip_ = 1270,                        /* -mrecip= */
  OPT_mrecord_mcount = 1271,                 /* -mrecord-mcount */
  OPT_mred_zone = 1272,                      /* -mred-zone */
  OPT_mregparm_ = 1273,                      /* -mregparm= */
  OPT_mrtd = 1274,                           /* -mrtd */
  OPT_mrtm = 1275,                           /* -mrtm */
  OPT_msahf = 1276,                          /* -msahf */
  OPT_msha = 1277,                           /* -msha */
  ...
  OPT_static_libgcj = 1358,                  /* -static-libgcj */
  OPT_static_libgfortran = 1359,             /* -static-libgfortran */
  OPT_static_libgo = 1360,                   /* -static-libgo */
  OPT_static_liblsan = 1361,                 /* -static-liblsan */
  OPT_static_libmpx = 1362,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1363,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1364,               /* -static-libstdc++ */
  OPT_static_libtsan = 1365,                 /* -static-libtsan */
  OPT_static_libubsan = 1366,                /* -static-libubsan */
  ...
  /* OPT_std_c89 = 1377, */                  /* -std=c89 */
  OPT_std_c90 = 1378,                        /* -std=c90 */
  OPT_std_c99 = 1379,                        /* -std=c99 */
  /* OPT_std_c9x = 1380, */                  /* -std=c9x */
  OPT_std_f2003 = 1381,                      /* -std=f2003 */
  OPT_std_f2008 = 1382,                      /* -std=f2008 */
  OPT_std_f2008ts = 1383,                    /* -std=f2008ts */
  OPT_std_f95 = 1384,                        /* -std=f95 */
  OPT_std_gnu = 1385,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1386, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1387, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1388,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1389,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1390, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1391, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1392,                    /* -std=gnu++1z */
  OPT_std_gnu__98 = 1393,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1394,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1395, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1396, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1397,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1398,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1399, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1400, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1401,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1402, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1403, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1404, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1405,                     /* -std=legacy */
  OPT_symbolic = 1406,                       /* -symbolic */
  OPT_t = 1407,                              /* -t */
  OPT_time = 1408,                           /* -time */
  OPT_time_ = 1409,                          /* -time= */
  OPT_tno_android_cc = 1410,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1411,                 /* -tno-android-ld */
  OPT_traditional = 1412,                    /* -traditional */
  OPT_traditional_cpp = 1413,                /* -traditional-cpp */
  OPT_trigraphs = 1414,                      /* -trigraphs */
  OPT_u = 1415,                              /* -u */
  OPT_undef = 1416,                          /* -undef */
  OPT_v = 1417,                              /* -v */
  OPT_version = 1418,                        /* -version */
  OPT_w = 1419,                              /* -w */
  OPT_wrapper = 1420,                        /* -wrapper */
  OPT_x = 1421,                              /* -x */
  OPT_z = 1422,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
