...
enum opt_code
{
  ...
  /* OPT_bootclasspath = 471, */             /* -bootclasspath */
  OPT_c = 472,                               /* -c */
  /* OPT_classpath = 473, */                 /* -classpath */
  OPT_coverage = 474,                        /* -coverage */
  OPT_cpp = 475,                             /* -cpp */
  OPT_cpp_ = 476,                            /* -cpp= */
  OPT_d = 477,                               /* -d */
  OPT_dumpbase = 478,                        /* -dumpbase */
  OPT_dumpdir = 479,                         /* -dumpdir */
  OPT_dumpmachine = 480,                     /* -dumpmachine */
  OPT_dumpspecs = 481,                       /* -dumpspecs */
  OPT_dumpversion = 482,                     /* -dumpversion */
  OPT_e = 483,                               /* -e */
  /* OPT_encoding = 484, */                  /* -encoding */
  OPT_export_dynamic = 485,                  /* -export-dynamic */
  OPT_extdirs = 486,                         /* -extdirs */
  /* OPT_fCLASSPATH_ = 487, */               /* -fCLASSPATH= */
  OPT_fPIC = 488,                            /* -fPIC */
  OPT_fPIE = 489,                            /* -fPIE */
  OPT_fRTS_ = 490,                           /* -fRTS= */
  OPT_fabi_compat_version_ = 491,            /* -fabi-compat-version= */
  OPT_fabi_version_ = 492,                   /* -fabi-version= */
  OPT_faccess_control = 493,                 /* -faccess-control */
  OPT_fada_spec_parent_ = 494,               /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 495,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 496,  /* -faggressive-loop-optimizations */
  OPT_falign_commons = 497,                  /* -falign-commons */
  OPT_falign_functions = 498,                /* -falign-functions */
  OPT_falign_functions_ = 499,               /* -falign-functions= */
  OPT_falign_jumps = 500,                    /* -falign-jumps */
  OPT_falign_jumps_ = 501,                   /* -falign-jumps= */
  OPT_falign_labels = 502,                   /* -falign-labels */
  OPT_falign_labels_ = 503,                  /* -falign-labels= */
  OPT_falign_loops = 504,                    /* -falign-loops */
  OPT_falign_loops_ = 505,                   /* -falign-loops= */
  OPT_fall_intrinsics = 506,                 /* -fall-intrinsics */
  /* OPT_fall_virtual = 507, */              /* -fall-virtual */
  OPT_fallow_leading_underscore = 508,       /* -fallow-leading-underscore */
  OPT_fallow_parameterless_variadic_functions = 509,/* -fallow-parameterless-variadic-functions */
  /* OPT_falt_external_templates = 510, */   /* -falt-external-templates */
  /* OPT_fargument_alias = 511, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 512, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 513, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 514, */  /* -fargument-noalias-global */
  OPT_fasan_shadow_offset_ = 515,            /* -fasan-shadow-offset= */
  OPT_fasm = 516,                            /* -fasm */
  OPT_fassert = 517,                         /* -fassert */
  OPT_fassociative_math = 518,               /* -fassociative-math */
  OPT_fassume_compiled = 519,                /* -fassume-compiled */
  OPT_fassume_compiled_ = 520,               /* -fassume-compiled= */
  OPT_fasynchronous_unwind_tables = 521,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 522,                   /* -fauto-inc-dec */
  OPT_fauto_profile = 523,                   /* -fauto-profile */
  OPT_fauto_profile_ = 524,                  /* -fauto-profile= */
  OPT_fautomatic = 525,                      /* -fautomatic */
  OPT_faux_classpath = 526,                  /* -faux-classpath */
  OPT_fbackslash = 527,                      /* -fbackslash */
  OPT_fbacktrace = 528,                      /* -fbacktrace */
  OPT_fblas_matmul_limit_ = 529,             /* -fblas-matmul-limit= */
  OPT_fbootclasspath_ = 530,                 /* -fbootclasspath= */
  OPT_fbootstrap_classes = 531,              /* -fbootstrap-classes */
  OPT_fbounds_check = 532,                   /* -fbounds-check */
  OPT_fbranch_count_reg = 533,               /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 534,           /* -fbranch-probabilities */
  OPT_fbranch_target_load_optimize = 535,    /* -fbranch-target-load-optimize */
  OPT_fbranch_target_load_optimize2 = 536,   /* -fbranch-target-load-optimize2 */
  OPT_fbtr_bb_exclusive = 537,               /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 538,                /* -fbuilding-libgcc */
  OPT_fbuiltin = 539,                        /* -fbuiltin */
  OPT_fbuiltin_ = 540,                       /* -fbuiltin- */
  OPT_fbuiltin_printf = 541,                 /* -fbuiltin-printf */
  OPT_fcall_saved_ = 542,                    /* -fcall-saved- */
  OPT_fcall_used_ = 543,                     /* -fcall-used- */
  OPT_fcaller_saves = 544,                   /* -fcaller-saves */
  OPT_fcanonical_system_headers = 545,       /* -fcanonical-system-headers */
  ...
  OPT_fcheck_references = 550,               /* -fcheck-references */
  OPT_fcheck_ = 551,                         /* -fcheck= */
  OPT_fchecking = 552,                       /* -fchecking */
  ...
  OPT_fchkp_instrument_calls = 557,          /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 558,    /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 559,             /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 560, /* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 561,                  /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 562,              /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 563,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 564, /* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 565,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 566,         /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 567,   /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 568,              /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 569,/* -fchkp-zero-input-bounds-for-main */
  OPT_fcilkplus = 570,                       /* -fcilkplus */
  OPT_fclasspath_ = 571,                     /* -fclasspath= */
  OPT_fcoarray_ = 572,                       /* -fcoarray= */
  OPT_fcombine_stack_adjustments = 573,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 574,                         /* -fcommon */
  OPT_fcompare_debug = 575,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 576,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 577,                 /* -fcompare-debug= */
  OPT_fcompare_elim = 578,                   /* -fcompare-elim */
  OPT_fcompile_resource_ = 579,              /* -fcompile-resource= */
  ...
  OPT_fconvert_ = 586,                       /* -fconvert= */
  OPT_fcprop_registers = 587,                /* -fcprop-registers */
  OPT_fcray_pointer = 588,                   /* -fcray-pointer */
  OPT_fcrossjumping = 589,                   /* -fcrossjumping */
  OPT_fcse_follow_jumps = 590,               /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 591, */          /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 592,               /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 593,               /* -fcx-limited-range */
  OPT_fd_lines_as_code = 594,                /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 595,            /* -fd-lines-as-comments */
  OPT_fdata_sections = 596,                  /* -fdata-sections */
  OPT_fdbg_cnt_list = 597,                   /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 598,                       /* -fdbg-cnt= */
  OPT_fdce = 599,                            /* -fdce */
  OPT_fdebug_cpp = 600,                      /* -fdebug-cpp */
  OPT_fdebug_prefix_map_ = 601,              /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 602,            /* -fdebug-types-section */
  OPT_fdeclone_ctor_dtor = 603,              /* -fdeclone-ctor-dtor */
  OPT_fdeduce_init_list = 604,               /* -fdeduce-init-list */
  OPT_fdefault_double_8 = 605,               /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 606, */           /* -fdefault-inline */
  OPT_fdefault_integer_8 = 607,              /* -fdefault-integer-8 */
  OPT_fdefault_real_8 = 608,                 /* -fdefault-real-8 */
  OPT_fdefer_pop = 609,                      /* -fdefer-pop */
  OPT_fdelayed_branch = 610,                 /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 611,         /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 612,     /* -fdelete-null-pointer-checks */
  OPT_fdevirtualize = 613,                   /* -fdevirtualize */
  OPT_fdevirtualize_at_ltrans = 614,         /* -fdevirtualize-at-ltrans */
  OPT_fdevirtualize_speculatively = 615,     /* -fdevirtualize-speculatively */
  /* OPT_fdiagnostics_color = 616, */        /* -fdiagnostics-color */
  OPT_fdiagnostics_color_ = 617,             /* -fdiagnostics-color= */
  ...
  OPT_fdirectives_only = 621,                /* -fdirectives-only */
  OPT_fdisable_ = 622,                       /* -fdisable- */
  OPT_fdisable_assertions = 623,             /* -fdisable-assertions */
  OPT_fdisable_assertions_ = 624,            /* -fdisable-assertions= */
  OPT_fdollar_ok = 625,                      /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 626,         /* -fdollars-in-identifiers */
  OPT_fdse = 627,                            /* -fdse */
  OPT_fdump_ = 628,                          /* -fdump- */
  OPT_fdump_ada_spec = 629,                  /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 630,             /* -fdump-ada-spec-slim */
  /* OPT_fdump_core = 631, */                /* -fdump-core */
  OPT_fdump_final_insns = 632,               /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 633,              /* -fdump-final-insns= */
  OPT_fdump_fortran_optimized = 634,         /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 635,          /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 636,                  /* -fdump-go-spec= */
  OPT_fdump_internal_locations = 637,        /* -fdump-internal-locations */
  OPT_fdump_noaddr = 638,                    /* -fdump-noaddr */
  /* OPT_fdump_parse_tree = 639, */          /* -fdump-parse-tree */
  OPT_fdump_passes = 640,                    /* -fdump-passes */
  OPT_fdump_unnumbered = 641,                /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 642,          /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 643,                 /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 644,                 /* -fearly-inlining */
  OPT_felide_constructors = 645,             /* -felide-constructors */
  ...
  OPT_femit_class_file = 650,                /* -femit-class-file */
  OPT_femit_class_files = 651,               /* -femit-class-files */
  OPT_femit_struct_debug_baseonly = 652,     /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 653,    /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 654,      /* -femit-struct-debug-reduced */
  OPT_fenable_ = 655,                        /* -fenable- */
  OPT_fenable_assertions = 656,              /* -fenable-assertions */
  OPT_fenable_assertions_ = 657,             /* -fenable-assertions= */
  OPT_fencoding_ = 658,                      /* -fencoding= */
  OPT_fenforce_eh_specs = 659,               /* -fenforce-eh-specs */
  /* OPT_fenum_int_equiv = 660, */           /* -fenum-int-equiv */
  OPT_fexceptions = 661,                     /* -fexceptions */
  OPT_fexcess_precision_ = 662,              /* -fexcess-precision= */
  OPT_fexec_charset_ = 663,                  /* -fexec-charset= */
  OPT_fexpensive_optimizations = 664,        /* -fexpensive-optimizations */
  OPT_fext_numeric_literals = 665,           /* -fext-numeric-literals */
  OPT_fextdirs_ = 666,                       /* -fextdirs= */
  OPT_fextended_identifiers = 667,           /* -fextended-identifiers */
  OPT_fextern_tls_init = 668,                /* -fextern-tls-init */
  OPT_fexternal_blas = 669,                  /* -fexternal-blas */
  /* OPT_fexternal_templates = 670, */       /* -fexternal-templates */
  OPT_ff2c = 671,                            /* -ff2c */
  OPT_ffast_math = 672,                      /* -ffast-math */
  OPT_ffat_lto_objects = 673,                /* -ffat-lto-objects */
  OPT_ffilelist_file = 674,                  /* -ffilelist-file */
  OPT_ffinite_math_only = 675,               /* -ffinite-math-only */
  OPT_ffixed_ = 676,                         /* -ffixed- */
  OPT_ffixed_form = 677,                     /* -ffixed-form */
  OPT_ffixed_line_length_ = 678,             /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 679,         /* -ffixed-line-length-none */
  OPT_ffloat_store = 680,                    /* -ffloat-store */
  OPT_ffor_scope = 681,                      /* -ffor-scope */
  /* OPT_fforce_addr = 682, */               /* -fforce-addr */
  OPT_fforce_classes_archive_check = 683,    /* -fforce-classes-archive-check */
  OPT_fforward_propagate = 684,              /* -fforward-propagate */
  OPT_ffp_contract_ = 685,                   /* -ffp-contract= */
  OPT_ffpe_summary_ = 686,                   /* -ffpe-summary= */
  OPT_ffpe_trap_ = 687,                      /* -ffpe-trap= */
  OPT_ffree_form = 688,                      /* -ffree-form */
  OPT_ffree_line_length_ = 689,              /* -ffree-line-length- */
  OPT_ffree_line_length_none = 690,          /* -ffree-line-length-none */
  OPT_ffreestanding = 691,                   /* -ffreestanding */
  OPT_ffriend_injection = 692,               /* -ffriend-injection */
  OPT_ffrontend_optimize = 693,              /* -ffrontend-optimize */
  OPT_ffunction_cse = 694,                   /* -ffunction-cse */
  OPT_ffunction_sections = 695,              /* -ffunction-sections */
  OPT_fgcse = 696,                           /* -fgcse */
  OPT_fgcse_after_reload = 697,              /* -fgcse-after-reload */
  OPT_fgcse_las = 698,                       /* -fgcse-las */
  OPT_fgcse_lm = 699,                        /* -fgcse-lm */
  OPT_fgcse_sm = 700,                        /* -fgcse-sm */
  OPT_fgnat_encodings_ = 701,                /* -fgnat-encodings= */
  OPT_fgnu_keywords = 702,                   /* -fgnu-keywords */
  OPT_fgnu_runtime = 703,                    /* -fgnu-runtime */
  OPT_fgnu_tm = 704,                         /* -fgnu-tm */
  OPT_fgnu_unique = 705,                     /* -fgnu-unique */
  OPT_fgnu89_inline = 706,                   /* -fgnu89-inline */
  OPT_fgo_check_divide_overflow = 707,       /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 708,           /* -fgo-check-divide-zero */
  ...
  OPT_fhash_synchronization = 719,           /* -fhash-synchronization */
  /* OPT_fhelp = 720, */                     /* -fhelp */
  /* OPT_fhelp_ = 721, */                    /* -fhelp= */
  OPT_fhoist_adjacent_loads = 722,           /* -fhoist-adjacent-loads */
  /* OPT_fhonor_std = 723, */                /* -fhonor-std */
  OPT_fhosted = 724,                         /* -fhosted */
  /* OPT_fhuge_objects = 725, */             /* -fhuge-objects */
  OPT_fident = 726,                          /* -fident */
  OPT_fif_conversion = 727,                  /* -fif-conversion */
  OPT_fif_conversion2 = 728,                 /* -fif-conversion2 */
  OPT_fimplement_inlines = 729,              /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 730,      /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 731,                  /* -fimplicit-none */
  OPT_fimplicit_templates = 732,             /* -fimplicit-templates */
  OPT_findirect_classes = 733,               /* -findirect-classes */
  OPT_findirect_dispatch = 734,              /* -findirect-dispatch */
  OPT_findirect_inlining = 735,              /* -findirect-inlining */
  OPT_finhibit_size_directive = 736,         /* -finhibit-size-directive */
  OPT_finit_character_ = 737,                /* -finit-character= */
  OPT_finit_integer_ = 738,                  /* -finit-integer= */
  OPT_finit_local_zero = 739,                /* -finit-local-zero */
  OPT_finit_logical_ = 740,                  /* -finit-logical= */
  OPT_finit_real_ = 741,                     /* -finit-real= */
  OPT_finline = 742,                         /* -finline */
  OPT_finline_atomics = 743,                 /* -finline-atomics */
  OPT_finline_functions = 744,               /* -finline-functions */
  OPT_finline_functions_called_once = 745,   /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 746, */            /* -finline-limit- */
  OPT_finline_limit_ = 747,                  /* -finline-limit= */
  OPT_finline_matmul_limit_ = 748,           /* -finline-matmul-limit= */
  OPT_finline_small_functions = 749,         /* -finline-small-functions */
  OPT_finput_charset_ = 750,                 /* -finput-charset= */
  OPT_finstrument_functions = 751,           /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 752,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 753,/* -finstrument-functions-exclude-function-list= */
  OPT_finteger_4_integer_8 = 754,            /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 755,         /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 756,        /* -fintrinsic-modules-path= */
  OPT_fipa_cp = 757,                         /* -fipa-cp */
  OPT_fipa_cp_alignment = 758,               /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 759,                   /* -fipa-cp-clone */
  OPT_fipa_icf = 760,                        /* -fipa-icf */
  OPT_fipa_icf_functions = 761,              /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 762,              /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 763, */         /* -fipa-matrix-reorg */
  OPT_fipa_profile = 764,                    /* -fipa-profile */
  OPT_fipa_pta = 765,                        /* -fipa-pta */
  OPT_fipa_pure_const = 766,                 /* -fipa-pure-const */
  OPT_fipa_ra = 767,                         /* -fipa-ra */
  OPT_fipa_reference = 768,                  /* -fipa-reference */
  OPT_fipa_sra = 769,                        /* -fipa-sra */
  /* OPT_fipa_struct_reorg = 770, */         /* -fipa-struct-reorg */
  ...
  OPT_fjni = 782,                            /* -fjni */
  OPT_fjump_tables = 783,                    /* -fjump-tables */
  OPT_fkeep_gc_roots_live = 784,             /* -fkeep-gc-roots-live */
  OPT_fkeep_inline_dllexport = 785,          /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 786,          /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 787,             /* -fkeep-static-consts */
  OPT_fkeep_static_functions = 788,          /* -fkeep-static-functions */
  /* OPT_flabels_ok = 789, */                /* -flabels-ok */
  OPT_flax_vector_conversions = 790,         /* -flax-vector-conversions */
  OPT_fleading_underscore = 791,             /* -fleading-underscore */
  OPT_flifetime_dse = 792,                   /* -flifetime-dse */
  OPT_flinker_output_ = 793,                 /* -flinker-output= */
  OPT_flive_range_shrinkage = 794,           /* -flive-range-shrinkage */
  OPT_flocal_ivars = 795,                    /* -flocal-ivars */
  /* OPT_floop_block = 796, */               /* -floop-block */
  /* OPT_floop_flatten = 797, */             /* -floop-flatten */
  /* OPT_floop_interchange = 798, */         /* -floop-interchange */
  OPT_floop_nest_optimize = 799,             /* -floop-nest-optimize */
  /* OPT_floop_optimize = 800, */            /* -floop-optimize */
  OPT_floop_parallelize_all = 801,           /* -floop-parallelize-all */
  /* OPT_floop_strip_mine = 802, */          /* -floop-strip-mine */
  /* OPT_floop_unroll_and_jam = 803, */      /* -floop-unroll-and-jam */
  OPT_flra_remat = 804,                      /* -flra-remat */
  OPT_flto = 805,                            /* -flto */
  OPT_flto_compression_level_ = 806,         /* -flto-compression-level= */
  OPT_flto_odr_type_merging = 807,           /* -flto-odr-type-merging */
  OPT_flto_partition_ = 808,                 /* -flto-partition= */
  OPT_flto_report = 809,                     /* -flto-report */
  OPT_flto_report_wpa = 810,                 /* -flto-report-wpa */
  OPT_flto_ = 811,                           /* -flto= */
  OPT_fltrans = 812,                         /* -fltrans */
  OPT_fltrans_output_list_ = 813,            /* -fltrans-output-list= */
  OPT_fmain_ = 814,                          /* -fmain= */
  OPT_fmath_errno = 815,                     /* -fmath-errno */
  OPT_fmax_array_constructor_ = 816,         /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 817,                    /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 818,         /* -fmax-identifier-length= */
  OPT_fmax_stack_var_size_ = 819,            /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 820,          /* -fmax-subrecord-length= */
  OPT_fmem_report = 821,                     /* -fmem-report */
  OPT_fmem_report_wpa = 822,                 /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 823,            /* -fmerge-all-constants */
  OPT_fmerge_constants = 824,                /* -fmerge-constants */
  OPT_fmerge_debug_strings = 825,            /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 826,                /* -fmessage-length= */
  OPT_fmodule_private = 827,                 /* -fmodule-private */
  OPT_fmodulo_sched = 828,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 829,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 830,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 831,                  /* -fms-extensions */
  /* OPT_fmudflap = 832, */                  /* -fmudflap */
  /* OPT_fmudflapir = 833, */                /* -fmudflapir */
  /* OPT_fmudflapth = 834, */                /* -fmudflapth */
  /* OPT_fname_mangling_version_ = 835, */   /* -fname-mangling-version- */
  /* OPT_fnew_abi = 836, */                  /* -fnew-abi */
  OPT_fnext_runtime = 837,                   /* -fnext-runtime */
  OPT_fnil_receivers = 838,                  /* -fnil-receivers */
  /* OPT_fno_vect_cost_model = 839, */       /* -fno-vect-cost-model */
  ...
  OPT_foptimize_static_class_initialization = 864,/* -foptimize-static-class-initialization */
  OPT_foptimize_strlen = 865,                /* -foptimize-strlen */
  /* OPT_foptional_diags = 866, */           /* -foptional-diags */
  OPT_foutput_class_dir_ = 867,              /* -foutput-class-dir= */
  ...
  OPT_fpcc_struct_return = 872,              /* -fpcc-struct-return */
  OPT_fpch_deps = 873,                       /* -fpch-deps */
  OPT_fpch_preprocess = 874,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 875,                     /* -fpeel-loops */
  OPT_fpeephole = 876,                       /* -fpeephole */
  OPT_fpeephole2 = 877,                      /* -fpeephole2 */
  OPT_fpermissive = 878,                     /* -fpermissive */
  OPT_fpic = 879,                            /* -fpic */
  OPT_fpie = 880,                            /* -fpie */
  ...
  OPT_fprofile = 891,                        /* -fprofile */
  OPT_fprofile_arcs = 892,                   /* -fprofile-arcs */
  OPT_fprofile_correction = 893,             /* -fprofile-correction */
  OPT_fprofile_dir_ = 894,                   /* -fprofile-dir= */
  OPT_fprofile_generate = 895,               /* -fprofile-generate */
  OPT_fprofile_generate_ = 896,              /* -fprofile-generate= */
  OPT_fprofile_reorder_functions = 897,      /* -fprofile-reorder-functions */
  OPT_fprofile_report = 898,                 /* -fprofile-report */
  OPT_fprofile_use = 899,                    /* -fprofile-use */
  OPT_fprofile_use_ = 900,                   /* -fprofile-use= */
  OPT_fprofile_values = 901,                 /* -fprofile-values */
  OPT_fprotect_parens = 902,                 /* -fprotect-parens */
  OPT_frandom_seed = 903,                    /* -frandom-seed */
  OPT_frandom_seed_ = 904,                   /* -frandom-seed= */
  OPT_frange_check = 905,                    /* -frange-check */
  OPT_freal_4_real_10 = 906,                 /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 907,                 /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 908,                  /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 909,                 /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 910,                 /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 911,                  /* -freal-8-real-4 */
  OPT_frealloc_lhs = 912,                    /* -frealloc-lhs */
  OPT_freciprocal_math = 913,                /* -freciprocal-math */
  OPT_frecord_gcc_switches = 914,            /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 915,                /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 916,                /* -frecord-marker=8 */
  OPT_frecursive = 917,                      /* -frecursive */
  OPT_freduced_reflection = 918,             /* -freduced-reflection */
  OPT_free = 919,                            /* -free */
  OPT_freg_struct_return = 920,              /* -freg-struct-return */
  /* OPT_fregmove = 921, */                  /* -fregmove */
  OPT_frename_registers = 922,               /* -frename-registers */
  OPT_freorder_blocks = 923,                 /* -freorder-blocks */
  OPT_freorder_blocks_algorithm_ = 924,      /* -freorder-blocks-algorithm= */
  OPT_freorder_blocks_and_partition = 925,   /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 926,              /* -freorder-functions */
  OPT_frepack_arrays = 927,                  /* -frepack-arrays */
  OPT_freplace_objc_classes = 928,           /* -freplace-objc-classes */
  OPT_frepo = 929,                           /* -frepo */
  OPT_freport_bug = 930,                     /* -freport-bug */
  OPT_frequire_return_statement = 931,       /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 932,           /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 933, */           /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 934,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 935,                    /* -fresolution= */
  OPT_frounding_math = 936,                  /* -frounding-math */
  OPT_frtti = 937,                           /* -frtti */
  OPT_fsanitize_coverage_trace_pc = 938,     /* -fsanitize-coverage=trace-pc */
  OPT_fsanitize_recover = 939,               /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 940,              /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 941,             /* -fsanitize-sections= */
  OPT_fsanitize_undefined_trap_on_error = 942,/* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 943,                      /* -fsanitize= */
  OPT_fsaw_java_file = 944,                  /* -fsaw-java-file */
  OPT_fsched_critical_path_heuristic = 945,  /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 946,      /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 947,          /* -fsched-group-heuristic */
  OPT_fsched_interblock = 948,               /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 949,      /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 950,                 /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 951,           /* -fsched-rank-heuristic */
  OPT_fsched_spec = 952,                     /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 953,      /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 954,                /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 955,      /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 956,            /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 957,        /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 958,       /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 959,           /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 960,                 /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 961,         /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 962, */        /* -fsched2-use-traces */
  OPT_fschedule_fusion = 963,                /* -fschedule-fusion */
  OPT_fschedule_insns = 964,                 /* -fschedule-insns */
  OPT_fschedule_insns2 = 965,                /* -fschedule-insns2 */
  OPT_fsecond_underscore = 966,              /* -fsecond-underscore */
  OPT_fsection_anchors = 967,                /* -fsection-anchors */
  /* OPT_fsee = 968, */                      /* -fsee */
  OPT_fsel_sched_pipelining = 969,           /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 970,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 971, /* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 972,           /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 973,          /* -fselective-scheduling2 */
  OPT_fsemantic_interposition = 974,         /* -fsemantic-interposition */
  OPT_fshort_enums = 975,                    /* -fshort-enums */
  OPT_fshort_wchar = 976,                    /* -fshort-wchar */
  OPT_fshow_column = 977,                    /* -fshow-column */
  OPT_fshrink_wrap = 978,                    /* -fshrink-wrap */
  ...
  OPT_fsource_filename_ = 987,               /* -fsource-filename= */
  OPT_fsource_ = 988,                        /* -fsource= */
  OPT_fsplit_ivs_in_unroller = 989,          /* -fsplit-ivs-in-unroller */
  OPT_fsplit_paths = 990,                    /* -fsplit-paths */
  OPT_fsplit_stack = 991,                    /* -fsplit-stack */
  OPT_fsplit_wide_types = 992,               /* -fsplit-wide-types */
  /* OPT_fsquangle = 993, */                 /* -fsquangle */
  OPT_fssa_backprop = 994,                   /* -fssa-backprop */
  OPT_fssa_phiopt = 995,                     /* -fssa-phiopt */
  OPT_fsso_struct_ = 996,                    /* -fsso-struct= */
  OPT_fstack_arrays = 997,                   /* -fstack-arrays */
  /* OPT_fstack_check = 998, */              /* -fstack-check */
  OPT_fstack_check_ = 999,                   /* -fstack-check= */
  ...
  OPT_fstore_check = 1011,                   /* -fstore-check */
  ...
  OPT_fsync_libcalls = 1018,                 /* -fsync-libcalls */
  OPT_fsyntax_only = 1019,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1020,                      /* -ftabstop= */
  /* OPT_ftarget_help = 1021, */             /* -ftarget-help */
  OPT_ftarget_ = 1022,                       /* -ftarget= */
  ...
  /* OPT_fthis_is_variable = 1027, */        /* -fthis-is-variable */
  OPT_fthread_jumps = 1028,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1029,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1030,                   /* -ftime-report */
  OPT_ftls_model_ = 1031,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1032,              /* -ftoplevel-reorder */
  OPT_ftracer = 1033,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1034,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1035,        /* -ftrack-macro-expansion= */
  OPT_ftrapping_math = 1036,                 /* -ftrapping-math */
  OPT_ftrapv = 1037,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1038,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1039,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1040,                      /* -ftree-ccp */
  OPT_ftree_ch = 1041,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1042, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1043,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1044,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1045, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1046,                   /* -ftree-cselim */
  OPT_ftree_dce = 1047,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1048,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1049,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1050,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1051,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1052, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1053,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1054,          /* -ftree-loop-if-convert */
  OPT_ftree_loop_if_convert_stores = 1055,   /* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1056,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1057,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1058, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1059,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1060,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1061,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1062,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1063,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1064,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1065,                      /* -ftree-pre */
  OPT_ftree_pta = 1066,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1067,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1068, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1069,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1070,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1071,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1072,                     /* -ftree-slsr */
  OPT_ftree_sra = 1073,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1074, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1075, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1076,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1077,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1078,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1079, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1080,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1081, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1082,                      /* -ftree-vrp */
  OPT_funderscoring = 1083,                  /* -funderscoring */
  OPT_funit_at_a_time = 1084,                /* -funit-at-a-time */
  OPT_funroll_all_loops = 1085,              /* -funroll-all-loops */
  OPT_funroll_loops = 1086,                  /* -funroll-loops */
  OPT_funsafe_loop_optimizations = 1087,     /* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1088,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1089,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1090,                 /* -funsigned-char */
  OPT_funswitch_loops = 1091,                /* -funswitch-loops */
  OPT_funwind_tables = 1092,                 /* -funwind-tables */
  OPT_fuse_atomic_builtins = 1093,           /* -fuse-atomic-builtins */
  OPT_fuse_boehm_gc = 1094,                  /* -fuse-boehm-gc */
  OPT_fuse_cxa_atexit = 1095,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1096,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_divide_subroutine = 1097,         /* -fuse-divide-subroutine */
  OPT_fuse_ld_bfd = 1098,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1099,                   /* -fuse-ld=gold */
  OPT_fuse_linker_plugin = 1100,             /* -fuse-linker-plugin */
  OPT_fvar_tracking = 1101,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1102,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1103,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1104,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1105,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1106, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1107,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1108,                   /* -fverbose-asm */
  /* OPT_fversion = 1109, */                 /* -fversion */
  OPT_fvisibility_inlines_hidden = 1110,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1111,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1112,                   /* -fvisibility= */
  OPT_fvpt = 1113,                           /* -fvpt */
  /* OPT_fvtable_gc = 1114, */               /* -fvtable-gc */
  /* OPT_fvtable_thunks = 1115, */           /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1116,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1117,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1118,                     /* -fvtv-debug */
  OPT_fweak = 1119,                          /* -fweak */
  OPT_fweb = 1120,                           /* -fweb */
  /* OPT_fwhole_file = 1121, */              /* -fwhole-file */
  OPT_fwhole_program = 1122,                 /* -fwhole-program */
  OPT_fwide_exec_charset_ = 1123,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1124,             /* -fworking-directory */
  OPT_fwpa = 1125,                           /* -fwpa */
  OPT_fwpa_ = 1126,                          /* -fwpa= */
  OPT_fwrapv = 1127,                         /* -fwrapv */
  /* OPT_fxref = 1128, */                    /* -fxref */
  /* OPT_fzee = 1129, */                     /* -fzee */
  OPT_fzero_initialized_in_bss = 1130,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1131,                     /* -fzero-link */
  OPT_g = 1132,                              /* -g */
  OPT_gant = 1133,                           /* -gant */
  OPT_gcoff = 1134,                          /* -gcoff */
  OPT_gdwarf = 1135,                         /* -gdwarf */
  OPT_gdwarf_ = 1136,                        /* -gdwarf- */
  OPT_gen_decls = 1137,                      /* -gen-decls */
  OPT_ggdb = 1138,                           /* -ggdb */
  OPT_ggnu_pubnames = 1139,                  /* -ggnu-pubnames */
  OPT_gnat = 1140,                           /* -gnat */
  OPT_gnatO = 1141,                          /* -gnatO */
  OPT_gno_pubnames = 1142,                   /* -gno-pubnames */
  OPT_gno_record_gcc_switches = 1143,        /* -gno-record-gcc-switches */
  OPT_gno_split_dwarf = 1144,                /* -gno-split-dwarf */
  OPT_gno_strict_dwarf = 1145,               /* -gno-strict-dwarf */
  OPT_gpubnames = 1146,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1147,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1148,                   /* -gsplit-dwarf */
  OPT_gstabs = 1149,                         /* -gstabs */
  OPT_gstabs_ = 1150,                        /* -gstabs+ */
  OPT_gstrict_dwarf = 1151,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1152,                        /* -gtoggle */
  OPT_gvms = 1153,                           /* -gvms */
  OPT_gxcoff = 1154,                         /* -gxcoff */
  OPT_gxcoff_ = 1155,                        /* -gxcoff+ */
  OPT_gz = 1156,                             /* -gz */
  OPT_gz_ = 1157,                            /* -gz= */
  OPT_h = 1158,                              /* -h */
  OPT_idirafter = 1159,                      /* -idirafter */
  OPT_imacros = 1160,                        /* -imacros */
  OPT_imultiarch = 1161,                     /* -imultiarch */
  OPT_imultilib = 1162,                      /* -imultilib */
  OPT_include = 1163,                        /* -include */
  OPT_iplugindir_ = 1164,                    /* -iplugindir= */
  OPT_iprefix = 1165,                        /* -iprefix */
  OPT_iquote = 1166,                         /* -iquote */
  OPT_isysroot = 1167,                       /* -isysroot */
  OPT_isystem = 1168,                        /* -isystem */
  OPT_iwithprefix = 1169,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1170,              /* -iwithprefixbefore */
  OPT_k8 = 1171,                             /* -k8 */
  OPT_l = 1172,                              /* -l */
  OPT_lang_asm = 1173,                       /* -lang-asm */
  OPT_m128bit_long_double = 1174,            /* -m128bit-long-double */
  OPT_m16 = 1175,                            /* -m16 */
  OPT_m32 = 1176,                            /* -m32 */
  OPT_m3dnow = 1177,                         /* -m3dnow */
  OPT_m3dnowa = 1178,                        /* -m3dnowa */
  OPT_m64 = 1179,                            /* -m64 */
  OPT_m80387 = 1180,                         /* -m80387 */
  OPT_m8bit_idiv = 1181,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1182,             /* -m96bit-long-double */
  OPT_mabi_ = 1183,                          /* -mabi= */
  OPT_mabm = 1184,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1185,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1186,                 /* -maddress-mode= */
  OPT_madx = 1187,                           /* -madx */
  OPT_maes = 1188,                           /* -maes */
  OPT_malign_data_ = 1189,                   /* -malign-data= */
  OPT_malign_double = 1190,                  /* -malign-double */
  OPT_malign_functions_ = 1191,              /* -malign-functions= */
  OPT_malign_jumps_ = 1192,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1193,                  /* -malign-loops= */
  OPT_malign_stringops = 1194,               /* -malign-stringops */
  OPT_mandroid = 1195,                       /* -mandroid */
  OPT_march_ = 1196,                         /* -march= */
  OPT_masm_ = 1197,                          /* -masm= */
  OPT_mavx = 1198,                           /* -mavx */
  OPT_mavx2 = 1199,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1200,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1201,  /* -mavx256-split-unaligned-store */
  OPT_mavx512bw = 1202,                      /* -mavx512bw */
  OPT_mavx512cd = 1203,                      /* -mavx512cd */
  OPT_mavx512dq = 1204,                      /* -mavx512dq */
  OPT_mavx512er = 1205,                      /* -mavx512er */
  OPT_mavx512f = 1206,                       /* -mavx512f */
  OPT_mavx512ifma = 1207,                    /* -mavx512ifma */
  OPT_mavx512pf = 1208,                      /* -mavx512pf */
  OPT_mavx512vbmi = 1209,                    /* -mavx512vbmi */
  OPT_mavx512vl = 1210,                      /* -mavx512vl */
  OPT_mbionic = 1211,                        /* -mbionic */
  OPT_mbmi = 1212,                           /* -mbmi */
  OPT_mbmi2 = 1213,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1214,                  /* -mbranch-cost= */
  OPT_mcld = 1215,                           /* -mcld */
  OPT_mclflushopt = 1216,                    /* -mclflushopt */
  OPT_mclwb = 1217,                          /* -mclwb */
  OPT_mclzero = 1218,                        /* -mclzero */
  OPT_mcmodel_ = 1219,                       /* -mcmodel= */
  /* OPT_mcpu_ = 1220, */                    /* -mcpu= */
  OPT_mcrc32 = 1221,                         /* -mcrc32 */
  OPT_mcx16 = 1222,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1223,            /* -mdispatch-scheduler */
  OPT_mdump_tune_features = 1224,            /* -mdump-tune-features */
  OPT_mf16c = 1225,                          /* -mf16c */
  OPT_mfancy_math_387 = 1226,                /* -mfancy-math-387 */
  OPT_mfentry = 1227,                        /* -mfentry */
  OPT_mfma = 1228,                           /* -mfma */
  OPT_mfma4 = 1229,                          /* -mfma4 */
  OPT_mforce_drap = 1230,                    /* -mforce-drap */
  OPT_mfp_ret_in_387 = 1231,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1232,                       /* -mfpmath= */
  OPT_mfsgsbase = 1233,                      /* -mfsgsbase */
  /* OPT_mfused_madd = 1234, */              /* -mfused-madd */
  OPT_mfxsr = 1235,                          /* -mfxsr */
  OPT_mglibc = 1236,                         /* -mglibc */
  OPT_mhard_float = 1237,                    /* -mhard-float */
  OPT_mhle = 1238,                           /* -mhle */
  OPT_miamcu = 1239,                         /* -miamcu */
  OPT_mieee_fp = 1240,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1241,      /* -mincoming-stack-boundary= */
  OPT_minline_all_stringops = 1242,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1243,  /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 1244, */            /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 1245,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1246,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1247,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1248,                /* -mlong-double-80 */
  OPT_mlwp = 1249,                           /* -mlwp */
  OPT_mlzcnt = 1250,                         /* -mlzcnt */
  OPT_mmemcpy_strategy_ = 1251,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1252,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 1253,                  /* -mmitigate-rop */
  OPT_mmmx = 1254,                           /* -mmmx */
  OPT_mmovbe = 1255,                         /* -mmovbe */
  OPT_mmpx = 1256,                           /* -mmpx */
  OPT_mms_bitfields = 1257,                  /* -mms-bitfields */
  OPT_mmusl = 1258,                          /* -mmusl */
  OPT_mmwaitx = 1259,                        /* -mmwaitx */
  OPT_mno_align_stringops = 1260,            /* -mno-align-stringops */
  OPT_mno_default = 1261,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1262,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1263,                  /* -mno-push-args */
  OPT_mno_red_zone = 1264,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1265,                       /* -mno-sse4 */
  OPT_mnop_mcount = 1266,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 1267,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1268,                          /* -mpc32 */
  OPT_mpc64 = 1269,                          /* -mpc64 */
  OPT_mpc80 = 1270,                          /* -mpc80 */
  OPT_mpclmul = 1271,                        /* -mpclmul */
  OPT_mpcommit = 1272,                       /* -mpcommit */
  OPT_mpku = 1273,                           /* -mpku */
  OPT_mpopcnt = 1274,                        /* -mpopcnt */
  OPT_mprefer_avx128 = 1275,                 /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 1276,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1277,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1278,                        /* -mprfchw */
  OPT_mpush_args = 1279,                     /* -mpush-args */
  OPT_mrdrnd = 1280,                         /* -mrdrnd */
  OPT_mrdseed = 1281,                        /* -mrdseed */
  OPT_mrecip = 1282,                         /* -mrecip */
  OPT_mrecip_ = 1283,                        /* -mrecip= */
  OPT_mrecord_mcount = 1284,                 /* -mrecord-mcount */
  OPT_mred_zone = 1285,                      /* -mred-zone */
  OPT_mregparm_ = 1286,                      /* -mregparm= */
  OPT_mrtd = 1287,                           /* -mrtd */
  OPT_mrtm = 1288,                           /* -mrtm */
  OPT_msahf = 1289,                          /* -msahf */
  OPT_msha = 1290,                           /* -msha */
  OPT_mskip_rax_setup = 1291,                /* -mskip-rax-setup */
  OPT_msoft_float = 1292,                    /* -msoft-float */
  OPT_msse = 1293,                           /* -msse */
  OPT_msse2 = 1294,                          /* -msse2 */
  OPT_msse2avx = 1295,                       /* -msse2avx */
  OPT_msse3 = 1296,                          /* -msse3 */
  OPT_msse4 = 1297,                          /* -msse4 */
  OPT_msse4_1 = 1298,                        /* -msse4.1 */
  OPT_msse4_2 = 1299,                        /* -msse4.2 */
  OPT_msse4a = 1300,                         /* -msse4a */
  /* OPT_msse5 = 1301, */                    /* -msse5 */
  OPT_msseregparm = 1302,                    /* -msseregparm */
  OPT_mssse3 = 1303,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1304,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_ = 1305,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1306,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1307,            /* -mstringop-strategy= */
  OPT_mstv = 1308,                           /* -mstv */
  OPT_mtbm = 1309,                           /* -mtbm */
  OPT_mtls_dialect_ = 1310,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1311,           /* -mtls-direct-seg-refs */
  OPT_mtune_ctrl_ = 1312,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1313,                         /* -mtune= */
  OPT_muclibc = 1314,                        /* -muclibc */
  OPT_mveclibabi_ = 1315,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1316,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1317,                    /* -mvzeroupper */
  OPT_mx32 = 1318,                           /* -mx32 */
  OPT_mxop = 1319,                           /* -mxop */
  OPT_mxsave = 1320,                         /* -mxsave */
  OPT_mxsavec = 1321,                        /* -mxsavec */
  OPT_mxsaveopt = 1322,                      /* -mxsaveopt */
  OPT_mxsaves = 1323,                        /* -mxsaves */
  OPT_n = 1324,                              /* -n */
  ...
  OPT_nostartfiles = 1330,                   /* -nostartfiles */
  OPT_nostdinc = 1331,                       /* -nostdinc */
  OPT_nostdinc__ = 1332,                     /* -nostdinc++ */
  OPT_nostdlib = 1333,                       /* -nostdlib */
  OPT_o = 1334,                              /* -o */
  OPT_p = 1335,                              /* -p */
  OPT_pass_exit_codes = 1336,                /* -pass-exit-codes */
  /* OPT_pedantic = 1337, */                 /* -pedantic */
  OPT_pedantic_errors = 1338,                /* -pedantic-errors */
  OPT_pg = 1339,                             /* -pg */
  OPT_pie = 1340,                            /* -pie */
  OPT_pipe = 1341,                           /* -pipe */
  OPT_posix = 1342,                          /* -posix */
  OPT_print_file_name_ = 1343,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1344,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1345,          /* -print-multi-directory */
  OPT_print_multi_lib = 1346,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1347,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1348,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1349,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1350,               /* -print-prog-name= */
  OPT_print_search_dirs = 1351,              /* -print-search-dirs */
  OPT_print_sysroot = 1352,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1353,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1354,                        /* -profile */
  OPT_pthread = 1355,                        /* -pthread */
  OPT_quiet = 1356,                          /* -quiet */
  OPT_r = 1357,                              /* -r */
  OPT_rdynamic = 1358,                       /* -rdynamic */
  OPT_remap = 1359,                          /* -remap */
  OPT_s = 1360,                              /* -s */
  OPT_s_bc_abi = 1361,                       /* -s-bc-abi */
  OPT_save_temps = 1362,                     /* -save-temps */
  OPT_save_temps_ = 1363,                    /* -save-temps= */
  OPT_shared = 1364,                         /* -shared */
  OPT_shared_libgcc = 1365,                  /* -shared-libgcc */
  /* OPT_specs = 1366, */                    /* -specs */
  OPT_specs_ = 1367,                         /* -specs= */
  OPT_static = 1368,                         /* -static */
  OPT_static_libasan = 1369,                 /* -static-libasan */
  OPT_static_libgcc = 1370,                  /* -static-libgcc */
  OPT_static_libgcj = 1371,                  /* -static-libgcj */
  OPT_static_libgfortran = 1372,             /* -static-libgfortran */
  OPT_static_libgo = 1373,                   /* -static-libgo */
  OPT_static_liblsan = 1374,                 /* -static-liblsan */
  OPT_static_libmpx = 1375,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1376,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1377,               /* -static-libstdc++ */
  OPT_static_libtsan = 1378,                 /* -static-libtsan */
  OPT_static_libubsan = 1379,                /* -static-libubsan */
  ...
  /* OPT_std_c89 = 1390, */                  /* -std=c89 */
  OPT_std_c90 = 1391,                        /* -std=c90 */
  OPT_std_c99 = 1392,                        /* -std=c99 */
  /* OPT_std_c9x = 1393, */                  /* -std=c9x */
  OPT_std_f2003 = 1394,                      /* -std=f2003 */
  OPT_std_f2008 = 1395,                      /* -std=f2008 */
  OPT_std_f2008ts = 1396,                    /* -std=f2008ts */
  OPT_std_f95 = 1397,                        /* -std=f95 */
  OPT_std_gnu = 1398,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1399, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1400, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1401,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1402,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1403, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1404, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1405,                    /* -std=gnu++1z */
  OPT_std_gnu__98 = 1406,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1407,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1408, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1409, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1410,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1411,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1412, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1413, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1414,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1415, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1416, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1417, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1418,                     /* -std=legacy */
  OPT_symbolic = 1419,                       /* -symbolic */
  OPT_t = 1420,                              /* -t */
  OPT_time = 1421,                           /* -time */
  OPT_time_ = 1422,                          /* -time= */
  OPT_tno_android_cc = 1423,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1424,                 /* -tno-android-ld */
  OPT_traditional = 1425,                    /* -traditional */
  OPT_traditional_cpp = 1426,                /* -traditional-cpp */
  OPT_trigraphs = 1427,                      /* -trigraphs */
  OPT_u = 1428,                              /* -u */
  OPT_undef = 1429,                          /* -undef */
  OPT_v = 1430,                              /* -v */
  OPT_version = 1431,                        /* -version */
  OPT_w = 1432,                              /* -w */
  OPT_wrapper = 1433,                        /* -wrapper */
  OPT_x = 1434,                              /* -x */
  OPT_z = 1435,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
