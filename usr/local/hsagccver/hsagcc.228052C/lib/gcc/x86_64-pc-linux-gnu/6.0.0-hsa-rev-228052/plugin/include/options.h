...
enum opt_code
{
  ...
  OPT_Winteger_division = 269,               /* -Winteger-division */
  OPT_Wintf_annotation = 270,                /* -Wintf-annotation */
  OPT_Wintf_non_inherited = 271,             /* -Wintf-non-inherited */
  OPT_Wintrinsic_shadow = 272,               /* -Wintrinsic-shadow */
  OPT_Wintrinsics_std = 273,                 /* -Wintrinsics-std */
  OPT_Winvalid_memory_model = 274,           /* -Winvalid-memory-model */
  OPT_Winvalid_offsetof = 275,               /* -Winvalid-offsetof */
  OPT_Winvalid_pch = 276,                    /* -Winvalid-pch */
  OPT_Wjavadoc = 277,                        /* -Wjavadoc */
  OPT_Wjump_misses_init = 278,               /* -Wjump-misses-init */
  OPT_Wl_ = 279,                             /* -Wl, */
  /* OPT_Wlarger_than_ = 280, */             /* -Wlarger-than- */
  OPT_Wlarger_than_ = 281,                   /* -Wlarger-than= */
  OPT_Wline_truncation = 282,                /* -Wline-truncation */
  OPT_Wliteral_suffix = 283,                 /* -Wliteral-suffix */
  OPT_Wlocal_hiding = 284,                   /* -Wlocal-hiding */
  ...
  OPT_Wnarrowing = 304,                      /* -Wnarrowing */
  OPT_Wnested_externs = 305,                 /* -Wnested-externs */
  OPT_Wnls = 306,                            /* -Wnls */
  OPT_Wno_effect_assign = 307,               /* -Wno-effect-assign */
  OPT_Wnoexcept = 308,                       /* -Wnoexcept */
  OPT_Wnon_template_friend = 309,            /* -Wnon-template-friend */
  OPT_Wnon_virtual_dtor = 310,               /* -Wnon-virtual-dtor */
  OPT_Wnonnull = 311,                        /* -Wnonnull */
  /* OPT_Wnormalized = 312, */               /* -Wnormalized */
  OPT_Wnormalized_ = 313,                    /* -Wnormalized= */
  OPT_Wnull = 314,                           /* -Wnull */
  OPT_Wnull_dereference = 315,               /* -Wnull-dereference */
  OPT_Wodr = 316,                            /* -Wodr */
  ...
  OPT_Wpadded = 331,                         /* -Wpadded */
  OPT_Wparam_assign = 332,                   /* -Wparam-assign */
  OPT_Wparentheses = 333,                    /* -Wparentheses */
  OPT_Wpedantic = 334,                       /* -Wpedantic */
  OPT_Wpkg_default_method = 335,             /* -Wpkg-default-method */
  OPT_Wpmf_conversions = 336,                /* -Wpmf-conversions */
  OPT_Wpointer_arith = 337,                  /* -Wpointer-arith */
  OPT_Wpointer_sign = 338,                   /* -Wpointer-sign */
  OPT_Wpointer_to_int_cast = 339,            /* -Wpointer-to-int-cast */
  ...
  OPT_Wshift_negative_value = 360,           /* -Wshift-negative-value */
  /* OPT_Wshift_overflow = 361, */           /* -Wshift-overflow */
  OPT_Wshift_overflow_ = 362,                /* -Wshift-overflow= */
  OPT_Wsign_compare = 363,                   /* -Wsign-compare */
  OPT_Wsign_conversion = 364,                /* -Wsign-conversion */
  OPT_Wsign_promo = 365,                     /* -Wsign-promo */
  OPT_Wsized_deallocation = 366,             /* -Wsized-deallocation */
  OPT_Wsizeof_array_argument = 367,          /* -Wsizeof-array-argument */
  OPT_Wsizeof_pointer_memaccess = 368,       /* -Wsizeof-pointer-memaccess */
  OPT_Wspecial_param_hiding = 369,           /* -Wspecial-param-hiding */
  OPT_Wstack_protector = 370,                /* -Wstack-protector */
  OPT_Wstack_usage_ = 371,                   /* -Wstack-usage= */
  OPT_Wstatic_access = 372,                  /* -Wstatic-access */
  OPT_Wstatic_receiver = 373,                /* -Wstatic-receiver */
  OPT_Wstrict_aliasing = 374,                /* -Wstrict-aliasing */
  OPT_Wstrict_aliasing_ = 375,               /* -Wstrict-aliasing= */
  OPT_Wstrict_null_sentinel = 376,           /* -Wstrict-null-sentinel */
  OPT_Wstrict_overflow = 377,                /* -Wstrict-overflow */
  OPT_Wstrict_overflow_ = 378,               /* -Wstrict-overflow= */
  OPT_Wstrict_prototypes = 379,              /* -Wstrict-prototypes */
  OPT_Wstrict_selector_match = 380,          /* -Wstrict-selector-match */
  OPT_Wsubobject_linkage = 381,              /* -Wsubobject-linkage */
  OPT_Wsuggest_attribute_const = 382,        /* -Wsuggest-attribute=const */
  OPT_Wsuggest_attribute_format = 383,       /* -Wsuggest-attribute=format */
  OPT_Wsuggest_attribute_noreturn = 384,     /* -Wsuggest-attribute=noreturn */
  OPT_Wsuggest_attribute_pure = 385,         /* -Wsuggest-attribute=pure */
  OPT_Wsuggest_final_methods = 386,          /* -Wsuggest-final-methods */
  OPT_Wsuggest_final_types = 387,            /* -Wsuggest-final-types */
  OPT_Wsuggest_override = 388,               /* -Wsuggest-override */
  OPT_Wsuppress = 389,                       /* -Wsuppress */
  OPT_Wsurprising = 390,                     /* -Wsurprising */
  OPT_Wswitch = 391,                         /* -Wswitch */
  OPT_Wswitch_bool = 392,                    /* -Wswitch-bool */
  OPT_Wswitch_default = 393,                 /* -Wswitch-default */
  OPT_Wswitch_enum = 394,                    /* -Wswitch-enum */
  OPT_Wsync_nand = 395,                      /* -Wsync-nand */
  OPT_Wsynth = 396,                          /* -Wsynth */
  OPT_Wsynthetic_access = 397,               /* -Wsynthetic-access */
  OPT_Wsystem_headers = 398,                 /* -Wsystem-headers */
  OPT_Wtabs = 399,                           /* -Wtabs */
  OPT_Wtarget_lifetime = 400,                /* -Wtarget-lifetime */
  OPT_Wtasks = 401,                          /* -Wtasks */
  OPT_Wtautological_compare = 402,           /* -Wtautological-compare */
  OPT_Wterminate = 403,                      /* -Wterminate */
  OPT_Wtraditional = 404,                    /* -Wtraditional */
  OPT_Wtraditional_conversion = 405,         /* -Wtraditional-conversion */
  OPT_Wtrampolines = 406,                    /* -Wtrampolines */
  OPT_Wtrigraphs = 407,                      /* -Wtrigraphs */
  OPT_Wtype_hiding = 408,                    /* -Wtype-hiding */
  OPT_Wtype_limits = 409,                    /* -Wtype-limits */
  OPT_Wuncheck = 410,                        /* -Wuncheck */
  OPT_Wundeclared_selector = 411,            /* -Wundeclared-selector */
  OPT_Wundef = 412,                          /* -Wundef */
  OPT_Wunderflow = 413,                      /* -Wunderflow */
  OPT_Wuninitialized = 414,                  /* -Wuninitialized */
  OPT_Wunknown_pragmas = 415,                /* -Wunknown-pragmas */
  OPT_Wunnecessary_else = 416,               /* -Wunnecessary-else */
  OPT_Wunqualified_field = 417,              /* -Wunqualified-field */
  /* OPT_Wunreachable_code = 418, */         /* -Wunreachable-code */
  OPT_Wunsafe_loop_optimizations = 419,      /* -Wunsafe-loop-optimizations */
  OPT_Wunsuffixed_float_constants = 420,     /* -Wunsuffixed-float-constants */
  OPT_Wunused = 421,                         /* -Wunused */
  OPT_Wunused_argument = 422,                /* -Wunused-argument */
  OPT_Wunused_but_set_parameter = 423,       /* -Wunused-but-set-parameter */
  OPT_Wunused_but_set_variable = 424,        /* -Wunused-but-set-variable */
  OPT_Wunused_const_variable = 425,          /* -Wunused-const-variable */
  OPT_Wunused_dummy_argument = 426,          /* -Wunused-dummy-argument */
  OPT_Wunused_function = 427,                /* -Wunused-function */
  OPT_Wunused_import = 428,                  /* -Wunused-import */
  OPT_Wunused_label = 429,                   /* -Wunused-label */
  OPT_Wunused_local = 430,                   /* -Wunused-local */
  OPT_Wunused_local_typedefs = 431,          /* -Wunused-local-typedefs */
  OPT_Wunused_macros = 432,                  /* -Wunused-macros */
  OPT_Wunused_parameter = 433,               /* -Wunused-parameter */
  OPT_Wunused_private = 434,                 /* -Wunused-private */
  OPT_Wunused_result = 435,                  /* -Wunused-result */
  OPT_Wunused_thrown = 436,                  /* -Wunused-thrown */
  OPT_Wunused_value = 437,                   /* -Wunused-value */
  OPT_Wunused_variable = 438,                /* -Wunused-variable */
  OPT_Wuse_without_only = 439,               /* -Wuse-without-only */
  OPT_Wuseless_cast = 440,                   /* -Wuseless-cast */
  OPT_Wuseless_type_check = 441,             /* -Wuseless-type-check */
  OPT_Wvarargs = 442,                        /* -Wvarargs */
  OPT_Wvarargs_cast = 443,                   /* -Wvarargs-cast */
  OPT_Wvariadic_macros = 444,                /* -Wvariadic-macros */
  OPT_Wvector_operation_performance = 445,   /* -Wvector-operation-performance */
  OPT_Wvirtual_move_assign = 446,            /* -Wvirtual-move-assign */
  OPT_Wvla = 447,                            /* -Wvla */
  OPT_Wvolatile_register_var = 448,          /* -Wvolatile-register-var */
  OPT_Wwarning_token = 449,                  /* -Wwarning-token */
  OPT_Wwrite_strings = 450,                  /* -Wwrite-strings */
  OPT_Wzero_as_null_pointer_constant = 451,  /* -Wzero-as-null-pointer-constant */
  OPT_Wzerotrip = 452,                       /* -Wzerotrip */
  OPT_Xassembler = 453,                      /* -Xassembler */
  OPT_Xlinker = 454,                         /* -Xlinker */
  OPT_Xpreprocessor = 455,                   /* -Xpreprocessor */
  OPT_Z = 456,                               /* -Z */
  OPT_ansi = 457,                            /* -ansi */
  OPT_aux_info = 458,                        /* -aux-info */
  /* OPT_aux_info_ = 459, */                 /* -aux-info= */
  OPT_auxbase = 460,                         /* -auxbase */
  OPT_auxbase_strip = 461,                   /* -auxbase-strip */
  /* OPT_bootclasspath = 462, */             /* -bootclasspath */
  OPT_c = 463,                               /* -c */
  ...
  OPT_e = 474,                               /* -e */
  /* OPT_encoding = 475, */                  /* -encoding */
  OPT_export_dynamic = 476,                  /* -export-dynamic */
  OPT_extdirs = 477,                         /* -extdirs */
  ...
  OPT_fasm = 507,                            /* -fasm */
  OPT_fassert = 508,                         /* -fassert */
  OPT_fassociative_math = 509,               /* -fassociative-math */
  OPT_fassume_compiled = 510,                /* -fassume-compiled */
  OPT_fassume_compiled_ = 511,               /* -fassume-compiled= */
  OPT_fasynchronous_unwind_tables = 512,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 513,                   /* -fauto-inc-dec */
  OPT_fauto_profile = 514,                   /* -fauto-profile */
  OPT_fauto_profile_ = 515,                  /* -fauto-profile= */
  OPT_fautomatic = 516,                      /* -fautomatic */
  OPT_faux_classpath = 517,                  /* -faux-classpath */
  OPT_fbackslash = 518,                      /* -fbackslash */
  OPT_fbacktrace = 519,                      /* -fbacktrace */
  OPT_fblas_matmul_limit_ = 520,             /* -fblas-matmul-limit= */
  OPT_fbootclasspath_ = 521,                 /* -fbootclasspath= */
  OPT_fbootstrap_classes = 522,              /* -fbootstrap-classes */
  OPT_fbounds_check = 523,                   /* -fbounds-check */
  OPT_fbranch_count_reg = 524,               /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 525,           /* -fbranch-probabilities */
  OPT_fbranch_target_load_optimize = 526,    /* -fbranch-target-load-optimize */
  OPT_fbranch_target_load_optimize2 = 527,   /* -fbranch-target-load-optimize2 */
  OPT_fbtr_bb_exclusive = 528,               /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 529,                /* -fbuilding-libgcc */
  OPT_fbuiltin = 530,                        /* -fbuiltin */
  OPT_fbuiltin_ = 531,                       /* -fbuiltin- */
  OPT_fcall_saved_ = 532,                    /* -fcall-saved- */
  OPT_fcall_used_ = 533,                     /* -fcall-used- */
  OPT_fcaller_saves = 534,                   /* -fcaller-saves */
  OPT_fcanonical_system_headers = 535,       /* -fcanonical-system-headers */
  ...
  OPT_fcheck_references = 540,               /* -fcheck-references */
  OPT_fcheck_ = 541,                         /* -fcheck= */
  OPT_fchkp_check_incomplete_type = 542,     /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 543,                /* -fchkp-check-read */
  OPT_fchkp_check_write = 544,               /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 545,/* -fchkp-first-field-has-own-bounds */
  ...
  OPT_fclasspath_ = 560,                     /* -fclasspath= */
  OPT_fcoarray_ = 561,                       /* -fcoarray= */
  ...
  OPT_fcompile_resource_ = 568,              /* -fcompile-resource= */
  OPT_fconcepts = 569,                       /* -fconcepts */
  OPT_fcond_mismatch = 570,                  /* -fcond-mismatch */
  OPT_fconserve_space = 571,                 /* -fconserve-space */
  OPT_fconserve_stack = 572,                 /* -fconserve-stack */
  OPT_fconstant_string_class_ = 573,         /* -fconstant-string-class= */
  OPT_fconstexpr_depth_ = 574,               /* -fconstexpr-depth= */
  ...
  OPT_fdeclone_ctor_dtor = 592,              /* -fdeclone-ctor-dtor */
  OPT_fdeduce_init_list = 593,               /* -fdeduce-init-list */
  OPT_fdefault_double_8 = 594,               /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 595, */           /* -fdefault-inline */
  OPT_fdefault_integer_8 = 596,              /* -fdefault-integer-8 */
  OPT_fdefault_real_8 = 597,                 /* -fdefault-real-8 */
  OPT_fdefer_pop = 598,                      /* -fdefer-pop */
  OPT_fdelayed_branch = 599,                 /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 600,         /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 601,     /* -fdelete-null-pointer-checks */
  OPT_fdevirtualize = 602,                   /* -fdevirtualize */
  OPT_fdevirtualize_at_ltrans = 603,         /* -fdevirtualize-at-ltrans */
  OPT_fdevirtualize_speculatively = 604,     /* -fdevirtualize-speculatively */
  /* OPT_fdiagnostics_color = 605, */        /* -fdiagnostics-color */
  OPT_fdiagnostics_color_ = 606,             /* -fdiagnostics-color= */
  OPT_fdiagnostics_show_caret = 607,         /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_location_ = 608,     /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 609,        /* -fdiagnostics-show-option */
  OPT_fdirectives_only = 610,                /* -fdirectives-only */
  OPT_fdisable_ = 611,                       /* -fdisable- */
  OPT_fdisable_assertions = 612,             /* -fdisable-assertions */
  OPT_fdisable_assertions_ = 613,            /* -fdisable-assertions= */
  OPT_fdisable_hsa_gridification = 614,      /* -fdisable-hsa-gridification */
  OPT_fdollar_ok = 615,                      /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 616,         /* -fdollars-in-identifiers */
  OPT_fdse = 617,                            /* -fdse */
  OPT_fdump_ = 618,                          /* -fdump- */
  OPT_fdump_ada_spec = 619,                  /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 620,             /* -fdump-ada-spec-slim */
  /* OPT_fdump_core = 621, */                /* -fdump-core */
  OPT_fdump_final_insns = 622,               /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 623,              /* -fdump-final-insns= */
  OPT_fdump_fortran_optimized = 624,         /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 625,          /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 626,                  /* -fdump-go-spec= */
  OPT_fdump_internal_locations = 627,        /* -fdump-internal-locations */
  OPT_fdump_noaddr = 628,                    /* -fdump-noaddr */
  /* OPT_fdump_parse_tree = 629, */          /* -fdump-parse-tree */
  OPT_fdump_passes = 630,                    /* -fdump-passes */
  OPT_fdump_unnumbered = 631,                /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 632,          /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 633,                 /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 634,                 /* -fearly-inlining */
  OPT_felide_constructors = 635,             /* -felide-constructors */
  OPT_feliminate_dwarf2_dups = 636,          /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 637, /* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 638,   /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 639,        /* -femit-class-debug-always */
  OPT_femit_class_file = 640,                /* -femit-class-file */
  OPT_femit_class_files = 641,               /* -femit-class-files */
  OPT_femit_struct_debug_baseonly = 642,     /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 643,    /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 644,      /* -femit-struct-debug-reduced */
  OPT_fenable_ = 645,                        /* -fenable- */
  OPT_fenable_assertions = 646,              /* -fenable-assertions */
  OPT_fenable_assertions_ = 647,             /* -fenable-assertions= */
  OPT_fencoding_ = 648,                      /* -fencoding= */
  OPT_fenforce_eh_specs = 649,               /* -fenforce-eh-specs */
  /* OPT_fenum_int_equiv = 650, */           /* -fenum-int-equiv */
  OPT_fexceptions = 651,                     /* -fexceptions */
  OPT_fexcess_precision_ = 652,              /* -fexcess-precision= */
  OPT_fexec_charset_ = 653,                  /* -fexec-charset= */
  OPT_fexpensive_optimizations = 654,        /* -fexpensive-optimizations */
  OPT_fext_numeric_literals = 655,           /* -fext-numeric-literals */
  OPT_fextdirs_ = 656,                       /* -fextdirs= */
  OPT_fextended_identifiers = 657,           /* -fextended-identifiers */
  OPT_fextern_tls_init = 658,                /* -fextern-tls-init */
  OPT_fexternal_blas = 659,                  /* -fexternal-blas */
  /* OPT_fexternal_templates = 660, */       /* -fexternal-templates */
  OPT_ff2c = 661,                            /* -ff2c */
  OPT_ffast_math = 662,                      /* -ffast-math */
  OPT_ffat_lto_objects = 663,                /* -ffat-lto-objects */
  OPT_ffilelist_file = 664,                  /* -ffilelist-file */
  ...
  OPT_fforce_classes_archive_check = 673,    /* -fforce-classes-archive-check */
  OPT_fforward_propagate = 674,              /* -fforward-propagate */
  OPT_ffp_contract_ = 675,                   /* -ffp-contract= */
  ...
  OPT_ffrontend_optimize = 683,              /* -ffrontend-optimize */
  OPT_ffunction_cse = 684,                   /* -ffunction-cse */
  OPT_ffunction_sections = 685,              /* -ffunction-sections */
  OPT_fgcse = 686,                           /* -fgcse */
  OPT_fgcse_after_reload = 687,              /* -fgcse-after-reload */
  OPT_fgcse_las = 688,                       /* -fgcse-las */
  OPT_fgcse_lm = 689,                        /* -fgcse-lm */
  OPT_fgcse_sm = 690,                        /* -fgcse-sm */
  OPT_fgnu_keywords = 691,                   /* -fgnu-keywords */
  OPT_fgnu_runtime = 692,                    /* -fgnu-runtime */
  OPT_fgnu_tm = 693,                         /* -fgnu-tm */
  OPT_fgnu_unique = 694,                     /* -fgnu-unique */
  OPT_fgnu89_inline = 695,                   /* -fgnu89-inline */
  OPT_fgo_check_divide_overflow = 696,       /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 697,           /* -fgo-check-divide-zero */
  OPT_fgo_dump_ = 698,                       /* -fgo-dump- */
  OPT_fgo_optimize_ = 699,                   /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 700,                    /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 701,                     /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 702,       /* -fgo-relative-import-path= */
  OPT_fgraphite = 703,                       /* -fgraphite */
  OPT_fgraphite_identity = 704,              /* -fgraphite-identity */
  OPT_fguess_branch_probability = 705,       /* -fguess-branch-probability */
  /* OPT_fguiding_decls = 706, */            /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 707, */        /* -fhandle-exceptions */
  OPT_fhash_synchronization = 708,           /* -fhash-synchronization */
  /* OPT_fhelp = 709, */                     /* -fhelp */
  /* OPT_fhelp_ = 710, */                    /* -fhelp= */
  OPT_fhoist_adjacent_loads = 711,           /* -fhoist-adjacent-loads */
  /* OPT_fhonor_std = 712, */                /* -fhonor-std */
  OPT_fhosted = 713,                         /* -fhosted */
  /* OPT_fhuge_objects = 714, */             /* -fhuge-objects */
  OPT_fident = 715,                          /* -fident */
  OPT_fif_conversion = 716,                  /* -fif-conversion */
  OPT_fif_conversion2 = 717,                 /* -fif-conversion2 */
  OPT_fimplement_inlines = 718,              /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 719,      /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 720,                  /* -fimplicit-none */
  OPT_fimplicit_templates = 721,             /* -fimplicit-templates */
  OPT_findirect_classes = 722,               /* -findirect-classes */
  OPT_findirect_dispatch = 723,              /* -findirect-dispatch */
  OPT_findirect_inlining = 724,              /* -findirect-inlining */
  OPT_finhibit_size_directive = 725,         /* -finhibit-size-directive */
  OPT_finit_character_ = 726,                /* -finit-character= */
  OPT_finit_integer_ = 727,                  /* -finit-integer= */
  OPT_finit_local_zero = 728,                /* -finit-local-zero */
  OPT_finit_logical_ = 729,                  /* -finit-logical= */
  OPT_finit_real_ = 730,                     /* -finit-real= */
  OPT_finline = 731,                         /* -finline */
  OPT_finline_atomics = 732,                 /* -finline-atomics */
  OPT_finline_functions = 733,               /* -finline-functions */
  OPT_finline_functions_called_once = 734,   /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 735, */            /* -finline-limit- */
  OPT_finline_limit_ = 736,                  /* -finline-limit= */
  OPT_finline_matmul_limit_ = 737,           /* -finline-matmul-limit= */
  OPT_finline_small_functions = 738,         /* -finline-small-functions */
  OPT_finput_charset_ = 739,                 /* -finput-charset= */
  OPT_finstrument_functions = 740,           /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 741,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 742,/* -finstrument-functions-exclude-function-list= */
  OPT_finteger_4_integer_8 = 743,            /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 744,         /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 745,        /* -fintrinsic-modules-path= */
  ...
  OPT_fira_algorithm_ = 760,                 /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 761,             /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 762,              /* -fira-loop-pressure */
  OPT_fira_region_ = 763,                    /* -fira-region= */
  OPT_fira_share_save_slots = 764,           /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 765,          /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 766,                   /* -fira-verbose= */
  OPT_fisolate_erroneous_paths_attribute = 767,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 768,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 769,               /* -fivar-visibility= */
  OPT_fivopts = 770,                         /* -fivopts */
  OPT_fjni = 771,                            /* -fjni */
  OPT_fjump_tables = 772,                    /* -fjump-tables */
  OPT_fkeep_inline_dllexport = 773,          /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 774,          /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 775,             /* -fkeep-static-consts */
  /* OPT_flabels_ok = 776, */                /* -flabels-ok */
  OPT_flax_vector_conversions = 777,         /* -flax-vector-conversions */
  OPT_fleading_underscore = 778,             /* -fleading-underscore */
  OPT_flifetime_dse = 779,                   /* -flifetime-dse */
  OPT_flive_range_shrinkage = 780,           /* -flive-range-shrinkage */
  OPT_flocal_ivars = 781,                    /* -flocal-ivars */
  /* OPT_floop_block = 782, */               /* -floop-block */
  /* OPT_floop_flatten = 783, */             /* -floop-flatten */
  /* OPT_floop_interchange = 784, */         /* -floop-interchange */
  OPT_floop_nest_optimize = 785,             /* -floop-nest-optimize */
  /* OPT_floop_optimize = 786, */            /* -floop-optimize */
  OPT_floop_parallelize_all = 787,           /* -floop-parallelize-all */
  /* OPT_floop_strip_mine = 788, */          /* -floop-strip-mine */
  /* OPT_floop_unroll_and_jam = 789, */      /* -floop-unroll-and-jam */
  OPT_flra_remat = 790,                      /* -flra-remat */
  OPT_flto = 791,                            /* -flto */
  OPT_flto_compression_level_ = 792,         /* -flto-compression-level= */
  OPT_flto_odr_type_merging = 793,           /* -flto-odr-type-merging */
  OPT_flto_partition_ = 794,                 /* -flto-partition= */
  OPT_flto_report = 795,                     /* -flto-report */
  OPT_flto_report_wpa = 796,                 /* -flto-report-wpa */
  OPT_flto_ = 797,                           /* -flto= */
  OPT_fltrans = 798,                         /* -fltrans */
  OPT_fltrans_output_list_ = 799,            /* -fltrans-output-list= */
  OPT_fmain_ = 800,                          /* -fmain= */
  OPT_fmath_errno = 801,                     /* -fmath-errno */
  OPT_fmax_array_constructor_ = 802,         /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 803,                    /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 804,         /* -fmax-identifier-length= */
  OPT_fmax_stack_var_size_ = 805,            /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 806,          /* -fmax-subrecord-length= */
  OPT_fmem_report = 807,                     /* -fmem-report */
  OPT_fmem_report_wpa = 808,                 /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 809,            /* -fmerge-all-constants */
  OPT_fmerge_constants = 810,                /* -fmerge-constants */
  OPT_fmerge_debug_strings = 811,            /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 812,                /* -fmessage-length= */
  OPT_fmodule_private = 813,                 /* -fmodule-private */
  OPT_fmodulo_sched = 814,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 815,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 816,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 817,                  /* -fms-extensions */
  /* OPT_fmudflap = 818, */                  /* -fmudflap */
  /* OPT_fmudflapir = 819, */                /* -fmudflapir */
  /* OPT_fmudflapth = 820, */                /* -fmudflapth */
  /* OPT_fname_mangling_version_ = 821, */   /* -fname-mangling-version- */
  /* OPT_fnew_abi = 822, */                  /* -fnew-abi */
  OPT_fnext_runtime = 823,                   /* -fnext-runtime */
  OPT_fnil_receivers = 824,                  /* -fnil-receivers */
  /* OPT_fno_vect_cost_model = 825, */       /* -fno-vect-cost-model */
  OPT_fnon_call_exceptions = 826,            /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 827,               /* -fnonansi-builtins */
  /* OPT_fnonnull_objects = 828, */          /* -fnonnull-objects */
  OPT_fnothrow_opt = 829,                    /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 830,              /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 831,           /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 832,           /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 833,                /* -fobjc-exceptions */
  OPT_fobjc_gc = 834,                        /* -fobjc-gc */
  OPT_fobjc_nilcheck = 835,                  /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 836,           /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 837,                 /* -fobjc-std=objc1 */
  OPT_foffload_abi_ = 838,                   /* -foffload-abi= */
  OPT_foffload_ = 839,                       /* -foffload= */
  OPT_fomit_frame_pointer = 840,             /* -fomit-frame-pointer */
  OPT_fopenacc = 841,                        /* -fopenacc */
  OPT_fopenmp = 842,                         /* -fopenmp */
  OPT_fopenmp_simd = 843,                    /* -fopenmp-simd */
  OPT_foperator_names = 844,                 /* -foperator-names */
  OPT_fopt_info = 845,                       /* -fopt-info */
  OPT_fopt_info_ = 846,                      /* -fopt-info- */
  /* OPT_foptimize_register_move = 847, */   /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 848,         /* -foptimize-sibling-calls */
  OPT_foptimize_static_class_initialization = 849,/* -foptimize-static-class-initialization */
  OPT_foptimize_strlen = 850,                /* -foptimize-strlen */
  /* OPT_foptional_diags = 851, */           /* -foptional-diags */
  OPT_foutput_class_dir_ = 852,              /* -foutput-class-dir= */
  OPT_fpack_derived = 853,                   /* -fpack-derived */
  OPT_fpack_struct = 854,                    /* -fpack-struct */
  OPT_fpack_struct_ = 855,                   /* -fpack-struct= */
  OPT_fpartial_inlining = 856,               /* -fpartial-inlining */
  OPT_fpcc_struct_return = 857,              /* -fpcc-struct-return */
  OPT_fpch_deps = 858,                       /* -fpch-deps */
  OPT_fpch_preprocess = 859,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 860,                     /* -fpeel-loops */
  OPT_fpeephole = 861,                       /* -fpeephole */
  OPT_fpeephole2 = 862,                      /* -fpeephole2 */
  OPT_fpermissive = 863,                     /* -fpermissive */
  OPT_fpic = 864,                            /* -fpic */
  OPT_fpie = 865,                            /* -fpie */
  OPT_fplan9_extensions = 866,               /* -fplan9-extensions */
  OPT_fplt = 867,                            /* -fplt */
  OPT_fplugin_arg_ = 868,                    /* -fplugin-arg- */
  OPT_fplugin_ = 869,                        /* -fplugin= */
  OPT_fpost_ipa_mem_report = 870,            /* -fpost-ipa-mem-report */
  OPT_fpre_ipa_mem_report = 871,             /* -fpre-ipa-mem-report */
  OPT_fpredictive_commoning = 872,           /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 873,           /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 874,                   /* -fpreprocessed */
  OPT_fpretty_templates = 875,               /* -fpretty-templates */
  OPT_fprofile = 876,                        /* -fprofile */
  OPT_fprofile_arcs = 877,                   /* -fprofile-arcs */
  OPT_fprofile_correction = 878,             /* -fprofile-correction */
  OPT_fprofile_dir_ = 879,                   /* -fprofile-dir= */
  OPT_fprofile_generate = 880,               /* -fprofile-generate */
  OPT_fprofile_generate_ = 881,              /* -fprofile-generate= */
  OPT_fprofile_reorder_functions = 882,      /* -fprofile-reorder-functions */
  OPT_fprofile_report = 883,                 /* -fprofile-report */
  OPT_fprofile_use = 884,                    /* -fprofile-use */
  OPT_fprofile_use_ = 885,                   /* -fprofile-use= */
  OPT_fprofile_values = 886,                 /* -fprofile-values */
  OPT_fprotect_parens = 887,                 /* -fprotect-parens */
  OPT_frandom_seed = 888,                    /* -frandom-seed */
  OPT_frandom_seed_ = 889,                   /* -frandom-seed= */
  OPT_frange_check = 890,                    /* -frange-check */
  OPT_freal_4_real_10 = 891,                 /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 892,                 /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 893,                  /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 894,                 /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 895,                 /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 896,                  /* -freal-8-real-4 */
  OPT_frealloc_lhs = 897,                    /* -frealloc-lhs */
  OPT_freciprocal_math = 898,                /* -freciprocal-math */
  OPT_frecord_gcc_switches = 899,            /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 900,                /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 901,                /* -frecord-marker=8 */
  OPT_frecursive = 902,                      /* -frecursive */
  OPT_freduced_reflection = 903,             /* -freduced-reflection */
  OPT_free = 904,                            /* -free */
  OPT_freg_struct_return = 905,              /* -freg-struct-return */
  /* OPT_fregmove = 906, */                  /* -fregmove */
  OPT_frename_registers = 907,               /* -frename-registers */
  OPT_freorder_blocks = 908,                 /* -freorder-blocks */
  OPT_freorder_blocks_and_partition = 909,   /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 910,              /* -freorder-functions */
  OPT_frepack_arrays = 911,                  /* -frepack-arrays */
  OPT_freplace_objc_classes = 912,           /* -freplace-objc-classes */
  OPT_frepo = 913,                           /* -frepo */
  OPT_freport_bug = 914,                     /* -freport-bug */
  OPT_frequire_return_statement = 915,       /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 916,           /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 917, */           /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 918,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 919,                    /* -fresolution= */
  OPT_frounding_math = 920,                  /* -frounding-math */
  OPT_frtti = 921,                           /* -frtti */
  ...
  OPT_fsaw_java_file = 927,                  /* -fsaw-java-file */
  OPT_fsched_critical_path_heuristic = 928,  /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 929,      /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 930,          /* -fsched-group-heuristic */
  OPT_fsched_interblock = 931,               /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 932,      /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 933,                 /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 934,           /* -fsched-rank-heuristic */
  OPT_fsched_spec = 935,                     /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 936,      /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 937,                /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 938,      /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 939,            /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 940,        /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 941,       /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 942,           /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 943,                 /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 944,         /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 945, */        /* -fsched2-use-traces */
  OPT_fschedule_fusion = 946,                /* -fschedule-fusion */
  OPT_fschedule_insns = 947,                 /* -fschedule-insns */
  OPT_fschedule_insns2 = 948,                /* -fschedule-insns2 */
  OPT_fsecond_underscore = 949,              /* -fsecond-underscore */
  OPT_fsection_anchors = 950,                /* -fsection-anchors */
  /* OPT_fsee = 951, */                      /* -fsee */
  OPT_fsel_sched_pipelining = 952,           /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 953,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 954, /* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 955,           /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 956,          /* -fselective-scheduling2 */
  OPT_fsemantic_interposition = 957,         /* -fsemantic-interposition */
  OPT_fshort_double = 958,                   /* -fshort-double */
  OPT_fshort_enums = 959,                    /* -fshort-enums */
  OPT_fshort_wchar = 960,                    /* -fshort-wchar */
  OPT_fshow_column = 961,                    /* -fshow-column */
  OPT_fshrink_wrap = 962,                    /* -fshrink-wrap */
  ...
  OPT_fsource_filename_ = 971,               /* -fsource-filename= */
  OPT_fsource_ = 972,                        /* -fsource= */
  OPT_fsplit_ivs_in_unroller = 973,          /* -fsplit-ivs-in-unroller */
  OPT_fsplit_stack = 974,                    /* -fsplit-stack */
  OPT_fsplit_wide_types = 975,               /* -fsplit-wide-types */
  /* OPT_fsquangle = 976, */                 /* -fsquangle */
  OPT_fssa_phiopt = 977,                     /* -fssa-phiopt */
  ...
  OPT_fstore_check = 992,                    /* -fstore-check */
  ...
  OPT_fsync_libcalls = 999,                  /* -fsync-libcalls */
  OPT_fsyntax_only = 1000,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1001,                      /* -ftabstop= */
  /* OPT_ftarget_help = 1002, */             /* -ftarget-help */
  OPT_ftarget_ = 1003,                       /* -ftarget= */
  OPT_ftemplate_backtrace_limit_ = 1004,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1005, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1006,               /* -ftemplate-depth= */
  OPT_ftest_coverage = 1007,                 /* -ftest-coverage */
  /* OPT_fthis_is_variable = 1008, */        /* -fthis-is-variable */
  OPT_fthread_jumps = 1009,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1010,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1011,                   /* -ftime-report */
  OPT_ftls_model_ = 1012,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1013,              /* -ftoplevel-reorder */
  OPT_ftracer = 1014,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1015,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1016,        /* -ftrack-macro-expansion= */
  ...
  OPT_funderscoring = 1064,                  /* -funderscoring */
  OPT_funit_at_a_time = 1065,                /* -funit-at-a-time */
  OPT_funroll_all_loops = 1066,              /* -funroll-all-loops */
  OPT_funroll_loops = 1067,                  /* -funroll-loops */
  OPT_funsafe_loop_optimizations = 1068,     /* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1069,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1070,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1071,                 /* -funsigned-char */
  OPT_funswitch_loops = 1072,                /* -funswitch-loops */
  OPT_funwind_tables = 1073,                 /* -funwind-tables */
  OPT_fuse_atomic_builtins = 1074,           /* -fuse-atomic-builtins */
  OPT_fuse_boehm_gc = 1075,                  /* -fuse-boehm-gc */
  OPT_fuse_cxa_atexit = 1076,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1077,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_divide_subroutine = 1078,         /* -fuse-divide-subroutine */
  OPT_fuse_ld_bfd = 1079,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1080,                   /* -fuse-ld=gold */
  OPT_fuse_linker_plugin = 1081,             /* -fuse-linker-plugin */
  OPT_fvar_tracking = 1082,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1083,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1084,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1085,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1086,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1087, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1088,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1089,                   /* -fverbose-asm */
  /* OPT_fversion = 1090, */                 /* -fversion */
  OPT_fvisibility_inlines_hidden = 1091,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1092,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1093,                   /* -fvisibility= */
  OPT_fvpt = 1094,                           /* -fvpt */
  /* OPT_fvtable_gc = 1095, */               /* -fvtable-gc */
  /* OPT_fvtable_thunks = 1096, */           /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1097,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1098,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1099,                     /* -fvtv-debug */
  OPT_fweak = 1100,                          /* -fweak */
  OPT_fweb = 1101,                           /* -fweb */
  /* OPT_fwhole_file = 1102, */              /* -fwhole-file */
  OPT_fwhole_program = 1103,                 /* -fwhole-program */
  OPT_fwide_exec_charset_ = 1104,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1105,             /* -fworking-directory */
  OPT_fwpa = 1106,                           /* -fwpa */
  OPT_fwpa_ = 1107,                          /* -fwpa= */
  OPT_fwrapv = 1108,                         /* -fwrapv */
  /* OPT_fxref = 1109, */                    /* -fxref */
  /* OPT_fzee = 1110, */                     /* -fzee */
  OPT_fzero_initialized_in_bss = 1111,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1112,                     /* -fzero-link */
  OPT_g = 1113,                              /* -g */
  OPT_gant = 1114,                           /* -gant */
  OPT_gcoff = 1115,                          /* -gcoff */
  OPT_gdwarf = 1116,                         /* -gdwarf */
  OPT_gdwarf_ = 1117,                        /* -gdwarf- */
  OPT_gen_decls = 1118,                      /* -gen-decls */
  OPT_ggdb = 1119,                           /* -ggdb */
  OPT_ggnu_pubnames = 1120,                  /* -ggnu-pubnames */
  OPT_gnat = 1121,                           /* -gnat */
  OPT_gnatO = 1122,                          /* -gnatO */
  ...
  OPT_m128bit_long_double = 1155,            /* -m128bit-long-double */
  OPT_m16 = 1156,                            /* -m16 */
  OPT_m32 = 1157,                            /* -m32 */
  OPT_m3dnow = 1158,                         /* -m3dnow */
  OPT_m3dnowa = 1159,                        /* -m3dnowa */
  OPT_m64 = 1160,                            /* -m64 */
  OPT_m80387 = 1161,                         /* -m80387 */
  OPT_m8bit_idiv = 1162,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1163,             /* -m96bit-long-double */
  OPT_mabi_ = 1164,                          /* -mabi= */
  OPT_mabm = 1165,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1166,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1167,                 /* -maddress-mode= */
  OPT_madx = 1168,                           /* -madx */
  OPT_maes = 1169,                           /* -maes */
  OPT_malign_data_ = 1170,                   /* -malign-data= */
  OPT_malign_double = 1171,                  /* -malign-double */
  OPT_malign_functions_ = 1172,              /* -malign-functions= */
  OPT_malign_jumps_ = 1173,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1174,                  /* -malign-loops= */
  OPT_malign_stringops = 1175,               /* -malign-stringops */
  OPT_mandroid = 1176,                       /* -mandroid */
  OPT_march_ = 1177,                         /* -march= */
  OPT_masm_ = 1178,                          /* -masm= */
  OPT_mavx = 1179,                           /* -mavx */
  OPT_mavx2 = 1180,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1181,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1182,  /* -mavx256-split-unaligned-store */
  OPT_mavx512bw = 1183,                      /* -mavx512bw */
  OPT_mavx512cd = 1184,                      /* -mavx512cd */
  OPT_mavx512dq = 1185,                      /* -mavx512dq */
  OPT_mavx512er = 1186,                      /* -mavx512er */
  OPT_mavx512f = 1187,                       /* -mavx512f */
  OPT_mavx512ifma = 1188,                    /* -mavx512ifma */
  OPT_mavx512pf = 1189,                      /* -mavx512pf */
  OPT_mavx512vbmi = 1190,                    /* -mavx512vbmi */
  OPT_mavx512vl = 1191,                      /* -mavx512vl */
  ...
  /* OPT_mcpu_ = 1200, */                    /* -mcpu= */
  OPT_mcrc32 = 1201,                         /* -mcrc32 */
  OPT_mcx16 = 1202,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1203,            /* -mdispatch-scheduler */
  OPT_mdump_tune_features = 1204,            /* -mdump-tune-features */
  OPT_mf16c = 1205,                          /* -mf16c */
  OPT_mfancy_math_387 = 1206,                /* -mfancy-math-387 */
  OPT_mfentry = 1207,                        /* -mfentry */
  OPT_mfma = 1208,                           /* -mfma */
  OPT_mfma4 = 1209,                          /* -mfma4 */
  OPT_mforce_drap = 1210,                    /* -mforce-drap */
  OPT_mfp_ret_in_387 = 1211,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1212,                       /* -mfpmath= */
  OPT_mfsgsbase = 1213,                      /* -mfsgsbase */
  ...
  OPT_mmmx = 1233,                           /* -mmmx */
  OPT_mmovbe = 1234,                         /* -mmovbe */
  OPT_mmpx = 1235,                           /* -mmpx */
  OPT_mms_bitfields = 1236,                  /* -mms-bitfields */
  OPT_mmusl = 1237,                          /* -mmusl */
  OPT_mmwaitx = 1238,                        /* -mmwaitx */
  OPT_mno_align_stringops = 1239,            /* -mno-align-stringops */
  OPT_mno_default = 1240,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1241,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1242,                  /* -mno-push-args */
  OPT_mno_red_zone = 1243,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1244,                       /* -mno-sse4 */
  OPT_mnop_mcount = 1245,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 1246,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1247,                          /* -mpc32 */
  OPT_mpc64 = 1248,                          /* -mpc64 */
  OPT_mpc80 = 1249,                          /* -mpc80 */
  OPT_mpclmul = 1250,                        /* -mpclmul */
  OPT_mpcommit = 1251,                       /* -mpcommit */
  OPT_mpopcnt = 1252,                        /* -mpopcnt */
  OPT_mprefer_avx128 = 1253,                 /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 1254,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1255,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1256,                        /* -mprfchw */
  OPT_mpush_args = 1257,                     /* -mpush-args */
  OPT_mrdrnd = 1258,                         /* -mrdrnd */
  OPT_mrdseed = 1259,                        /* -mrdseed */
  OPT_mrecip = 1260,                         /* -mrecip */
  OPT_mrecip_ = 1261,                        /* -mrecip= */
  OPT_mrecord_mcount = 1262,                 /* -mrecord-mcount */
  OPT_mred_zone = 1263,                      /* -mred-zone */
  OPT_mregparm_ = 1264,                      /* -mregparm= */
  OPT_mrtd = 1265,                           /* -mrtd */
  OPT_mrtm = 1266,                           /* -mrtm */
  OPT_msahf = 1267,                          /* -msahf */
  OPT_msha = 1268,                           /* -msha */
  OPT_mskip_rax_setup = 1269,                /* -mskip-rax-setup */
  OPT_msoft_float = 1270,                    /* -msoft-float */
  OPT_msse = 1271,                           /* -msse */
  OPT_msse2 = 1272,                          /* -msse2 */
  OPT_msse2avx = 1273,                       /* -msse2avx */
  OPT_msse3 = 1274,                          /* -msse3 */
  OPT_msse4 = 1275,                          /* -msse4 */
  OPT_msse4_1 = 1276,                        /* -msse4.1 */
  OPT_msse4_2 = 1277,                        /* -msse4.2 */
  OPT_msse4a = 1278,                         /* -msse4a */
  /* OPT_msse5 = 1279, */                    /* -msse5 */
  OPT_msseregparm = 1280,                    /* -msseregparm */
  OPT_mssse3 = 1281,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1282,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_ = 1283,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1284,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1285,            /* -mstringop-strategy= */
  OPT_mtbm = 1286,                           /* -mtbm */
  OPT_mtls_dialect_ = 1287,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1288,           /* -mtls-direct-seg-refs */
  OPT_mtune_ctrl_ = 1289,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1290,                         /* -mtune= */
  OPT_muclibc = 1291,                        /* -muclibc */
  OPT_mveclibabi_ = 1292,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1293,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1294,                    /* -mvzeroupper */
  OPT_mx32 = 1295,                           /* -mx32 */
  OPT_mxop = 1296,                           /* -mxop */
  OPT_mxsave = 1297,                         /* -mxsave */
  OPT_mxsavec = 1298,                        /* -mxsavec */
  OPT_mxsaveopt = 1299,                      /* -mxsaveopt */
  OPT_mxsaves = 1300,                        /* -mxsaves */
  OPT_n = 1301,                              /* -n */
  ...
  OPT_nostartfiles = 1307,                   /* -nostartfiles */
  OPT_nostdinc = 1308,                       /* -nostdinc */
  OPT_nostdinc__ = 1309,                     /* -nostdinc++ */
  OPT_nostdlib = 1310,                       /* -nostdlib */
  OPT_o = 1311,                              /* -o */
  OPT_p = 1312,                              /* -p */
  OPT_pass_exit_codes = 1313,                /* -pass-exit-codes */
  /* OPT_pedantic = 1314, */                 /* -pedantic */
  OPT_pedantic_errors = 1315,                /* -pedantic-errors */
  OPT_pg = 1316,                             /* -pg */
  OPT_pie = 1317,                            /* -pie */
  OPT_pipe = 1318,                           /* -pipe */
  OPT_posix = 1319,                          /* -posix */
  OPT_print_file_name_ = 1320,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1321,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1322,          /* -print-multi-directory */
  OPT_print_multi_lib = 1323,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1324,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1325,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1326,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1327,               /* -print-prog-name= */
  OPT_print_search_dirs = 1328,              /* -print-search-dirs */
  OPT_print_sysroot = 1329,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1330,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1331,                        /* -profile */
  OPT_pthread = 1332,                        /* -pthread */
  OPT_quiet = 1333,                          /* -quiet */
  OPT_r = 1334,                              /* -r */
  OPT_rdynamic = 1335,                       /* -rdynamic */
  OPT_remap = 1336,                          /* -remap */
  OPT_s = 1337,                              /* -s */
  OPT_s_bc_abi = 1338,                       /* -s-bc-abi */
  OPT_save_temps = 1339,                     /* -save-temps */
  OPT_save_temps_ = 1340,                    /* -save-temps= */
  OPT_shared = 1341,                         /* -shared */
  OPT_shared_libgcc = 1342,                  /* -shared-libgcc */
  /* OPT_specs = 1343, */                    /* -specs */
  OPT_specs_ = 1344,                         /* -specs= */
  OPT_static = 1345,                         /* -static */
  OPT_static_libasan = 1346,                 /* -static-libasan */
  OPT_static_libgcc = 1347,                  /* -static-libgcc */
  OPT_static_libgcj = 1348,                  /* -static-libgcj */
  ...
  OPT_static_libstdc__ = 1354,               /* -static-libstdc++ */
  OPT_static_libtsan = 1355,                 /* -static-libtsan */
  OPT_static_libubsan = 1356,                /* -static-libubsan */
  ...
  /* OPT_std_c1x = 1366, */                  /* -std=c1x */
  /* OPT_std_c89 = 1367, */                  /* -std=c89 */
  OPT_std_c90 = 1368,                        /* -std=c90 */
  OPT_std_c99 = 1369,                        /* -std=c99 */
  /* OPT_std_c9x = 1370, */                  /* -std=c9x */
  OPT_std_f2003 = 1371,                      /* -std=f2003 */
  OPT_std_f2008 = 1372,                      /* -std=f2008 */
  OPT_std_f2008ts = 1373,                    /* -std=f2008ts */
  ...
  OPT_std_gnu__98 = 1383,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1384,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1385, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1386, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1387,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1388,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1389, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1390, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1391,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1392, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1393, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1394, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1395,                     /* -std=legacy */
  OPT_symbolic = 1396,                       /* -symbolic */
  OPT_t = 1397,                              /* -t */
  OPT_time = 1398,                           /* -time */
  OPT_time_ = 1399,                          /* -time= */
  OPT_tno_android_cc = 1400,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1401,                 /* -tno-android-ld */
  OPT_traditional = 1402,                    /* -traditional */
  OPT_traditional_cpp = 1403,                /* -traditional-cpp */
  OPT_trigraphs = 1404,                      /* -trigraphs */
  OPT_u = 1405,                              /* -u */
  OPT_undef = 1406,                          /* -undef */
  OPT_v = 1407,                              /* -v */
  OPT_version = 1408,                        /* -version */
  OPT_w = 1409,                              /* -w */
  OPT_wrapper = 1410,                        /* -wrapper */
  OPT_x = 1411,                              /* -x */
  OPT_z = 1412,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
