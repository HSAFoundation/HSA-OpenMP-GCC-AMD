...
enum opt_code
{
  ...
  OPT_Wnull = 318,                           /* -Wnull */
  OPT_Wnull_dereference = 319,               /* -Wnull-dereference */
  OPT_Wodr = 320,                            /* -Wodr */
  OPT_Wold_style_cast = 321,                 /* -Wold-style-cast */
  OPT_Wold_style_declaration = 322,          /* -Wold-style-declaration */
  OPT_Wold_style_definition = 323,           /* -Wold-style-definition */
  OPT_Wopenmp_simd = 324,                    /* -Wopenmp-simd */
  OPT_Wout_of_date = 325,                    /* -Wout-of-date */
  OPT_Wover_ann = 326,                       /* -Wover-ann */
  OPT_Woverflow = 327,                       /* -Woverflow */
  OPT_Woverlength_strings = 328,             /* -Woverlength-strings */
  OPT_Woverloaded_virtual = 329,             /* -Woverloaded-virtual */
  OPT_Woverride_init = 330,                  /* -Woverride-init */
  OPT_Woverride_init_side_effects = 331,     /* -Woverride-init-side-effects */
  OPT_Wp_ = 332,                             /* -Wp, */
  OPT_Wpacked = 333,                         /* -Wpacked */
  OPT_Wpacked_bitfield_compat = 334,         /* -Wpacked-bitfield-compat */
  OPT_Wpadded = 335,                         /* -Wpadded */
  OPT_Wparam_assign = 336,                   /* -Wparam-assign */
  OPT_Wparentheses = 337,                    /* -Wparentheses */
  OPT_Wpedantic = 338,                       /* -Wpedantic */
  OPT_Wpkg_default_method = 339,             /* -Wpkg-default-method */
  OPT_Wpmf_conversions = 340,                /* -Wpmf-conversions */
  OPT_Wpointer_arith = 341,                  /* -Wpointer-arith */
  OPT_Wpointer_sign = 342,                   /* -Wpointer-sign */
  OPT_Wpointer_to_int_cast = 343,            /* -Wpointer-to-int-cast */
  OPT_Wpragmas = 344,                        /* -Wpragmas */
  OPT_Wproperty_assign_default = 345,        /* -Wproperty-assign-default */
  OPT_Wprotocol = 346,                       /* -Wprotocol */
  OPT_Wpsabi = 347,                          /* -Wpsabi */
  OPT_Wraw = 348,                            /* -Wraw */
  ...
  OPT_Wredundant_modifiers = 353,            /* -Wredundant-modifiers */
  OPT_Wreorder = 354,                        /* -Wreorder */
  OPT_Wreturn_local_addr = 355,              /* -Wreturn-local-addr */
  OPT_Wreturn_type = 356,                    /* -Wreturn-type */
  OPT_Wselector = 357,                       /* -Wselector */
  OPT_Wsequence_point = 358,                 /* -Wsequence-point */
  OPT_Wserial = 359,                         /* -Wserial */
  OPT_Wshadow = 360,                         /* -Wshadow */
  OPT_Wshadow_ivar = 361,                    /* -Wshadow-ivar */
  OPT_Wshift_count_negative = 362,           /* -Wshift-count-negative */
  OPT_Wshift_count_overflow = 363,           /* -Wshift-count-overflow */
  OPT_Wshift_negative_value = 364,           /* -Wshift-negative-value */
  /* OPT_Wshift_overflow = 365, */           /* -Wshift-overflow */
  OPT_Wshift_overflow_ = 366,                /* -Wshift-overflow= */
  OPT_Wsign_compare = 367,                   /* -Wsign-compare */
  OPT_Wsign_conversion = 368,                /* -Wsign-conversion */
  OPT_Wsign_promo = 369,                     /* -Wsign-promo */
  OPT_Wsized_deallocation = 370,             /* -Wsized-deallocation */
  OPT_Wsizeof_array_argument = 371,          /* -Wsizeof-array-argument */
  OPT_Wsizeof_pointer_memaccess = 372,       /* -Wsizeof-pointer-memaccess */
  OPT_Wspecial_param_hiding = 373,           /* -Wspecial-param-hiding */
  OPT_Wstack_protector = 374,                /* -Wstack-protector */
  OPT_Wstack_usage_ = 375,                   /* -Wstack-usage= */
  OPT_Wstatic_access = 376,                  /* -Wstatic-access */
  OPT_Wstatic_receiver = 377,                /* -Wstatic-receiver */
  OPT_Wstrict_aliasing = 378,                /* -Wstrict-aliasing */
  OPT_Wstrict_aliasing_ = 379,               /* -Wstrict-aliasing= */
  OPT_Wstrict_null_sentinel = 380,           /* -Wstrict-null-sentinel */
  OPT_Wstrict_overflow = 381,                /* -Wstrict-overflow */
  OPT_Wstrict_overflow_ = 382,               /* -Wstrict-overflow= */
  OPT_Wstrict_prototypes = 383,              /* -Wstrict-prototypes */
  OPT_Wstrict_selector_match = 384,          /* -Wstrict-selector-match */
  OPT_Wsubobject_linkage = 385,              /* -Wsubobject-linkage */
  OPT_Wsuggest_attribute_const = 386,        /* -Wsuggest-attribute=const */
  OPT_Wsuggest_attribute_format = 387,       /* -Wsuggest-attribute=format */
  OPT_Wsuggest_attribute_noreturn = 388,     /* -Wsuggest-attribute=noreturn */
  OPT_Wsuggest_attribute_pure = 389,         /* -Wsuggest-attribute=pure */
  OPT_Wsuggest_final_methods = 390,          /* -Wsuggest-final-methods */
  OPT_Wsuggest_final_types = 391,            /* -Wsuggest-final-types */
  OPT_Wsuggest_override = 392,               /* -Wsuggest-override */
  OPT_Wsuppress = 393,                       /* -Wsuppress */
  OPT_Wsurprising = 394,                     /* -Wsurprising */
  OPT_Wswitch = 395,                         /* -Wswitch */
  OPT_Wswitch_bool = 396,                    /* -Wswitch-bool */
  OPT_Wswitch_default = 397,                 /* -Wswitch-default */
  OPT_Wswitch_enum = 398,                    /* -Wswitch-enum */
  OPT_Wsync_nand = 399,                      /* -Wsync-nand */
  OPT_Wsynth = 400,                          /* -Wsynth */
  OPT_Wsynthetic_access = 401,               /* -Wsynthetic-access */
  OPT_Wsystem_headers = 402,                 /* -Wsystem-headers */
  OPT_Wtabs = 403,                           /* -Wtabs */
  OPT_Wtarget_lifetime = 404,                /* -Wtarget-lifetime */
  OPT_Wtasks = 405,                          /* -Wtasks */
  OPT_Wtautological_compare = 406,           /* -Wtautological-compare */
  OPT_Wtemplates = 407,                      /* -Wtemplates */
  OPT_Wterminate = 408,                      /* -Wterminate */
  OPT_Wtraditional = 409,                    /* -Wtraditional */
  OPT_Wtraditional_conversion = 410,         /* -Wtraditional-conversion */
  OPT_Wtrampolines = 411,                    /* -Wtrampolines */
  OPT_Wtrigraphs = 412,                      /* -Wtrigraphs */
  OPT_Wtype_hiding = 413,                    /* -Wtype-hiding */
  OPT_Wtype_limits = 414,                    /* -Wtype-limits */
  OPT_Wuncheck = 415,                        /* -Wuncheck */
  OPT_Wundeclared_selector = 416,            /* -Wundeclared-selector */
  OPT_Wundef = 417,                          /* -Wundef */
  OPT_Wunderflow = 418,                      /* -Wunderflow */
  OPT_Wuninitialized = 419,                  /* -Wuninitialized */
  OPT_Wunknown_pragmas = 420,                /* -Wunknown-pragmas */
  OPT_Wunnecessary_else = 421,               /* -Wunnecessary-else */
  OPT_Wunqualified_field = 422,              /* -Wunqualified-field */
  /* OPT_Wunreachable_code = 423, */         /* -Wunreachable-code */
  OPT_Wunsafe_loop_optimizations = 424,      /* -Wunsafe-loop-optimizations */
  OPT_Wunsuffixed_float_constants = 425,     /* -Wunsuffixed-float-constants */
  OPT_Wunused = 426,                         /* -Wunused */
  OPT_Wunused_argument = 427,                /* -Wunused-argument */
  ...
  OPT_Wunused_dummy_argument = 431,          /* -Wunused-dummy-argument */
  OPT_Wunused_function = 432,                /* -Wunused-function */
  OPT_Wunused_import = 433,                  /* -Wunused-import */
  OPT_Wunused_label = 434,                   /* -Wunused-label */
  OPT_Wunused_local = 435,                   /* -Wunused-local */
  ...
  OPT_Wunused_private = 439,                 /* -Wunused-private */
  OPT_Wunused_result = 440,                  /* -Wunused-result */
  OPT_Wunused_thrown = 441,                  /* -Wunused-thrown */
  ...
  OPT_Wuseless_type_check = 446,             /* -Wuseless-type-check */
  OPT_Wvarargs = 447,                        /* -Wvarargs */
  OPT_Wvarargs_cast = 448,                   /* -Wvarargs-cast */
  OPT_Wvariadic_macros = 449,                /* -Wvariadic-macros */
  OPT_Wvector_operation_performance = 450,   /* -Wvector-operation-performance */
  OPT_Wvirtual_inheritance = 451,            /* -Wvirtual-inheritance */
  OPT_Wvirtual_move_assign = 452,            /* -Wvirtual-move-assign */
  OPT_Wvla = 453,                            /* -Wvla */
  OPT_Wvolatile_register_var = 454,          /* -Wvolatile-register-var */
  OPT_Wwarning_token = 455,                  /* -Wwarning-token */
  OPT_Wwrite_strings = 456,                  /* -Wwrite-strings */
  OPT_Wzero_as_null_pointer_constant = 457,  /* -Wzero-as-null-pointer-constant */
  OPT_Wzerotrip = 458,                       /* -Wzerotrip */
  OPT_Xassembler = 459,                      /* -Xassembler */
  OPT_Xlinker = 460,                         /* -Xlinker */
  OPT_Xpreprocessor = 461,                   /* -Xpreprocessor */
  OPT_Z = 462,                               /* -Z */
  OPT_ansi = 463,                            /* -ansi */
  OPT_aux_info = 464,                        /* -aux-info */
  /* OPT_aux_info_ = 465, */                 /* -aux-info= */
  OPT_auxbase = 466,                         /* -auxbase */
  OPT_auxbase_strip = 467,                   /* -auxbase-strip */
  /* OPT_bootclasspath = 468, */             /* -bootclasspath */
  OPT_c = 469,                               /* -c */
  /* OPT_classpath = 470, */                 /* -classpath */
  OPT_coverage = 471,                        /* -coverage */
  OPT_cpp = 472,                             /* -cpp */
  OPT_cpp_ = 473,                            /* -cpp= */
  OPT_d = 474,                               /* -d */
  OPT_dumpbase = 475,                        /* -dumpbase */
  OPT_dumpdir = 476,                         /* -dumpdir */
  OPT_dumpmachine = 477,                     /* -dumpmachine */
  OPT_dumpspecs = 478,                       /* -dumpspecs */
  OPT_dumpversion = 479,                     /* -dumpversion */
  OPT_e = 480,                               /* -e */
  /* OPT_encoding = 481, */                  /* -encoding */
  OPT_export_dynamic = 482,                  /* -export-dynamic */
  OPT_extdirs = 483,                         /* -extdirs */
  /* OPT_fCLASSPATH_ = 484, */               /* -fCLASSPATH= */
  OPT_fPIC = 485,                            /* -fPIC */
  OPT_fPIE = 486,                            /* -fPIE */
  OPT_fRTS_ = 487,                           /* -fRTS= */
  OPT_fabi_compat_version_ = 488,            /* -fabi-compat-version= */
  OPT_fabi_version_ = 489,                   /* -fabi-version= */
  OPT_faccess_control = 490,                 /* -faccess-control */
  OPT_fada_spec_parent_ = 491,               /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 492,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 493,  /* -faggressive-loop-optimizations */
  OPT_falign_commons = 494,                  /* -falign-commons */
  OPT_falign_functions = 495,                /* -falign-functions */
  OPT_falign_functions_ = 496,               /* -falign-functions= */
  OPT_falign_jumps = 497,                    /* -falign-jumps */
  OPT_falign_jumps_ = 498,                   /* -falign-jumps= */
  OPT_falign_labels = 499,                   /* -falign-labels */
  OPT_falign_labels_ = 500,                  /* -falign-labels= */
  OPT_falign_loops = 501,                    /* -falign-loops */
  OPT_falign_loops_ = 502,                   /* -falign-loops= */
  OPT_fall_intrinsics = 503,                 /* -fall-intrinsics */
  /* OPT_fall_virtual = 504, */              /* -fall-virtual */
  OPT_fallow_leading_underscore = 505,       /* -fallow-leading-underscore */
  OPT_fallow_parameterless_variadic_functions = 506,/* -fallow-parameterless-variadic-functions */
  /* OPT_falt_external_templates = 507, */   /* -falt-external-templates */
  ...
  OPT_fasan_shadow_offset_ = 512,            /* -fasan-shadow-offset= */
  OPT_fasm = 513,                            /* -fasm */
  OPT_fassert = 514,                         /* -fassert */
  OPT_fassociative_math = 515,               /* -fassociative-math */
  OPT_fassume_compiled = 516,                /* -fassume-compiled */
  OPT_fassume_compiled_ = 517,               /* -fassume-compiled= */
  OPT_fasynchronous_unwind_tables = 518,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 519,                   /* -fauto-inc-dec */
  OPT_fauto_profile = 520,                   /* -fauto-profile */
  OPT_fauto_profile_ = 521,                  /* -fauto-profile= */
  OPT_fautomatic = 522,                      /* -fautomatic */
  OPT_faux_classpath = 523,                  /* -faux-classpath */
  OPT_fbackslash = 524,                      /* -fbackslash */
  OPT_fbacktrace = 525,                      /* -fbacktrace */
  OPT_fblas_matmul_limit_ = 526,             /* -fblas-matmul-limit= */
  OPT_fbootclasspath_ = 527,                 /* -fbootclasspath= */
  OPT_fbootstrap_classes = 528,              /* -fbootstrap-classes */
  OPT_fbounds_check = 529,                   /* -fbounds-check */
  ...
  OPT_fcall_saved_ = 539,                    /* -fcall-saved- */
  OPT_fcall_used_ = 540,                     /* -fcall-used- */
  OPT_fcaller_saves = 541,                   /* -fcaller-saves */
  OPT_fcanonical_system_headers = 542,       /* -fcanonical-system-headers */
  OPT_fcheck_array_temporaries = 543,        /* -fcheck-array-temporaries */
  OPT_fcheck_data_deps = 544,                /* -fcheck-data-deps */
  OPT_fcheck_new = 545,                      /* -fcheck-new */
  OPT_fcheck_pointer_bounds = 546,           /* -fcheck-pointer-bounds */
  OPT_fcheck_references = 547,               /* -fcheck-references */
  OPT_fcheck_ = 548,                         /* -fcheck= */
  OPT_fchecking = 549,                       /* -fchecking */
  OPT_fchkp_check_incomplete_type = 550,     /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 551,                /* -fchkp-check-read */
  OPT_fchkp_check_write = 552,               /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 553,/* -fchkp-first-field-has-own-bounds */
  OPT_fchkp_instrument_calls = 554,          /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 555,    /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 556,             /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 557, /* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 558,                  /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 559,              /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 560,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 561, /* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 562,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 563,         /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 564,   /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 565,              /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 566,/* -fchkp-zero-input-bounds-for-main */
  OPT_fcilkplus = 567,                       /* -fcilkplus */
  OPT_fclasspath_ = 568,                     /* -fclasspath= */
  OPT_fcoarray_ = 569,                       /* -fcoarray= */
  OPT_fcombine_stack_adjustments = 570,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 571,                         /* -fcommon */
  OPT_fcompare_debug = 572,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 573,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 574,                 /* -fcompare-debug= */
  OPT_fcompare_elim = 575,                   /* -fcompare-elim */
  OPT_fcompile_resource_ = 576,              /* -fcompile-resource= */
  OPT_fconcepts = 577,                       /* -fconcepts */
  OPT_fcond_mismatch = 578,                  /* -fcond-mismatch */
  OPT_fconserve_space = 579,                 /* -fconserve-space */
  OPT_fconserve_stack = 580,                 /* -fconserve-stack */
  OPT_fconstant_string_class_ = 581,         /* -fconstant-string-class= */
  OPT_fconstexpr_depth_ = 582,               /* -fconstexpr-depth= */
  OPT_fconvert_ = 583,                       /* -fconvert= */
  OPT_fcprop_registers = 584,                /* -fcprop-registers */
  OPT_fcray_pointer = 585,                   /* -fcray-pointer */
  OPT_fcrossjumping = 586,                   /* -fcrossjumping */
  OPT_fcse_follow_jumps = 587,               /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 588, */          /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 589,               /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 590,               /* -fcx-limited-range */
  OPT_fd_lines_as_code = 591,                /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 592,            /* -fd-lines-as-comments */
  OPT_fdata_sections = 593,                  /* -fdata-sections */
  OPT_fdbg_cnt_list = 594,                   /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 595,                       /* -fdbg-cnt= */
  OPT_fdce = 596,                            /* -fdce */
  OPT_fdebug_cpp = 597,                      /* -fdebug-cpp */
  OPT_fdebug_prefix_map_ = 598,              /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 599,            /* -fdebug-types-section */
  OPT_fdeclone_ctor_dtor = 600,              /* -fdeclone-ctor-dtor */
  OPT_fdeduce_init_list = 601,               /* -fdeduce-init-list */
  OPT_fdefault_double_8 = 602,               /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 603, */           /* -fdefault-inline */
  OPT_fdefault_integer_8 = 604,              /* -fdefault-integer-8 */
  OPT_fdefault_real_8 = 605,                 /* -fdefault-real-8 */
  OPT_fdefer_pop = 606,                      /* -fdefer-pop */
  OPT_fdelayed_branch = 607,                 /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 608,         /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 609,     /* -fdelete-null-pointer-checks */
  OPT_fdevirtualize = 610,                   /* -fdevirtualize */
  OPT_fdevirtualize_at_ltrans = 611,         /* -fdevirtualize-at-ltrans */
  OPT_fdevirtualize_speculatively = 612,     /* -fdevirtualize-speculatively */
  /* OPT_fdiagnostics_color = 613, */        /* -fdiagnostics-color */
  OPT_fdiagnostics_color_ = 614,             /* -fdiagnostics-color= */
  ...
  OPT_fdirectives_only = 618,                /* -fdirectives-only */
  OPT_fdisable_ = 619,                       /* -fdisable- */
  OPT_fdisable_assertions = 620,             /* -fdisable-assertions */
  OPT_fdisable_assertions_ = 621,            /* -fdisable-assertions= */
  ...
  OPT_femit_class_file = 647,                /* -femit-class-file */
  OPT_femit_class_files = 648,               /* -femit-class-files */
  OPT_femit_struct_debug_baseonly = 649,     /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 650,    /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 651,      /* -femit-struct-debug-reduced */
  OPT_fenable_ = 652,                        /* -fenable- */
  OPT_fenable_assertions = 653,              /* -fenable-assertions */
  OPT_fenable_assertions_ = 654,             /* -fenable-assertions= */
  OPT_fencoding_ = 655,                      /* -fencoding= */
  OPT_fenforce_eh_specs = 656,               /* -fenforce-eh-specs */
  /* OPT_fenum_int_equiv = 657, */           /* -fenum-int-equiv */
  OPT_fexceptions = 658,                     /* -fexceptions */
  OPT_fexcess_precision_ = 659,              /* -fexcess-precision= */
  OPT_fexec_charset_ = 660,                  /* -fexec-charset= */
  OPT_fexpensive_optimizations = 661,        /* -fexpensive-optimizations */
  OPT_fext_numeric_literals = 662,           /* -fext-numeric-literals */
  OPT_fextdirs_ = 663,                       /* -fextdirs= */
  OPT_fextended_identifiers = 664,           /* -fextended-identifiers */
  OPT_fextern_tls_init = 665,                /* -fextern-tls-init */
  OPT_fexternal_blas = 666,                  /* -fexternal-blas */
  /* OPT_fexternal_templates = 667, */       /* -fexternal-templates */
  OPT_ff2c = 668,                            /* -ff2c */
  OPT_ffast_math = 669,                      /* -ffast-math */
  OPT_ffat_lto_objects = 670,                /* -ffat-lto-objects */
  OPT_ffilelist_file = 671,                  /* -ffilelist-file */
  OPT_ffinite_math_only = 672,               /* -ffinite-math-only */
  OPT_ffixed_ = 673,                         /* -ffixed- */
  OPT_ffixed_form = 674,                     /* -ffixed-form */
  OPT_ffixed_line_length_ = 675,             /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 676,         /* -ffixed-line-length-none */
  OPT_ffloat_store = 677,                    /* -ffloat-store */
  OPT_ffor_scope = 678,                      /* -ffor-scope */
  /* OPT_fforce_addr = 679, */               /* -fforce-addr */
  OPT_fforce_classes_archive_check = 680,    /* -fforce-classes-archive-check */
  OPT_fforward_propagate = 681,              /* -fforward-propagate */
  OPT_ffp_contract_ = 682,                   /* -ffp-contract= */
  OPT_ffpe_summary_ = 683,                   /* -ffpe-summary= */
  OPT_ffpe_trap_ = 684,                      /* -ffpe-trap= */
  OPT_ffree_form = 685,                      /* -ffree-form */
  OPT_ffree_line_length_ = 686,              /* -ffree-line-length- */
  OPT_ffree_line_length_none = 687,          /* -ffree-line-length-none */
  OPT_ffreestanding = 688,                   /* -ffreestanding */
  OPT_ffriend_injection = 689,               /* -ffriend-injection */
  OPT_ffrontend_optimize = 690,              /* -ffrontend-optimize */
  OPT_ffunction_cse = 691,                   /* -ffunction-cse */
  OPT_ffunction_sections = 692,              /* -ffunction-sections */
  OPT_fgcse = 693,                           /* -fgcse */
  OPT_fgcse_after_reload = 694,              /* -fgcse-after-reload */
  OPT_fgcse_las = 695,                       /* -fgcse-las */
  OPT_fgcse_lm = 696,                        /* -fgcse-lm */
  OPT_fgcse_sm = 697,                        /* -fgcse-sm */
  ...
  OPT_fgo_check_divide_overflow = 703,       /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 704,           /* -fgo-check-divide-zero */
  OPT_fgo_dump_ = 705,                       /* -fgo-dump- */
  OPT_fgo_optimize_ = 706,                   /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 707,                    /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 708,                     /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 709,       /* -fgo-relative-import-path= */
  OPT_fgraphite = 710,                       /* -fgraphite */
  OPT_fgraphite_identity = 711,              /* -fgraphite-identity */
  OPT_fguess_branch_probability = 712,       /* -fguess-branch-probability */
  /* OPT_fguiding_decls = 713, */            /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 714, */        /* -fhandle-exceptions */
  OPT_fhash_synchronization = 715,           /* -fhash-synchronization */
  /* OPT_fhelp = 716, */                     /* -fhelp */
  /* OPT_fhelp_ = 717, */                    /* -fhelp= */
  OPT_fhoist_adjacent_loads = 718,           /* -fhoist-adjacent-loads */
  /* OPT_fhonor_std = 719, */                /* -fhonor-std */
  OPT_fhosted = 720,                         /* -fhosted */
  /* OPT_fhuge_objects = 721, */             /* -fhuge-objects */
  OPT_fident = 722,                          /* -fident */
  OPT_fif_conversion = 723,                  /* -fif-conversion */
  OPT_fif_conversion2 = 724,                 /* -fif-conversion2 */
  OPT_fimplement_inlines = 725,              /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 726,      /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 727,                  /* -fimplicit-none */
  OPT_fimplicit_templates = 728,             /* -fimplicit-templates */
  OPT_findirect_classes = 729,               /* -findirect-classes */
  OPT_findirect_dispatch = 730,              /* -findirect-dispatch */
  OPT_findirect_inlining = 731,              /* -findirect-inlining */
  OPT_finhibit_size_directive = 732,         /* -finhibit-size-directive */
  OPT_finit_character_ = 733,                /* -finit-character= */
  ...
  OPT_fipa_cp = 753,                         /* -fipa-cp */
  OPT_fipa_cp_alignment = 754,               /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 755,                   /* -fipa-cp-clone */
  OPT_fipa_icf = 756,                        /* -fipa-icf */
  OPT_fipa_icf_functions = 757,              /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 758,              /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 759, */         /* -fipa-matrix-reorg */
  OPT_fipa_profile = 760,                    /* -fipa-profile */
  OPT_fipa_pta = 761,                        /* -fipa-pta */
  OPT_fipa_pure_const = 762,                 /* -fipa-pure-const */
  OPT_fipa_ra = 763,                         /* -fipa-ra */
  OPT_fipa_reference = 764,                  /* -fipa-reference */
  OPT_fipa_sra = 765,                        /* -fipa-sra */
  /* OPT_fipa_struct_reorg = 766, */         /* -fipa-struct-reorg */
  OPT_fira_algorithm_ = 767,                 /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 768,             /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 769,              /* -fira-loop-pressure */
  OPT_fira_region_ = 770,                    /* -fira-region= */
  OPT_fira_share_save_slots = 771,           /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 772,          /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 773,                   /* -fira-verbose= */
  OPT_fisolate_erroneous_paths_attribute = 774,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 775,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 776,               /* -fivar-visibility= */
  OPT_fivopts = 777,                         /* -fivopts */
  OPT_fjni = 778,                            /* -fjni */
  OPT_fjump_tables = 779,                    /* -fjump-tables */
  OPT_fkeep_inline_dllexport = 780,          /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 781,          /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 782,             /* -fkeep-static-consts */
  OPT_fkeep_static_functions = 783,          /* -fkeep-static-functions */
  /* OPT_flabels_ok = 784, */                /* -flabels-ok */
  OPT_flax_vector_conversions = 785,         /* -flax-vector-conversions */
  OPT_fleading_underscore = 786,             /* -fleading-underscore */
  OPT_flifetime_dse = 787,                   /* -flifetime-dse */
  OPT_flive_range_shrinkage = 788,           /* -flive-range-shrinkage */
  OPT_flocal_ivars = 789,                    /* -flocal-ivars */
  /* OPT_floop_block = 790, */               /* -floop-block */
  /* OPT_floop_flatten = 791, */             /* -floop-flatten */
  /* OPT_floop_interchange = 792, */         /* -floop-interchange */
  OPT_floop_nest_optimize = 793,             /* -floop-nest-optimize */
  /* OPT_floop_optimize = 794, */            /* -floop-optimize */
  OPT_floop_parallelize_all = 795,           /* -floop-parallelize-all */
  /* OPT_floop_strip_mine = 796, */          /* -floop-strip-mine */
  /* OPT_floop_unroll_and_jam = 797, */      /* -floop-unroll-and-jam */
  OPT_flra_remat = 798,                      /* -flra-remat */
  OPT_flto = 799,                            /* -flto */
  OPT_flto_compression_level_ = 800,         /* -flto-compression-level= */
  OPT_flto_odr_type_merging = 801,           /* -flto-odr-type-merging */
  OPT_flto_partition_ = 802,                 /* -flto-partition= */
  OPT_flto_report = 803,                     /* -flto-report */
  OPT_flto_report_wpa = 804,                 /* -flto-report-wpa */
  OPT_flto_ = 805,                           /* -flto= */
  OPT_fltrans = 806,                         /* -fltrans */
  OPT_fltrans_output_list_ = 807,            /* -fltrans-output-list= */
  OPT_fmain_ = 808,                          /* -fmain= */
  OPT_fmath_errno = 809,                     /* -fmath-errno */
  OPT_fmax_array_constructor_ = 810,         /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 811,                    /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 812,         /* -fmax-identifier-length= */
  OPT_fmax_stack_var_size_ = 813,            /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 814,          /* -fmax-subrecord-length= */
  OPT_fmem_report = 815,                     /* -fmem-report */
  OPT_fmem_report_wpa = 816,                 /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 817,            /* -fmerge-all-constants */
  OPT_fmerge_constants = 818,                /* -fmerge-constants */
  OPT_fmerge_debug_strings = 819,            /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 820,                /* -fmessage-length= */
  OPT_fmodule_private = 821,                 /* -fmodule-private */
  OPT_fmodulo_sched = 822,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 823,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 824,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 825,                  /* -fms-extensions */
  /* OPT_fmudflap = 826, */                  /* -fmudflap */
  /* OPT_fmudflapir = 827, */                /* -fmudflapir */
  /* OPT_fmudflapth = 828, */                /* -fmudflapth */
  /* OPT_fname_mangling_version_ = 829, */   /* -fname-mangling-version- */
  /* OPT_fnew_abi = 830, */                  /* -fnew-abi */
  OPT_fnext_runtime = 831,                   /* -fnext-runtime */
  OPT_fnil_receivers = 832,                  /* -fnil-receivers */
  /* OPT_fno_vect_cost_model = 833, */       /* -fno-vect-cost-model */
  OPT_fnon_call_exceptions = 834,            /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 835,               /* -fnonansi-builtins */
  /* OPT_fnonnull_objects = 836, */          /* -fnonnull-objects */
  OPT_fnothrow_opt = 837,                    /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 838,              /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 839,           /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 840,           /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 841,                /* -fobjc-exceptions */
  OPT_fobjc_gc = 842,                        /* -fobjc-gc */
  OPT_fobjc_nilcheck = 843,                  /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 844,           /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 845,                 /* -fobjc-std=objc1 */
  OPT_foffload_abi_ = 846,                   /* -foffload-abi= */
  OPT_foffload_ = 847,                       /* -foffload= */
  OPT_fomit_frame_pointer = 848,             /* -fomit-frame-pointer */
  OPT_fopenacc = 849,                        /* -fopenacc */
  ...
  OPT_foptimize_static_class_initialization = 857,/* -foptimize-static-class-initialization */
  OPT_foptimize_strlen = 858,                /* -foptimize-strlen */
  /* OPT_foptional_diags = 859, */           /* -foptional-diags */
  OPT_foutput_class_dir_ = 860,              /* -foutput-class-dir= */
  OPT_fpack_derived = 861,                   /* -fpack-derived */
  OPT_fpack_struct = 862,                    /* -fpack-struct */
  OPT_fpack_struct_ = 863,                   /* -fpack-struct= */
  OPT_fpartial_inlining = 864,               /* -fpartial-inlining */
  OPT_fpcc_struct_return = 865,              /* -fpcc-struct-return */
  OPT_fpch_deps = 866,                       /* -fpch-deps */
  OPT_fpch_preprocess = 867,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 868,                     /* -fpeel-loops */
  OPT_fpeephole = 869,                       /* -fpeephole */
  OPT_fpeephole2 = 870,                      /* -fpeephole2 */
  OPT_fpermissive = 871,                     /* -fpermissive */
  OPT_fpic = 872,                            /* -fpic */
  OPT_fpie = 873,                            /* -fpie */
  OPT_fplan9_extensions = 874,               /* -fplan9-extensions */
  OPT_fplt = 875,                            /* -fplt */
  OPT_fplugin_arg_ = 876,                    /* -fplugin-arg- */
  OPT_fplugin_ = 877,                        /* -fplugin= */
  OPT_fpost_ipa_mem_report = 878,            /* -fpost-ipa-mem-report */
  OPT_fpre_ipa_mem_report = 879,             /* -fpre-ipa-mem-report */
  OPT_fpredictive_commoning = 880,           /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 881,           /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 882,                   /* -fpreprocessed */
  OPT_fpretty_templates = 883,               /* -fpretty-templates */
  OPT_fprofile = 884,                        /* -fprofile */
  OPT_fprofile_arcs = 885,                   /* -fprofile-arcs */
  OPT_fprofile_correction = 886,             /* -fprofile-correction */
  OPT_fprofile_dir_ = 887,                   /* -fprofile-dir= */
  OPT_fprofile_generate = 888,               /* -fprofile-generate */
  OPT_fprofile_generate_ = 889,              /* -fprofile-generate= */
  OPT_fprofile_reorder_functions = 890,      /* -fprofile-reorder-functions */
  OPT_fprofile_report = 891,                 /* -fprofile-report */
  OPT_fprofile_use = 892,                    /* -fprofile-use */
  OPT_fprofile_use_ = 893,                   /* -fprofile-use= */
  OPT_fprofile_values = 894,                 /* -fprofile-values */
  OPT_fprotect_parens = 895,                 /* -fprotect-parens */
  OPT_frandom_seed = 896,                    /* -frandom-seed */
  OPT_frandom_seed_ = 897,                   /* -frandom-seed= */
  OPT_frange_check = 898,                    /* -frange-check */
  OPT_freal_4_real_10 = 899,                 /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 900,                 /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 901,                  /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 902,                 /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 903,                 /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 904,                  /* -freal-8-real-4 */
  OPT_frealloc_lhs = 905,                    /* -frealloc-lhs */
  OPT_freciprocal_math = 906,                /* -freciprocal-math */
  OPT_frecord_gcc_switches = 907,            /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 908,                /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 909,                /* -frecord-marker=8 */
  OPT_frecursive = 910,                      /* -frecursive */
  OPT_freduced_reflection = 911,             /* -freduced-reflection */
  OPT_free = 912,                            /* -free */
  OPT_freg_struct_return = 913,              /* -freg-struct-return */
  /* OPT_fregmove = 914, */                  /* -fregmove */
  OPT_frename_registers = 915,               /* -frename-registers */
  OPT_freorder_blocks = 916,                 /* -freorder-blocks */
  OPT_freorder_blocks_algorithm_ = 917,      /* -freorder-blocks-algorithm= */
  OPT_freorder_blocks_and_partition = 918,   /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 919,              /* -freorder-functions */
  OPT_frepack_arrays = 920,                  /* -frepack-arrays */
  OPT_freplace_objc_classes = 921,           /* -freplace-objc-classes */
  OPT_frepo = 922,                           /* -frepo */
  OPT_freport_bug = 923,                     /* -freport-bug */
  OPT_frequire_return_statement = 924,       /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 925,           /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 926, */           /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 927,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 928,                    /* -fresolution= */
  OPT_frounding_math = 929,                  /* -frounding-math */
  OPT_frtti = 930,                           /* -frtti */
  OPT_fsanitize_recover = 931,               /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 932,              /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 933,             /* -fsanitize-sections= */
  OPT_fsanitize_undefined_trap_on_error = 934,/* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 935,                      /* -fsanitize= */
  OPT_fsaw_java_file = 936,                  /* -fsaw-java-file */
  OPT_fsched_critical_path_heuristic = 937,  /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 938,      /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 939,          /* -fsched-group-heuristic */
  OPT_fsched_interblock = 940,               /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 941,      /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 942,                 /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 943,           /* -fsched-rank-heuristic */
  OPT_fsched_spec = 944,                     /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 945,      /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 946,                /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 947,      /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 948,            /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 949,        /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 950,       /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 951,           /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 952,                 /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 953,         /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 954, */        /* -fsched2-use-traces */
  OPT_fschedule_fusion = 955,                /* -fschedule-fusion */
  OPT_fschedule_insns = 956,                 /* -fschedule-insns */
  OPT_fschedule_insns2 = 957,                /* -fschedule-insns2 */
  OPT_fsecond_underscore = 958,              /* -fsecond-underscore */
  OPT_fsection_anchors = 959,                /* -fsection-anchors */
  /* OPT_fsee = 960, */                      /* -fsee */
  OPT_fsel_sched_pipelining = 961,           /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 962,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 963, /* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 964,           /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 965,          /* -fselective-scheduling2 */
  OPT_fsemantic_interposition = 966,         /* -fsemantic-interposition */
  OPT_fshort_double = 967,                   /* -fshort-double */
  OPT_fshort_enums = 968,                    /* -fshort-enums */
  OPT_fshort_wchar = 969,                    /* -fshort-wchar */
  OPT_fshow_column = 970,                    /* -fshow-column */
  OPT_fshrink_wrap = 971,                    /* -fshrink-wrap */
  OPT_fsign_zero = 972,                      /* -fsign-zero */
  OPT_fsignaling_nans = 973,                 /* -fsignaling-nans */
  OPT_fsigned_bitfields = 974,               /* -fsigned-bitfields */
  OPT_fsigned_char = 975,                    /* -fsigned-char */
  OPT_fsigned_zeros = 976,                   /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 977,               /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 978,      /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 979,             /* -fsized-deallocation */
  OPT_fsource_filename_ = 980,               /* -fsource-filename= */
  OPT_fsource_ = 981,                        /* -fsource= */
  OPT_fsplit_ivs_in_unroller = 982,          /* -fsplit-ivs-in-unroller */
  OPT_fsplit_stack = 983,                    /* -fsplit-stack */
  OPT_fsplit_wide_types = 984,               /* -fsplit-wide-types */
  /* OPT_fsquangle = 985, */                 /* -fsquangle */
  OPT_fssa_backprop = 986,                   /* -fssa-backprop */
  OPT_fssa_phiopt = 987,                     /* -fssa-phiopt */
  OPT_fstack_arrays = 988,                   /* -fstack-arrays */
  /* OPT_fstack_check = 989, */              /* -fstack-check */
  OPT_fstack_check_ = 990,                   /* -fstack-check= */
  OPT_fstack_limit = 991,                    /* -fstack-limit */
  OPT_fstack_limit_register_ = 992,          /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 993,            /* -fstack-limit-symbol= */
  OPT_fstack_protector = 994,                /* -fstack-protector */
  OPT_fstack_protector_all = 995,            /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 996,       /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 997,         /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 998,                   /* -fstack-reuse= */
  OPT_fstack_usage = 999,                    /* -fstack-usage */
  OPT_fstats = 1000,                         /* -fstats */
  OPT_fstdarg_opt = 1001,                    /* -fstdarg-opt */
  OPT_fstore_check = 1002,                   /* -fstore-check */
  /* OPT_fstrength_reduce = 1003, */         /* -fstrength-reduce */
  OPT_fstrict_aliasing = 1004,               /* -fstrict-aliasing */
  OPT_fstrict_enums = 1005,                  /* -fstrict-enums */
  OPT_fstrict_overflow = 1006,               /* -fstrict-overflow */
  /* OPT_fstrict_prototype = 1007, */        /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 1008,     /* -fstrict-volatile-bitfields */
  OPT_fsync_libcalls = 1009,                 /* -fsync-libcalls */
  OPT_fsyntax_only = 1010,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1011,                      /* -ftabstop= */
  /* OPT_ftarget_help = 1012, */             /* -ftarget-help */
  OPT_ftarget_ = 1013,                       /* -ftarget= */
  OPT_ftemplate_backtrace_limit_ = 1014,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1015, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1016,               /* -ftemplate-depth= */
  OPT_ftest_coverage = 1017,                 /* -ftest-coverage */
  /* OPT_fthis_is_variable = 1018, */        /* -fthis-is-variable */
  OPT_fthread_jumps = 1019,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1020,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1021,                   /* -ftime-report */
  OPT_ftls_model_ = 1022,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1023,              /* -ftoplevel-reorder */
  OPT_ftracer = 1024,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1025,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1026,        /* -ftrack-macro-expansion= */
  OPT_ftrapping_math = 1027,                 /* -ftrapping-math */
  OPT_ftrapv = 1028,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1029,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1030,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1031,                      /* -ftree-ccp */
  OPT_ftree_ch = 1032,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1033, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1034,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1035,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1036, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1037,                   /* -ftree-cselim */
  OPT_ftree_dce = 1038,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1039,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1040,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1041,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1042,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1043, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1044,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1045,          /* -ftree-loop-if-convert */
  OPT_ftree_loop_if_convert_stores = 1046,   /* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1047,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1048,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1049, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1050,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1051,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1052,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1053,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1054,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1055,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1056,                      /* -ftree-pre */
  OPT_ftree_pta = 1057,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1058,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1059, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1060,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1061,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1062,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1063,                     /* -ftree-slsr */
  OPT_ftree_sra = 1064,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1065, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1066, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1067,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1068,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1069,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1070, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1071,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1072, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1073,                      /* -ftree-vrp */
  OPT_funderscoring = 1074,                  /* -funderscoring */
  OPT_funit_at_a_time = 1075,                /* -funit-at-a-time */
  OPT_funroll_all_loops = 1076,              /* -funroll-all-loops */
  OPT_funroll_loops = 1077,                  /* -funroll-loops */
  OPT_funsafe_loop_optimizations = 1078,     /* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1079,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1080,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1081,                 /* -funsigned-char */
  OPT_funswitch_loops = 1082,                /* -funswitch-loops */
  OPT_funwind_tables = 1083,                 /* -funwind-tables */
  OPT_fuse_atomic_builtins = 1084,           /* -fuse-atomic-builtins */
  OPT_fuse_boehm_gc = 1085,                  /* -fuse-boehm-gc */
  OPT_fuse_cxa_atexit = 1086,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1087,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_divide_subroutine = 1088,         /* -fuse-divide-subroutine */
  OPT_fuse_ld_bfd = 1089,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1090,                   /* -fuse-ld=gold */
  OPT_fuse_linker_plugin = 1091,             /* -fuse-linker-plugin */
  OPT_fvar_tracking = 1092,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1093,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1094,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1095,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1096,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1097, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1098,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1099,                   /* -fverbose-asm */
  /* OPT_fversion = 1100, */                 /* -fversion */
  OPT_fvisibility_inlines_hidden = 1101,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1102,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1103,                   /* -fvisibility= */
  OPT_fvpt = 1104,                           /* -fvpt */
  /* OPT_fvtable_gc = 1105, */               /* -fvtable-gc */
  /* OPT_fvtable_thunks = 1106, */           /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1107,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1108,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1109,                     /* -fvtv-debug */
  OPT_fweak = 1110,                          /* -fweak */
  OPT_fweb = 1111,                           /* -fweb */
  /* OPT_fwhole_file = 1112, */              /* -fwhole-file */
  OPT_fwhole_program = 1113,                 /* -fwhole-program */
  OPT_fwide_exec_charset_ = 1114,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1115,             /* -fworking-directory */
  OPT_fwpa = 1116,                           /* -fwpa */
  OPT_fwpa_ = 1117,                          /* -fwpa= */
  OPT_fwrapv = 1118,                         /* -fwrapv */
  /* OPT_fxref = 1119, */                    /* -fxref */
  /* OPT_fzee = 1120, */                     /* -fzee */
  OPT_fzero_initialized_in_bss = 1121,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1122,                     /* -fzero-link */
  OPT_g = 1123,                              /* -g */
  OPT_gant = 1124,                           /* -gant */
  OPT_gcoff = 1125,                          /* -gcoff */
  OPT_gdwarf = 1126,                         /* -gdwarf */
  OPT_gdwarf_ = 1127,                        /* -gdwarf- */
  OPT_gen_decls = 1128,                      /* -gen-decls */
  OPT_ggdb = 1129,                           /* -ggdb */
  OPT_ggnu_pubnames = 1130,                  /* -ggnu-pubnames */
  OPT_gnat = 1131,                           /* -gnat */
  OPT_gnatO = 1132,                          /* -gnatO */
  OPT_gno_pubnames = 1133,                   /* -gno-pubnames */
  OPT_gno_record_gcc_switches = 1134,        /* -gno-record-gcc-switches */
  OPT_gno_split_dwarf = 1135,                /* -gno-split-dwarf */
  OPT_gno_strict_dwarf = 1136,               /* -gno-strict-dwarf */
  OPT_gpubnames = 1137,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1138,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1139,                   /* -gsplit-dwarf */
  OPT_gstabs = 1140,                         /* -gstabs */
  OPT_gstabs_ = 1141,                        /* -gstabs+ */
  OPT_gstrict_dwarf = 1142,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1143,                        /* -gtoggle */
  OPT_gvms = 1144,                           /* -gvms */
  OPT_gxcoff = 1145,                         /* -gxcoff */
  OPT_gxcoff_ = 1146,                        /* -gxcoff+ */
  OPT_gz = 1147,                             /* -gz */
  OPT_gz_ = 1148,                            /* -gz= */
  OPT_h = 1149,                              /* -h */
  OPT_idirafter = 1150,                      /* -idirafter */
  OPT_imacros = 1151,                        /* -imacros */
  OPT_imultiarch = 1152,                     /* -imultiarch */
  OPT_imultilib = 1153,                      /* -imultilib */
  OPT_include = 1154,                        /* -include */
  OPT_iplugindir_ = 1155,                    /* -iplugindir= */
  OPT_iprefix = 1156,                        /* -iprefix */
  OPT_iquote = 1157,                         /* -iquote */
  OPT_isysroot = 1158,                       /* -isysroot */
  OPT_isystem = 1159,                        /* -isystem */
  OPT_iwithprefix = 1160,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1161,              /* -iwithprefixbefore */
  OPT_k8 = 1162,                             /* -k8 */
  OPT_l = 1163,                              /* -l */
  OPT_lang_asm = 1164,                       /* -lang-asm */
  OPT_m128bit_long_double = 1165,            /* -m128bit-long-double */
  OPT_m16 = 1166,                            /* -m16 */
  OPT_m32 = 1167,                            /* -m32 */
  OPT_m3dnow = 1168,                         /* -m3dnow */
  OPT_m3dnowa = 1169,                        /* -m3dnowa */
  OPT_m64 = 1170,                            /* -m64 */
  OPT_m80387 = 1171,                         /* -m80387 */
  OPT_m8bit_idiv = 1172,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1173,             /* -m96bit-long-double */
  OPT_mabi_ = 1174,                          /* -mabi= */
  OPT_mabm = 1175,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1176,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1177,                 /* -maddress-mode= */
  OPT_madx = 1178,                           /* -madx */
  OPT_maes = 1179,                           /* -maes */
  OPT_malign_data_ = 1180,                   /* -malign-data= */
  OPT_malign_double = 1181,                  /* -malign-double */
  OPT_malign_functions_ = 1182,              /* -malign-functions= */
  OPT_malign_jumps_ = 1183,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1184,                  /* -malign-loops= */
  OPT_malign_stringops = 1185,               /* -malign-stringops */
  OPT_mandroid = 1186,                       /* -mandroid */
  OPT_march_ = 1187,                         /* -march= */
  OPT_masm_ = 1188,                          /* -masm= */
  OPT_mavx = 1189,                           /* -mavx */
  OPT_mavx2 = 1190,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1191,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1192,  /* -mavx256-split-unaligned-store */
  OPT_mavx512bw = 1193,                      /* -mavx512bw */
  OPT_mavx512cd = 1194,                      /* -mavx512cd */
  OPT_mavx512dq = 1195,                      /* -mavx512dq */
  OPT_mavx512er = 1196,                      /* -mavx512er */
  OPT_mavx512f = 1197,                       /* -mavx512f */
  OPT_mavx512ifma = 1198,                    /* -mavx512ifma */
  OPT_mavx512pf = 1199,                      /* -mavx512pf */
  OPT_mavx512vbmi = 1200,                    /* -mavx512vbmi */
  OPT_mavx512vl = 1201,                      /* -mavx512vl */
  OPT_mbionic = 1202,                        /* -mbionic */
  OPT_mbmi = 1203,                           /* -mbmi */
  OPT_mbmi2 = 1204,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1205,                  /* -mbranch-cost= */
  OPT_mcld = 1206,                           /* -mcld */
  OPT_mclflushopt = 1207,                    /* -mclflushopt */
  OPT_mclwb = 1208,                          /* -mclwb */
  OPT_mclzero = 1209,                        /* -mclzero */
  OPT_mcmodel_ = 1210,                       /* -mcmodel= */
  /* OPT_mcpu_ = 1211, */                    /* -mcpu= */
  OPT_mcrc32 = 1212,                         /* -mcrc32 */
  OPT_mcx16 = 1213,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1214,            /* -mdispatch-scheduler */
  OPT_mdump_tune_features = 1215,            /* -mdump-tune-features */
  OPT_mf16c = 1216,                          /* -mf16c */
  OPT_mfancy_math_387 = 1217,                /* -mfancy-math-387 */
  OPT_mfentry = 1218,                        /* -mfentry */
  OPT_mfma = 1219,                           /* -mfma */
  OPT_mfma4 = 1220,                          /* -mfma4 */
  OPT_mforce_drap = 1221,                    /* -mforce-drap */
  OPT_mfp_ret_in_387 = 1222,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1223,                       /* -mfpmath= */
  OPT_mfsgsbase = 1224,                      /* -mfsgsbase */
  /* OPT_mfused_madd = 1225, */              /* -mfused-madd */
  OPT_mfxsr = 1226,                          /* -mfxsr */
  OPT_mglibc = 1227,                         /* -mglibc */
  OPT_mhard_float = 1228,                    /* -mhard-float */
  OPT_mhle = 1229,                           /* -mhle */
  OPT_miamcu = 1230,                         /* -miamcu */
  OPT_mieee_fp = 1231,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1232,      /* -mincoming-stack-boundary= */
  OPT_minline_all_stringops = 1233,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1234,  /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 1235, */            /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 1236,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1237,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1238,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1239,                /* -mlong-double-80 */
  OPT_mlwp = 1240,                           /* -mlwp */
  OPT_mlzcnt = 1241,                         /* -mlzcnt */
  OPT_mmemcpy_strategy_ = 1242,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1243,              /* -mmemset-strategy= */
  OPT_mmmx = 1244,                           /* -mmmx */
  OPT_mmovbe = 1245,                         /* -mmovbe */
  OPT_mmpx = 1246,                           /* -mmpx */
  OPT_mms_bitfields = 1247,                  /* -mms-bitfields */
  OPT_mmusl = 1248,                          /* -mmusl */
  OPT_mmwaitx = 1249,                        /* -mmwaitx */
  OPT_mno_align_stringops = 1250,            /* -mno-align-stringops */
  OPT_mno_default = 1251,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1252,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1253,                  /* -mno-push-args */
  OPT_mno_red_zone = 1254,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1255,                       /* -mno-sse4 */
  OPT_mnop_mcount = 1256,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 1257,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1258,                          /* -mpc32 */
  OPT_mpc64 = 1259,                          /* -mpc64 */
  OPT_mpc80 = 1260,                          /* -mpc80 */
  OPT_mpclmul = 1261,                        /* -mpclmul */
  OPT_mpcommit = 1262,                       /* -mpcommit */
  OPT_mpopcnt = 1263,                        /* -mpopcnt */
  OPT_mprefer_avx128 = 1264,                 /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 1265,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1266,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1267,                        /* -mprfchw */
  OPT_mpush_args = 1268,                     /* -mpush-args */
  ...
  OPT_msha = 1279,                           /* -msha */
  OPT_mskip_rax_setup = 1280,                /* -mskip-rax-setup */
  OPT_msoft_float = 1281,                    /* -msoft-float */
  OPT_msse = 1282,                           /* -msse */
  OPT_msse2 = 1283,                          /* -msse2 */
  OPT_msse2avx = 1284,                       /* -msse2avx */
  OPT_msse3 = 1285,                          /* -msse3 */
  OPT_msse4 = 1286,                          /* -msse4 */
  OPT_msse4_1 = 1287,                        /* -msse4.1 */
  OPT_msse4_2 = 1288,                        /* -msse4.2 */
  OPT_msse4a = 1289,                         /* -msse4a */
  /* OPT_msse5 = 1290, */                    /* -msse5 */
  OPT_msseregparm = 1291,                    /* -msseregparm */
  OPT_mssse3 = 1292,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1293,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_ = 1294,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1295,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1296,            /* -mstringop-strategy= */
  OPT_mstv = 1297,                           /* -mstv */
  OPT_mtbm = 1298,                           /* -mtbm */
  OPT_mtls_dialect_ = 1299,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1300,           /* -mtls-direct-seg-refs */
  OPT_mtune_ctrl_ = 1301,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1302,                         /* -mtune= */
  OPT_muclibc = 1303,                        /* -muclibc */
  OPT_mveclibabi_ = 1304,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1305,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1306,                    /* -mvzeroupper */
  OPT_mx32 = 1307,                           /* -mx32 */
  OPT_mxop = 1308,                           /* -mxop */
  OPT_mxsave = 1309,                         /* -mxsave */
  OPT_mxsavec = 1310,                        /* -mxsavec */
  OPT_mxsaveopt = 1311,                      /* -mxsaveopt */
  OPT_mxsaves = 1312,                        /* -mxsaves */
  OPT_n = 1313,                              /* -n */
  OPT_no_canonical_prefixes = 1314,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1315,              /* -no-integrated-cpp */
  OPT_no_pie = 1316,                         /* -no-pie */
  OPT_nocpp = 1317,                          /* -nocpp */
  OPT_nodefaultlibs = 1318,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1319,                   /* -nostartfiles */
  OPT_nostdinc = 1320,                       /* -nostdinc */
  OPT_nostdinc__ = 1321,                     /* -nostdinc++ */
  OPT_nostdlib = 1322,                       /* -nostdlib */
  OPT_o = 1323,                              /* -o */
  OPT_p = 1324,                              /* -p */
  OPT_pass_exit_codes = 1325,                /* -pass-exit-codes */
  /* OPT_pedantic = 1326, */                 /* -pedantic */
  OPT_pedantic_errors = 1327,                /* -pedantic-errors */
  OPT_pg = 1328,                             /* -pg */
  OPT_pie = 1329,                            /* -pie */
  OPT_pipe = 1330,                           /* -pipe */
  OPT_posix = 1331,                          /* -posix */
  OPT_print_file_name_ = 1332,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1333,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1334,          /* -print-multi-directory */
  OPT_print_multi_lib = 1335,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1336,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1337,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1338,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1339,               /* -print-prog-name= */
  OPT_print_search_dirs = 1340,              /* -print-search-dirs */
  OPT_print_sysroot = 1341,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1342,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1343,                        /* -profile */
  OPT_pthread = 1344,                        /* -pthread */
  OPT_quiet = 1345,                          /* -quiet */
  OPT_r = 1346,                              /* -r */
  OPT_rdynamic = 1347,                       /* -rdynamic */
  OPT_remap = 1348,                          /* -remap */
  OPT_s = 1349,                              /* -s */
  OPT_s_bc_abi = 1350,                       /* -s-bc-abi */
  OPT_save_temps = 1351,                     /* -save-temps */
  OPT_save_temps_ = 1352,                    /* -save-temps= */
  OPT_shared = 1353,                         /* -shared */
  OPT_shared_libgcc = 1354,                  /* -shared-libgcc */
  /* OPT_specs = 1355, */                    /* -specs */
  OPT_specs_ = 1356,                         /* -specs= */
  OPT_static = 1357,                         /* -static */
  OPT_static_libasan = 1358,                 /* -static-libasan */
  OPT_static_libgcc = 1359,                  /* -static-libgcc */
  OPT_static_libgcj = 1360,                  /* -static-libgcj */
  OPT_static_libgfortran = 1361,             /* -static-libgfortran */
  OPT_static_libgo = 1362,                   /* -static-libgo */
  OPT_static_liblsan = 1363,                 /* -static-liblsan */
  OPT_static_libmpx = 1364,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1365,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1366,               /* -static-libstdc++ */
  OPT_static_libtsan = 1367,                 /* -static-libtsan */
  OPT_static_libubsan = 1368,                /* -static-libubsan */
  /* OPT_std_c__03 = 1369, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1370, */                /* -std=c++0x */
  OPT_std_c__11 = 1371,                      /* -std=c++11 */
  OPT_std_c__14 = 1372,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1373, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1374, */                /* -std=c++1y */
  OPT_std_c__1z = 1375,                      /* -std=c++1z */
  OPT_std_c__98 = 1376,                      /* -std=c++98 */
  OPT_std_c11 = 1377,                        /* -std=c11 */
  ...
  OPT_std_gnu__98 = 1395,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1396,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1397, */                /* -std=gnu1x */
  ...
  OPT_std_legacy = 1407,                     /* -std=legacy */
  OPT_symbolic = 1408,                       /* -symbolic */
  OPT_t = 1409,                              /* -t */
  OPT_time = 1410,                           /* -time */
  OPT_time_ = 1411,                          /* -time= */
  OPT_tno_android_cc = 1412,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1413,                 /* -tno-android-ld */
