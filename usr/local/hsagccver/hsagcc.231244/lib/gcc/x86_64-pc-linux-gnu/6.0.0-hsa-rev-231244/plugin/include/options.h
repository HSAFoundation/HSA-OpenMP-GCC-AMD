...
enum opt_code
{
  ...
  OPT_Wpmf_conversions = 341,                /* -Wpmf-conversions */
  OPT_Wpointer_arith = 342,                  /* -Wpointer-arith */
  ...
  OPT_Wraw = 349,                            /* -Wraw */
  OPT_Wreal_q_constant = 350,                /* -Wreal-q-constant */
  OPT_Wrealloc_lhs = 351,                    /* -Wrealloc-lhs */
  OPT_Wrealloc_lhs_all = 352,                /* -Wrealloc-lhs-all */
  OPT_Wredundant_decls = 353,                /* -Wredundant-decls */
  OPT_Wredundant_modifiers = 354,            /* -Wredundant-modifiers */
  OPT_Wreorder = 355,                        /* -Wreorder */
  ...
  OPT_Wserial = 361,                         /* -Wserial */
  OPT_Wshadow = 362,                         /* -Wshadow */
  OPT_Wshadow_ivar = 363,                    /* -Wshadow-ivar */
  OPT_Wshift_count_negative = 364,           /* -Wshift-count-negative */
  OPT_Wshift_count_overflow = 365,           /* -Wshift-count-overflow */
  OPT_Wshift_negative_value = 366,           /* -Wshift-negative-value */
  /* OPT_Wshift_overflow = 367, */           /* -Wshift-overflow */
  OPT_Wshift_overflow_ = 368,                /* -Wshift-overflow= */
  OPT_Wsign_compare = 369,                   /* -Wsign-compare */
  OPT_Wsign_conversion = 370,                /* -Wsign-conversion */
  OPT_Wsign_promo = 371,                     /* -Wsign-promo */
  OPT_Wsized_deallocation = 372,             /* -Wsized-deallocation */
  OPT_Wsizeof_array_argument = 373,          /* -Wsizeof-array-argument */
  OPT_Wsizeof_pointer_memaccess = 374,       /* -Wsizeof-pointer-memaccess */
  OPT_Wspecial_param_hiding = 375,           /* -Wspecial-param-hiding */
  OPT_Wstack_protector = 376,                /* -Wstack-protector */
  OPT_Wstack_usage_ = 377,                   /* -Wstack-usage= */
  OPT_Wstatic_access = 378,                  /* -Wstatic-access */
  OPT_Wstatic_receiver = 379,                /* -Wstatic-receiver */
  ...
  OPT_Wsubobject_linkage = 387,              /* -Wsubobject-linkage */
  OPT_Wsuggest_attribute_const = 388,        /* -Wsuggest-attribute=const */
  OPT_Wsuggest_attribute_format = 389,       /* -Wsuggest-attribute=format */
  OPT_Wsuggest_attribute_noreturn = 390,     /* -Wsuggest-attribute=noreturn */
  OPT_Wsuggest_attribute_pure = 391,         /* -Wsuggest-attribute=pure */
  OPT_Wsuggest_final_methods = 392,          /* -Wsuggest-final-methods */
  OPT_Wsuggest_final_types = 393,            /* -Wsuggest-final-types */
  OPT_Wsuggest_override = 394,               /* -Wsuggest-override */
  OPT_Wsuppress = 395,                       /* -Wsuppress */
  OPT_Wsurprising = 396,                     /* -Wsurprising */
  OPT_Wswitch = 397,                         /* -Wswitch */
  OPT_Wswitch_bool = 398,                    /* -Wswitch-bool */
  OPT_Wswitch_default = 399,                 /* -Wswitch-default */
  OPT_Wswitch_enum = 400,                    /* -Wswitch-enum */
  OPT_Wsync_nand = 401,                      /* -Wsync-nand */
  OPT_Wsynth = 402,                          /* -Wsynth */
  OPT_Wsynthetic_access = 403,               /* -Wsynthetic-access */
  OPT_Wsystem_headers = 404,                 /* -Wsystem-headers */
  OPT_Wtabs = 405,                           /* -Wtabs */
  OPT_Wtarget_lifetime = 406,                /* -Wtarget-lifetime */
  OPT_Wtasks = 407,                          /* -Wtasks */
  OPT_Wtautological_compare = 408,           /* -Wtautological-compare */
  OPT_Wtemplates = 409,                      /* -Wtemplates */
  OPT_Wterminate = 410,                      /* -Wterminate */
  OPT_Wtraditional = 411,                    /* -Wtraditional */
  OPT_Wtraditional_conversion = 412,         /* -Wtraditional-conversion */
  OPT_Wtrampolines = 413,                    /* -Wtrampolines */
  OPT_Wtrigraphs = 414,                      /* -Wtrigraphs */
  OPT_Wtype_hiding = 415,                    /* -Wtype-hiding */
  OPT_Wtype_limits = 416,                    /* -Wtype-limits */
  OPT_Wuncheck = 417,                        /* -Wuncheck */
  OPT_Wundeclared_selector = 418,            /* -Wundeclared-selector */
  OPT_Wundef = 419,                          /* -Wundef */
  OPT_Wunderflow = 420,                      /* -Wunderflow */
  OPT_Wuninitialized = 421,                  /* -Wuninitialized */
  OPT_Wunknown_pragmas = 422,                /* -Wunknown-pragmas */
  OPT_Wunnecessary_else = 423,               /* -Wunnecessary-else */
  OPT_Wunqualified_field = 424,              /* -Wunqualified-field */
  ...
  OPT_Wunused_argument = 429,                /* -Wunused-argument */
  OPT_Wunused_but_set_parameter = 430,       /* -Wunused-but-set-parameter */
  OPT_Wunused_but_set_variable = 431,        /* -Wunused-but-set-variable */
  OPT_Wunused_const_variable = 432,          /* -Wunused-const-variable */
  OPT_Wunused_dummy_argument = 433,          /* -Wunused-dummy-argument */
  OPT_Wunused_function = 434,                /* -Wunused-function */
  OPT_Wunused_import = 435,                  /* -Wunused-import */
  OPT_Wunused_label = 436,                   /* -Wunused-label */
  OPT_Wunused_local = 437,                   /* -Wunused-local */
  ...
  OPT_Wunused_private = 441,                 /* -Wunused-private */
  OPT_Wunused_result = 442,                  /* -Wunused-result */
  OPT_Wunused_thrown = 443,                  /* -Wunused-thrown */
  OPT_Wunused_value = 444,                   /* -Wunused-value */
  OPT_Wunused_variable = 445,                /* -Wunused-variable */
  OPT_Wuse_without_only = 446,               /* -Wuse-without-only */
  OPT_Wuseless_cast = 447,                   /* -Wuseless-cast */
  OPT_Wuseless_type_check = 448,             /* -Wuseless-type-check */
  OPT_Wvarargs = 449,                        /* -Wvarargs */
  OPT_Wvarargs_cast = 450,                   /* -Wvarargs-cast */
  OPT_Wvariadic_macros = 451,                /* -Wvariadic-macros */
  OPT_Wvector_operation_performance = 452,   /* -Wvector-operation-performance */
  OPT_Wvirtual_inheritance = 453,            /* -Wvirtual-inheritance */
  OPT_Wvirtual_move_assign = 454,            /* -Wvirtual-move-assign */
  OPT_Wvla = 455,                            /* -Wvla */
  OPT_Wvolatile_register_var = 456,          /* -Wvolatile-register-var */
  OPT_Wwarning_token = 457,                  /* -Wwarning-token */
  OPT_Wwrite_strings = 458,                  /* -Wwrite-strings */
  OPT_Wzero_as_null_pointer_constant = 459,  /* -Wzero-as-null-pointer-constant */
  OPT_Wzerotrip = 460,                       /* -Wzerotrip */
  OPT_Xassembler = 461,                      /* -Xassembler */
  OPT_Xlinker = 462,                         /* -Xlinker */
  OPT_Xpreprocessor = 463,                   /* -Xpreprocessor */
  OPT_Z = 464,                               /* -Z */
  OPT_ansi = 465,                            /* -ansi */
  OPT_aux_info = 466,                        /* -aux-info */
  /* OPT_aux_info_ = 467, */                 /* -aux-info= */
  OPT_auxbase = 468,                         /* -auxbase */
  OPT_auxbase_strip = 469,                   /* -auxbase-strip */
  /* OPT_bootclasspath = 470, */             /* -bootclasspath */
  OPT_c = 471,                               /* -c */
  /* OPT_classpath = 472, */                 /* -classpath */
  OPT_coverage = 473,                        /* -coverage */
  OPT_cpp = 474,                             /* -cpp */
  OPT_cpp_ = 475,                            /* -cpp= */
  OPT_d = 476,                               /* -d */
  OPT_dumpbase = 477,                        /* -dumpbase */
  OPT_dumpdir = 478,                         /* -dumpdir */
  OPT_dumpmachine = 479,                     /* -dumpmachine */
  OPT_dumpspecs = 480,                       /* -dumpspecs */
  OPT_dumpversion = 481,                     /* -dumpversion */
  OPT_e = 482,                               /* -e */
  /* OPT_encoding = 483, */                  /* -encoding */
  OPT_export_dynamic = 484,                  /* -export-dynamic */
  OPT_extdirs = 485,                         /* -extdirs */
  /* OPT_fCLASSPATH_ = 486, */               /* -fCLASSPATH= */
  OPT_fPIC = 487,                            /* -fPIC */
  OPT_fPIE = 488,                            /* -fPIE */
  OPT_fRTS_ = 489,                           /* -fRTS= */
  OPT_fabi_compat_version_ = 490,            /* -fabi-compat-version= */
  OPT_fabi_version_ = 491,                   /* -fabi-version= */
  OPT_faccess_control = 492,                 /* -faccess-control */
  OPT_fada_spec_parent_ = 493,               /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 494,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 495,  /* -faggressive-loop-optimizations */
  OPT_falign_commons = 496,                  /* -falign-commons */
  OPT_falign_functions = 497,                /* -falign-functions */
  OPT_falign_functions_ = 498,               /* -falign-functions= */
  OPT_falign_jumps = 499,                    /* -falign-jumps */
  OPT_falign_jumps_ = 500,                   /* -falign-jumps= */
  OPT_falign_labels = 501,                   /* -falign-labels */
  OPT_falign_labels_ = 502,                  /* -falign-labels= */
  OPT_falign_loops = 503,                    /* -falign-loops */
  OPT_falign_loops_ = 504,                   /* -falign-loops= */
  OPT_fall_intrinsics = 505,                 /* -fall-intrinsics */
  /* OPT_fall_virtual = 506, */              /* -fall-virtual */
  OPT_fallow_leading_underscore = 507,       /* -fallow-leading-underscore */
  OPT_fallow_parameterless_variadic_functions = 508,/* -fallow-parameterless-variadic-functions */
  /* OPT_falt_external_templates = 509, */   /* -falt-external-templates */
  /* OPT_fargument_alias = 510, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 511, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 512, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 513, */  /* -fargument-noalias-global */
  OPT_fasan_shadow_offset_ = 514,            /* -fasan-shadow-offset= */
  OPT_fasm = 515,                            /* -fasm */
  OPT_fassert = 516,                         /* -fassert */
  OPT_fassociative_math = 517,               /* -fassociative-math */
  OPT_fassume_compiled = 518,                /* -fassume-compiled */
  OPT_fassume_compiled_ = 519,               /* -fassume-compiled= */
  ...
  OPT_fbuiltin_printf = 540,                 /* -fbuiltin-printf */
  OPT_fcall_saved_ = 541,                    /* -fcall-saved- */
  OPT_fcall_used_ = 542,                     /* -fcall-used- */
  OPT_fcaller_saves = 543,                   /* -fcaller-saves */
  OPT_fcanonical_system_headers = 544,       /* -fcanonical-system-headers */
  OPT_fcheck_array_temporaries = 545,        /* -fcheck-array-temporaries */
  OPT_fcheck_data_deps = 546,                /* -fcheck-data-deps */
  OPT_fcheck_new = 547,                      /* -fcheck-new */
  OPT_fcheck_pointer_bounds = 548,           /* -fcheck-pointer-bounds */
  OPT_fcheck_references = 549,               /* -fcheck-references */
  OPT_fcheck_ = 550,                         /* -fcheck= */
  OPT_fchecking = 551,                       /* -fchecking */
  OPT_fchkp_check_incomplete_type = 552,     /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 553,                /* -fchkp-check-read */
  OPT_fchkp_check_write = 554,               /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 555,/* -fchkp-first-field-has-own-bounds */
  OPT_fchkp_instrument_calls = 556,          /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 557,    /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 558,             /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 559, /* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 560,                  /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 561,              /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 562,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 563, /* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 564,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 565,         /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 566,   /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 567,              /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 568,/* -fchkp-zero-input-bounds-for-main */
  OPT_fcilkplus = 569,                       /* -fcilkplus */
  OPT_fclasspath_ = 570,                     /* -fclasspath= */
  OPT_fcoarray_ = 571,                       /* -fcoarray= */
  OPT_fcombine_stack_adjustments = 572,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 573,                         /* -fcommon */
  OPT_fcompare_debug = 574,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 575,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 576,                 /* -fcompare-debug= */
  OPT_fcompare_elim = 577,                   /* -fcompare-elim */
  OPT_fcompile_resource_ = 578,              /* -fcompile-resource= */
  OPT_fconcepts = 579,                       /* -fconcepts */
  OPT_fcond_mismatch = 580,                  /* -fcond-mismatch */
  OPT_fconserve_space = 581,                 /* -fconserve-space */
  OPT_fconserve_stack = 582,                 /* -fconserve-stack */
  OPT_fconstant_string_class_ = 583,         /* -fconstant-string-class= */
  OPT_fconstexpr_depth_ = 584,               /* -fconstexpr-depth= */
  OPT_fconvert_ = 585,                       /* -fconvert= */
  OPT_fcprop_registers = 586,                /* -fcprop-registers */
  OPT_fcray_pointer = 587,                   /* -fcray-pointer */
  OPT_fcrossjumping = 588,                   /* -fcrossjumping */
  OPT_fcse_follow_jumps = 589,               /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 590, */          /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 591,               /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 592,               /* -fcx-limited-range */
  OPT_fd_lines_as_code = 593,                /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 594,            /* -fd-lines-as-comments */
  OPT_fdata_sections = 595,                  /* -fdata-sections */
  OPT_fdbg_cnt_list = 596,                   /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 597,                       /* -fdbg-cnt= */
  OPT_fdce = 598,                            /* -fdce */
  OPT_fdebug_cpp = 599,                      /* -fdebug-cpp */
  OPT_fdebug_prefix_map_ = 600,              /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 601,            /* -fdebug-types-section */
  OPT_fdeclone_ctor_dtor = 602,              /* -fdeclone-ctor-dtor */
  OPT_fdeduce_init_list = 603,               /* -fdeduce-init-list */
  OPT_fdefault_double_8 = 604,               /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 605, */           /* -fdefault-inline */
  OPT_fdefault_integer_8 = 606,              /* -fdefault-integer-8 */
  OPT_fdefault_real_8 = 607,                 /* -fdefault-real-8 */
  OPT_fdefer_pop = 608,                      /* -fdefer-pop */
  OPT_fdelayed_branch = 609,                 /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 610,         /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 611,     /* -fdelete-null-pointer-checks */
  OPT_fdevirtualize = 612,                   /* -fdevirtualize */
  OPT_fdevirtualize_at_ltrans = 613,         /* -fdevirtualize-at-ltrans */
  OPT_fdevirtualize_speculatively = 614,     /* -fdevirtualize-speculatively */
  /* OPT_fdiagnostics_color = 615, */        /* -fdiagnostics-color */
  OPT_fdiagnostics_color_ = 616,             /* -fdiagnostics-color= */
  OPT_fdiagnostics_show_caret = 617,         /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_location_ = 618,     /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 619,        /* -fdiagnostics-show-option */
  OPT_fdirectives_only = 620,                /* -fdirectives-only */
  OPT_fdisable_ = 621,                       /* -fdisable- */
  OPT_fdisable_assertions = 622,             /* -fdisable-assertions */
  OPT_fdisable_assertions_ = 623,            /* -fdisable-assertions= */
  ...
  OPT_feliminate_dwarf2_dups = 645,          /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 646, /* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 647,   /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 648,        /* -femit-class-debug-always */
  OPT_femit_class_file = 649,                /* -femit-class-file */
  OPT_femit_class_files = 650,               /* -femit-class-files */
  OPT_femit_struct_debug_baseonly = 651,     /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 652,    /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 653,      /* -femit-struct-debug-reduced */
  OPT_fenable_ = 654,                        /* -fenable- */
  OPT_fenable_assertions = 655,              /* -fenable-assertions */
  OPT_fenable_assertions_ = 656,             /* -fenable-assertions= */
  OPT_fencoding_ = 657,                      /* -fencoding= */
  OPT_fenforce_eh_specs = 658,               /* -fenforce-eh-specs */
  /* OPT_fenum_int_equiv = 659, */           /* -fenum-int-equiv */
  OPT_fexceptions = 660,                     /* -fexceptions */
  OPT_fexcess_precision_ = 661,              /* -fexcess-precision= */
  OPT_fexec_charset_ = 662,                  /* -fexec-charset= */
  OPT_fexpensive_optimizations = 663,        /* -fexpensive-optimizations */
  OPT_fext_numeric_literals = 664,           /* -fext-numeric-literals */
  OPT_fextdirs_ = 665,                       /* -fextdirs= */
  OPT_fextended_identifiers = 666,           /* -fextended-identifiers */
  OPT_fextern_tls_init = 667,                /* -fextern-tls-init */
  OPT_fexternal_blas = 668,                  /* -fexternal-blas */
  /* OPT_fexternal_templates = 669, */       /* -fexternal-templates */
  OPT_ff2c = 670,                            /* -ff2c */
  OPT_ffast_math = 671,                      /* -ffast-math */
  OPT_ffat_lto_objects = 672,                /* -ffat-lto-objects */
  OPT_ffilelist_file = 673,                  /* -ffilelist-file */
  OPT_ffinite_math_only = 674,               /* -ffinite-math-only */
  OPT_ffixed_ = 675,                         /* -ffixed- */
  OPT_ffixed_form = 676,                     /* -ffixed-form */
  OPT_ffixed_line_length_ = 677,             /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 678,         /* -ffixed-line-length-none */
  OPT_ffloat_store = 679,                    /* -ffloat-store */
  OPT_ffor_scope = 680,                      /* -ffor-scope */
  /* OPT_fforce_addr = 681, */               /* -fforce-addr */
  OPT_fforce_classes_archive_check = 682,    /* -fforce-classes-archive-check */
  OPT_fforward_propagate = 683,              /* -fforward-propagate */
  OPT_ffp_contract_ = 684,                   /* -ffp-contract= */
  OPT_ffpe_summary_ = 685,                   /* -ffpe-summary= */
  OPT_ffpe_trap_ = 686,                      /* -ffpe-trap= */
  OPT_ffree_form = 687,                      /* -ffree-form */
  OPT_ffree_line_length_ = 688,              /* -ffree-line-length- */
  OPT_ffree_line_length_none = 689,          /* -ffree-line-length-none */
  OPT_ffreestanding = 690,                   /* -ffreestanding */
  OPT_ffriend_injection = 691,               /* -ffriend-injection */
  OPT_ffrontend_optimize = 692,              /* -ffrontend-optimize */
  OPT_ffunction_cse = 693,                   /* -ffunction-cse */
  OPT_ffunction_sections = 694,              /* -ffunction-sections */
  OPT_fgcse = 695,                           /* -fgcse */
  OPT_fgcse_after_reload = 696,              /* -fgcse-after-reload */
  OPT_fgcse_las = 697,                       /* -fgcse-las */
  OPT_fgcse_lm = 698,                        /* -fgcse-lm */
  OPT_fgcse_sm = 699,                        /* -fgcse-sm */
  OPT_fgnu_keywords = 700,                   /* -fgnu-keywords */
  OPT_fgnu_runtime = 701,                    /* -fgnu-runtime */
  OPT_fgnu_tm = 702,                         /* -fgnu-tm */
  OPT_fgnu_unique = 703,                     /* -fgnu-unique */
  OPT_fgnu89_inline = 704,                   /* -fgnu89-inline */
  OPT_fgo_check_divide_overflow = 705,       /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 706,           /* -fgo-check-divide-zero */
  ...
  OPT_fhash_synchronization = 717,           /* -fhash-synchronization */
  /* OPT_fhelp = 718, */                     /* -fhelp */
  /* OPT_fhelp_ = 719, */                    /* -fhelp= */
  OPT_fhoist_adjacent_loads = 720,           /* -fhoist-adjacent-loads */
  /* OPT_fhonor_std = 721, */                /* -fhonor-std */
  OPT_fhosted = 722,                         /* -fhosted */
  /* OPT_fhuge_objects = 723, */             /* -fhuge-objects */
  OPT_fident = 724,                          /* -fident */
  OPT_fif_conversion = 725,                  /* -fif-conversion */
  OPT_fif_conversion2 = 726,                 /* -fif-conversion2 */
  OPT_fimplement_inlines = 727,              /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 728,      /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 729,                  /* -fimplicit-none */
  OPT_fimplicit_templates = 730,             /* -fimplicit-templates */
  OPT_findirect_classes = 731,               /* -findirect-classes */
  OPT_findirect_dispatch = 732,              /* -findirect-dispatch */
  OPT_findirect_inlining = 733,              /* -findirect-inlining */
  OPT_finhibit_size_directive = 734,         /* -finhibit-size-directive */
  OPT_finit_character_ = 735,                /* -finit-character= */
  ...
  OPT_fipa_cp = 755,                         /* -fipa-cp */
  OPT_fipa_cp_alignment = 756,               /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 757,                   /* -fipa-cp-clone */
  OPT_fipa_icf = 758,                        /* -fipa-icf */
  OPT_fipa_icf_functions = 759,              /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 760,              /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 761, */         /* -fipa-matrix-reorg */
  OPT_fipa_profile = 762,                    /* -fipa-profile */
  OPT_fipa_pta = 763,                        /* -fipa-pta */
  OPT_fipa_pure_const = 764,                 /* -fipa-pure-const */
  OPT_fipa_ra = 765,                         /* -fipa-ra */
  OPT_fipa_reference = 766,                  /* -fipa-reference */
  OPT_fipa_sra = 767,                        /* -fipa-sra */
  /* OPT_fipa_struct_reorg = 768, */         /* -fipa-struct-reorg */
  ...
  OPT_fjni = 780,                            /* -fjni */
  OPT_fjump_tables = 781,                    /* -fjump-tables */
  ...
  OPT_flinker_output_ = 790,                 /* -flinker-output= */
  OPT_flive_range_shrinkage = 791,           /* -flive-range-shrinkage */
  OPT_flocal_ivars = 792,                    /* -flocal-ivars */
  /* OPT_floop_block = 793, */               /* -floop-block */
  /* OPT_floop_flatten = 794, */             /* -floop-flatten */
  /* OPT_floop_interchange = 795, */         /* -floop-interchange */
  OPT_floop_nest_optimize = 796,             /* -floop-nest-optimize */
  /* OPT_floop_optimize = 797, */            /* -floop-optimize */
  OPT_floop_parallelize_all = 798,           /* -floop-parallelize-all */
  /* OPT_floop_strip_mine = 799, */          /* -floop-strip-mine */
  /* OPT_floop_unroll_and_jam = 800, */      /* -floop-unroll-and-jam */
  OPT_flra_remat = 801,                      /* -flra-remat */
  OPT_flto = 802,                            /* -flto */
  OPT_flto_compression_level_ = 803,         /* -flto-compression-level= */
  OPT_flto_odr_type_merging = 804,           /* -flto-odr-type-merging */
  OPT_flto_partition_ = 805,                 /* -flto-partition= */
  OPT_flto_report = 806,                     /* -flto-report */
  OPT_flto_report_wpa = 807,                 /* -flto-report-wpa */
  OPT_flto_ = 808,                           /* -flto= */
  OPT_fltrans = 809,                         /* -fltrans */
  OPT_fltrans_output_list_ = 810,            /* -fltrans-output-list= */
  OPT_fmain_ = 811,                          /* -fmain= */
  OPT_fmath_errno = 812,                     /* -fmath-errno */
  OPT_fmax_array_constructor_ = 813,         /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 814,                    /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 815,         /* -fmax-identifier-length= */
  OPT_fmax_stack_var_size_ = 816,            /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 817,          /* -fmax-subrecord-length= */
  OPT_fmem_report = 818,                     /* -fmem-report */
  OPT_fmem_report_wpa = 819,                 /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 820,            /* -fmerge-all-constants */
  OPT_fmerge_constants = 821,                /* -fmerge-constants */
  OPT_fmerge_debug_strings = 822,            /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 823,                /* -fmessage-length= */
  OPT_fmodule_private = 824,                 /* -fmodule-private */
  OPT_fmodulo_sched = 825,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 826,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 827,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 828,                  /* -fms-extensions */
  /* OPT_fmudflap = 829, */                  /* -fmudflap */
  /* OPT_fmudflapir = 830, */                /* -fmudflapir */
  /* OPT_fmudflapth = 831, */                /* -fmudflapth */
  /* OPT_fname_mangling_version_ = 832, */   /* -fname-mangling-version- */
  /* OPT_fnew_abi = 833, */                  /* -fnew-abi */
  OPT_fnext_runtime = 834,                   /* -fnext-runtime */
  OPT_fnil_receivers = 835,                  /* -fnil-receivers */
  /* OPT_fno_vect_cost_model = 836, */       /* -fno-vect-cost-model */
  OPT_fnon_call_exceptions = 837,            /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 838,               /* -fnonansi-builtins */
  /* OPT_fnonnull_objects = 839, */          /* -fnonnull-objects */
  OPT_fnothrow_opt = 840,                    /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 841,              /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 842,           /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 843,           /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 844,                /* -fobjc-exceptions */
  OPT_fobjc_gc = 845,                        /* -fobjc-gc */
  OPT_fobjc_nilcheck = 846,                  /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 847,           /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 848,                 /* -fobjc-std=objc1 */
  OPT_foffload_abi_ = 849,                   /* -foffload-abi= */
  OPT_foffload_ = 850,                       /* -foffload= */
  OPT_fomit_frame_pointer = 851,             /* -fomit-frame-pointer */
  OPT_fopenacc = 852,                        /* -fopenacc */
  ...
  OPT_foptimize_static_class_initialization = 860,/* -foptimize-static-class-initialization */
  OPT_foptimize_strlen = 861,                /* -foptimize-strlen */
  /* OPT_foptional_diags = 862, */           /* -foptional-diags */
  OPT_foutput_class_dir_ = 863,              /* -foutput-class-dir= */
  OPT_fpack_derived = 864,                   /* -fpack-derived */
  OPT_fpack_struct = 865,                    /* -fpack-struct */
  OPT_fpack_struct_ = 866,                   /* -fpack-struct= */
  OPT_fpartial_inlining = 867,               /* -fpartial-inlining */
  OPT_fpcc_struct_return = 868,              /* -fpcc-struct-return */
  OPT_fpch_deps = 869,                       /* -fpch-deps */
  OPT_fpch_preprocess = 870,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 871,                     /* -fpeel-loops */
  OPT_fpeephole = 872,                       /* -fpeephole */
  OPT_fpeephole2 = 873,                      /* -fpeephole2 */
  OPT_fpermissive = 874,                     /* -fpermissive */
  OPT_fpic = 875,                            /* -fpic */
  OPT_fpie = 876,                            /* -fpie */
  ...
  OPT_fprofile = 887,                        /* -fprofile */
  OPT_fprofile_arcs = 888,                   /* -fprofile-arcs */
  OPT_fprofile_correction = 889,             /* -fprofile-correction */
  OPT_fprofile_dir_ = 890,                   /* -fprofile-dir= */
  OPT_fprofile_generate = 891,               /* -fprofile-generate */
  OPT_fprofile_generate_ = 892,              /* -fprofile-generate= */
  OPT_fprofile_reorder_functions = 893,      /* -fprofile-reorder-functions */
  OPT_fprofile_report = 894,                 /* -fprofile-report */
  OPT_fprofile_use = 895,                    /* -fprofile-use */
  OPT_fprofile_use_ = 896,                   /* -fprofile-use= */
  OPT_fprofile_values = 897,                 /* -fprofile-values */
  OPT_fprotect_parens = 898,                 /* -fprotect-parens */
  OPT_frandom_seed = 899,                    /* -frandom-seed */
  OPT_frandom_seed_ = 900,                   /* -frandom-seed= */
  OPT_frange_check = 901,                    /* -frange-check */
  OPT_freal_4_real_10 = 902,                 /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 903,                 /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 904,                  /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 905,                 /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 906,                 /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 907,                  /* -freal-8-real-4 */
  OPT_frealloc_lhs = 908,                    /* -frealloc-lhs */
  OPT_freciprocal_math = 909,                /* -freciprocal-math */
  OPT_frecord_gcc_switches = 910,            /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 911,                /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 912,                /* -frecord-marker=8 */
  OPT_frecursive = 913,                      /* -frecursive */
  OPT_freduced_reflection = 914,             /* -freduced-reflection */
  OPT_free = 915,                            /* -free */
  OPT_freg_struct_return = 916,              /* -freg-struct-return */
  /* OPT_fregmove = 917, */                  /* -fregmove */
  OPT_frename_registers = 918,               /* -frename-registers */
  OPT_freorder_blocks = 919,                 /* -freorder-blocks */
  OPT_freorder_blocks_algorithm_ = 920,      /* -freorder-blocks-algorithm= */
  OPT_freorder_blocks_and_partition = 921,   /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 922,              /* -freorder-functions */
  OPT_frepack_arrays = 923,                  /* -frepack-arrays */
  OPT_freplace_objc_classes = 924,           /* -freplace-objc-classes */
  OPT_frepo = 925,                           /* -frepo */
  OPT_freport_bug = 926,                     /* -freport-bug */
  OPT_frequire_return_statement = 927,       /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 928,           /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 929, */           /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 930,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 931,                    /* -fresolution= */
  OPT_frounding_math = 932,                  /* -frounding-math */
  OPT_frtti = 933,                           /* -frtti */
  OPT_fsanitize_recover = 934,               /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 935,              /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 936,             /* -fsanitize-sections= */
  OPT_fsanitize_undefined_trap_on_error = 937,/* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 938,                      /* -fsanitize= */
  OPT_fsaw_java_file = 939,                  /* -fsaw-java-file */
  OPT_fsched_critical_path_heuristic = 940,  /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 941,      /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 942,          /* -fsched-group-heuristic */
  OPT_fsched_interblock = 943,               /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 944,      /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 945,                 /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 946,           /* -fsched-rank-heuristic */
  OPT_fsched_spec = 947,                     /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 948,      /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 949,                /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 950,      /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 951,            /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 952,        /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 953,       /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 954,           /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 955,                 /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 956,         /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 957, */        /* -fsched2-use-traces */
  OPT_fschedule_fusion = 958,                /* -fschedule-fusion */
  OPT_fschedule_insns = 959,                 /* -fschedule-insns */
  OPT_fschedule_insns2 = 960,                /* -fschedule-insns2 */
  OPT_fsecond_underscore = 961,              /* -fsecond-underscore */
  OPT_fsection_anchors = 962,                /* -fsection-anchors */
  /* OPT_fsee = 963, */                      /* -fsee */
  OPT_fsel_sched_pipelining = 964,           /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 965,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 966, /* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 967,           /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 968,          /* -fselective-scheduling2 */
  OPT_fsemantic_interposition = 969,         /* -fsemantic-interposition */
  OPT_fshort_double = 970,                   /* -fshort-double */
  OPT_fshort_enums = 971,                    /* -fshort-enums */
  OPT_fshort_wchar = 972,                    /* -fshort-wchar */
  OPT_fshow_column = 973,                    /* -fshow-column */
  OPT_fshrink_wrap = 974,                    /* -fshrink-wrap */
  OPT_fsign_zero = 975,                      /* -fsign-zero */
  OPT_fsignaling_nans = 976,                 /* -fsignaling-nans */
  OPT_fsigned_bitfields = 977,               /* -fsigned-bitfields */
  OPT_fsigned_char = 978,                    /* -fsigned-char */
  OPT_fsigned_zeros = 979,                   /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 980,               /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 981,      /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 982,             /* -fsized-deallocation */
  OPT_fsource_filename_ = 983,               /* -fsource-filename= */
  OPT_fsource_ = 984,                        /* -fsource= */
  OPT_fsplit_ivs_in_unroller = 985,          /* -fsplit-ivs-in-unroller */
  OPT_fsplit_paths = 986,                    /* -fsplit-paths */
  OPT_fsplit_stack = 987,                    /* -fsplit-stack */
  OPT_fsplit_wide_types = 988,               /* -fsplit-wide-types */
  /* OPT_fsquangle = 989, */                 /* -fsquangle */
  OPT_fssa_backprop = 990,                   /* -fssa-backprop */
  OPT_fssa_phiopt = 991,                     /* -fssa-phiopt */
  OPT_fsso_struct_ = 992,                    /* -fsso-struct= */
  OPT_fstack_arrays = 993,                   /* -fstack-arrays */
  /* OPT_fstack_check = 994, */              /* -fstack-check */
  OPT_fstack_check_ = 995,                   /* -fstack-check= */
  OPT_fstack_limit = 996,                    /* -fstack-limit */
  OPT_fstack_limit_register_ = 997,          /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 998,            /* -fstack-limit-symbol= */
  OPT_fstack_protector = 999,                /* -fstack-protector */
  OPT_fstack_protector_all = 1000,           /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 1001,      /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 1002,        /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 1003,                  /* -fstack-reuse= */
  OPT_fstack_usage = 1004,                   /* -fstack-usage */
  OPT_fstats = 1005,                         /* -fstats */
  OPT_fstdarg_opt = 1006,                    /* -fstdarg-opt */
  OPT_fstore_check = 1007,                   /* -fstore-check */
  /* OPT_fstrength_reduce = 1008, */         /* -fstrength-reduce */
  OPT_fstrict_aliasing = 1009,               /* -fstrict-aliasing */
  OPT_fstrict_enums = 1010,                  /* -fstrict-enums */
  OPT_fstrict_overflow = 1011,               /* -fstrict-overflow */
  /* OPT_fstrict_prototype = 1012, */        /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 1013,     /* -fstrict-volatile-bitfields */
  OPT_fsync_libcalls = 1014,                 /* -fsync-libcalls */
  OPT_fsyntax_only = 1015,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1016,                      /* -ftabstop= */
  /* OPT_ftarget_help = 1017, */             /* -ftarget-help */
  OPT_ftarget_ = 1018,                       /* -ftarget= */
  OPT_ftemplate_backtrace_limit_ = 1019,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1020, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1021,               /* -ftemplate-depth= */
  OPT_ftest_coverage = 1022,                 /* -ftest-coverage */
  /* OPT_fthis_is_variable = 1023, */        /* -fthis-is-variable */
  OPT_fthread_jumps = 1024,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1025,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1026,                   /* -ftime-report */
  OPT_ftls_model_ = 1027,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1028,              /* -ftoplevel-reorder */
  OPT_ftracer = 1029,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1030,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1031,        /* -ftrack-macro-expansion= */
  OPT_ftrapping_math = 1032,                 /* -ftrapping-math */
  OPT_ftrapv = 1033,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1034,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1035,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1036,                      /* -ftree-ccp */
  OPT_ftree_ch = 1037,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1038, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1039,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1040,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1041, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1042,                   /* -ftree-cselim */
  OPT_ftree_dce = 1043,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1044,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1045,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1046,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1047,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1048, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1049,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1050,          /* -ftree-loop-if-convert */
  OPT_ftree_loop_if_convert_stores = 1051,   /* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1052,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1053,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1054, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1055,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1056,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1057,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1058,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1059,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1060,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1061,                      /* -ftree-pre */
  OPT_ftree_pta = 1062,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1063,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1064, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1065,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1066,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1067,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1068,                     /* -ftree-slsr */
  OPT_ftree_sra = 1069,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1070, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1071, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1072,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1073,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1074,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1075, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1076,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1077, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1078,                      /* -ftree-vrp */
  OPT_funderscoring = 1079,                  /* -funderscoring */
  OPT_funit_at_a_time = 1080,                /* -funit-at-a-time */
  OPT_funroll_all_loops = 1081,              /* -funroll-all-loops */
  OPT_funroll_loops = 1082,                  /* -funroll-loops */
  OPT_funsafe_loop_optimizations = 1083,     /* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1084,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1085,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1086,                 /* -funsigned-char */
  OPT_funswitch_loops = 1087,                /* -funswitch-loops */
  OPT_funwind_tables = 1088,                 /* -funwind-tables */
  OPT_fuse_atomic_builtins = 1089,           /* -fuse-atomic-builtins */
  OPT_fuse_boehm_gc = 1090,                  /* -fuse-boehm-gc */
  OPT_fuse_cxa_atexit = 1091,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1092,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_divide_subroutine = 1093,         /* -fuse-divide-subroutine */
  OPT_fuse_ld_bfd = 1094,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1095,                   /* -fuse-ld=gold */
  OPT_fuse_linker_plugin = 1096,             /* -fuse-linker-plugin */
  OPT_fvar_tracking = 1097,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1098,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1099,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1100,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1101,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1102, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1103,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1104,                   /* -fverbose-asm */
  /* OPT_fversion = 1105, */                 /* -fversion */
  OPT_fvisibility_inlines_hidden = 1106,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1107,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1108,                   /* -fvisibility= */
  OPT_fvpt = 1109,                           /* -fvpt */
  /* OPT_fvtable_gc = 1110, */               /* -fvtable-gc */
  /* OPT_fvtable_thunks = 1111, */           /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1112,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1113,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1114,                     /* -fvtv-debug */
  OPT_fweak = 1115,                          /* -fweak */
  OPT_fweb = 1116,                           /* -fweb */
  /* OPT_fwhole_file = 1117, */              /* -fwhole-file */
  OPT_fwhole_program = 1118,                 /* -fwhole-program */
  OPT_fwide_exec_charset_ = 1119,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1120,             /* -fworking-directory */
  OPT_fwpa = 1121,                           /* -fwpa */
  OPT_fwpa_ = 1122,                          /* -fwpa= */
  OPT_fwrapv = 1123,                         /* -fwrapv */
  /* OPT_fxref = 1124, */                    /* -fxref */
  /* OPT_fzee = 1125, */                     /* -fzee */
  OPT_fzero_initialized_in_bss = 1126,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1127,                     /* -fzero-link */
  OPT_g = 1128,                              /* -g */
  OPT_gant = 1129,                           /* -gant */
  OPT_gcoff = 1130,                          /* -gcoff */
  OPT_gdwarf = 1131,                         /* -gdwarf */
  OPT_gdwarf_ = 1132,                        /* -gdwarf- */
  OPT_gen_decls = 1133,                      /* -gen-decls */
  OPT_ggdb = 1134,                           /* -ggdb */
  OPT_ggnu_pubnames = 1135,                  /* -ggnu-pubnames */
  OPT_gnat = 1136,                           /* -gnat */
  OPT_gnatO = 1137,                          /* -gnatO */
  OPT_gno_pubnames = 1138,                   /* -gno-pubnames */
  OPT_gno_record_gcc_switches = 1139,        /* -gno-record-gcc-switches */
  OPT_gno_split_dwarf = 1140,                /* -gno-split-dwarf */
  OPT_gno_strict_dwarf = 1141,               /* -gno-strict-dwarf */
  OPT_gpubnames = 1142,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1143,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1144,                   /* -gsplit-dwarf */
  OPT_gstabs = 1145,                         /* -gstabs */
  OPT_gstabs_ = 1146,                        /* -gstabs+ */
  OPT_gstrict_dwarf = 1147,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1148,                        /* -gtoggle */
  OPT_gvms = 1149,                           /* -gvms */
  OPT_gxcoff = 1150,                         /* -gxcoff */
  OPT_gxcoff_ = 1151,                        /* -gxcoff+ */
  OPT_gz = 1152,                             /* -gz */
  OPT_gz_ = 1153,                            /* -gz= */
  OPT_h = 1154,                              /* -h */
  OPT_idirafter = 1155,                      /* -idirafter */
  OPT_imacros = 1156,                        /* -imacros */
  OPT_imultiarch = 1157,                     /* -imultiarch */
  OPT_imultilib = 1158,                      /* -imultilib */
  OPT_include = 1159,                        /* -include */
  OPT_iplugindir_ = 1160,                    /* -iplugindir= */
  OPT_iprefix = 1161,                        /* -iprefix */
  OPT_iquote = 1162,                         /* -iquote */
  OPT_isysroot = 1163,                       /* -isysroot */
  OPT_isystem = 1164,                        /* -isystem */
  OPT_iwithprefix = 1165,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1166,              /* -iwithprefixbefore */
  OPT_k8 = 1167,                             /* -k8 */
  OPT_l = 1168,                              /* -l */
  OPT_lang_asm = 1169,                       /* -lang-asm */
  OPT_m128bit_long_double = 1170,            /* -m128bit-long-double */
  OPT_m16 = 1171,                            /* -m16 */
  OPT_m32 = 1172,                            /* -m32 */
  OPT_m3dnow = 1173,                         /* -m3dnow */
  OPT_m3dnowa = 1174,                        /* -m3dnowa */
  OPT_m64 = 1175,                            /* -m64 */
  OPT_m80387 = 1176,                         /* -m80387 */
  OPT_m8bit_idiv = 1177,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1178,             /* -m96bit-long-double */
  OPT_mabi_ = 1179,                          /* -mabi= */
  OPT_mabm = 1180,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1181,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1182,                 /* -maddress-mode= */
  OPT_madx = 1183,                           /* -madx */
  OPT_maes = 1184,                           /* -maes */
  OPT_malign_data_ = 1185,                   /* -malign-data= */
  OPT_malign_double = 1186,                  /* -malign-double */
  OPT_malign_functions_ = 1187,              /* -malign-functions= */
  OPT_malign_jumps_ = 1188,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1189,                  /* -malign-loops= */
  OPT_malign_stringops = 1190,               /* -malign-stringops */
  OPT_mandroid = 1191,                       /* -mandroid */
  OPT_march_ = 1192,                         /* -march= */
  OPT_masm_ = 1193,                          /* -masm= */
  OPT_mavx = 1194,                           /* -mavx */
  OPT_mavx2 = 1195,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1196,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1197,  /* -mavx256-split-unaligned-store */
  OPT_mavx512bw = 1198,                      /* -mavx512bw */
  OPT_mavx512cd = 1199,                      /* -mavx512cd */
  OPT_mavx512dq = 1200,                      /* -mavx512dq */
  OPT_mavx512er = 1201,                      /* -mavx512er */
  OPT_mavx512f = 1202,                       /* -mavx512f */
  OPT_mavx512ifma = 1203,                    /* -mavx512ifma */
  OPT_mavx512pf = 1204,                      /* -mavx512pf */
  OPT_mavx512vbmi = 1205,                    /* -mavx512vbmi */
  OPT_mavx512vl = 1206,                      /* -mavx512vl */
  OPT_mbionic = 1207,                        /* -mbionic */
  OPT_mbmi = 1208,                           /* -mbmi */
  OPT_mbmi2 = 1209,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1210,                  /* -mbranch-cost= */
  OPT_mcld = 1211,                           /* -mcld */
  OPT_mclflushopt = 1212,                    /* -mclflushopt */
  OPT_mclwb = 1213,                          /* -mclwb */
  OPT_mclzero = 1214,                        /* -mclzero */
  OPT_mcmodel_ = 1215,                       /* -mcmodel= */
  /* OPT_mcpu_ = 1216, */                    /* -mcpu= */
  OPT_mcrc32 = 1217,                         /* -mcrc32 */
  OPT_mcx16 = 1218,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1219,            /* -mdispatch-scheduler */
  OPT_mdump_tune_features = 1220,            /* -mdump-tune-features */
  OPT_mf16c = 1221,                          /* -mf16c */
  OPT_mfancy_math_387 = 1222,                /* -mfancy-math-387 */
  OPT_mfentry = 1223,                        /* -mfentry */
  OPT_mfma = 1224,                           /* -mfma */
  OPT_mfma4 = 1225,                          /* -mfma4 */
  OPT_mforce_drap = 1226,                    /* -mforce-drap */
  OPT_mfp_ret_in_387 = 1227,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1228,                       /* -mfpmath= */
  OPT_mfsgsbase = 1229,                      /* -mfsgsbase */
  /* OPT_mfused_madd = 1230, */              /* -mfused-madd */
  OPT_mfxsr = 1231,                          /* -mfxsr */
  OPT_mglibc = 1232,                         /* -mglibc */
  OPT_mhard_float = 1233,                    /* -mhard-float */
  OPT_mhle = 1234,                           /* -mhle */
  OPT_miamcu = 1235,                         /* -miamcu */
  OPT_mieee_fp = 1236,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1237,      /* -mincoming-stack-boundary= */
  OPT_minline_all_stringops = 1238,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1239,  /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 1240, */            /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 1241,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1242,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1243,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1244,                /* -mlong-double-80 */
  OPT_mlwp = 1245,                           /* -mlwp */
  OPT_mlzcnt = 1246,                         /* -mlzcnt */
  OPT_mmemcpy_strategy_ = 1247,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1248,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 1249,                  /* -mmitigate-rop */
  OPT_mmmx = 1250,                           /* -mmmx */
  OPT_mmovbe = 1251,                         /* -mmovbe */
  OPT_mmpx = 1252,                           /* -mmpx */
  OPT_mms_bitfields = 1253,                  /* -mms-bitfields */
  OPT_mmusl = 1254,                          /* -mmusl */
  OPT_mmwaitx = 1255,                        /* -mmwaitx */
  OPT_mno_align_stringops = 1256,            /* -mno-align-stringops */
  OPT_mno_default = 1257,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1258,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1259,                  /* -mno-push-args */
  OPT_mno_red_zone = 1260,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1261,                       /* -mno-sse4 */
  OPT_mnop_mcount = 1262,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 1263,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1264,                          /* -mpc32 */
  OPT_mpc64 = 1265,                          /* -mpc64 */
  OPT_mpc80 = 1266,                          /* -mpc80 */
  OPT_mpclmul = 1267,                        /* -mpclmul */
  OPT_mpcommit = 1268,                       /* -mpcommit */
  OPT_mpopcnt = 1269,                        /* -mpopcnt */
  OPT_mprefer_avx128 = 1270,                 /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 1271,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1272,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1273,                        /* -mprfchw */
  OPT_mpush_args = 1274,                     /* -mpush-args */
  OPT_mrdrnd = 1275,                         /* -mrdrnd */
  OPT_mrdseed = 1276,                        /* -mrdseed */
  OPT_mrecip = 1277,                         /* -mrecip */
  OPT_mrecip_ = 1278,                        /* -mrecip= */
  OPT_mrecord_mcount = 1279,                 /* -mrecord-mcount */
  OPT_mred_zone = 1280,                      /* -mred-zone */
  OPT_mregparm_ = 1281,                      /* -mregparm= */
  OPT_mrtd = 1282,                           /* -mrtd */
  OPT_mrtm = 1283,                           /* -mrtm */
  OPT_msahf = 1284,                          /* -msahf */
  OPT_msha = 1285,                           /* -msha */
  OPT_mskip_rax_setup = 1286,                /* -mskip-rax-setup */
  OPT_msoft_float = 1287,                    /* -msoft-float */
  OPT_msse = 1288,                           /* -msse */
  OPT_msse2 = 1289,                          /* -msse2 */
  OPT_msse2avx = 1290,                       /* -msse2avx */
  OPT_msse3 = 1291,                          /* -msse3 */
  OPT_msse4 = 1292,                          /* -msse4 */
  OPT_msse4_1 = 1293,                        /* -msse4.1 */
  OPT_msse4_2 = 1294,                        /* -msse4.2 */
  OPT_msse4a = 1295,                         /* -msse4a */
  /* OPT_msse5 = 1296, */                    /* -msse5 */
  OPT_msseregparm = 1297,                    /* -msseregparm */
  OPT_mssse3 = 1298,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1299,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_ = 1300,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1301,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1302,            /* -mstringop-strategy= */
  OPT_mstv = 1303,                           /* -mstv */
  OPT_mtbm = 1304,                           /* -mtbm */
  OPT_mtls_dialect_ = 1305,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1306,           /* -mtls-direct-seg-refs */
  OPT_mtune_ctrl_ = 1307,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1308,                         /* -mtune= */
  OPT_muclibc = 1309,                        /* -muclibc */
  OPT_mveclibabi_ = 1310,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1311,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1312,                    /* -mvzeroupper */
  OPT_mx32 = 1313,                           /* -mx32 */
  OPT_mxop = 1314,                           /* -mxop */
  OPT_mxsave = 1315,                         /* -mxsave */
  OPT_mxsavec = 1316,                        /* -mxsavec */
  OPT_mxsaveopt = 1317,                      /* -mxsaveopt */
  OPT_mxsaves = 1318,                        /* -mxsaves */
  OPT_n = 1319,                              /* -n */
  ...
  OPT_nostartfiles = 1325,                   /* -nostartfiles */
  OPT_nostdinc = 1326,                       /* -nostdinc */
  OPT_nostdinc__ = 1327,                     /* -nostdinc++ */
  OPT_nostdlib = 1328,                       /* -nostdlib */
  OPT_o = 1329,                              /* -o */
  OPT_p = 1330,                              /* -p */
  OPT_pass_exit_codes = 1331,                /* -pass-exit-codes */
  /* OPT_pedantic = 1332, */                 /* -pedantic */
  OPT_pedantic_errors = 1333,                /* -pedantic-errors */
  OPT_pg = 1334,                             /* -pg */
  OPT_pie = 1335,                            /* -pie */
  OPT_pipe = 1336,                           /* -pipe */
  OPT_posix = 1337,                          /* -posix */
  OPT_print_file_name_ = 1338,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1339,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1340,          /* -print-multi-directory */
  OPT_print_multi_lib = 1341,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1342,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1343,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1344,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1345,               /* -print-prog-name= */
  OPT_print_search_dirs = 1346,              /* -print-search-dirs */
  OPT_print_sysroot = 1347,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1348,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1349,                        /* -profile */
  OPT_pthread = 1350,                        /* -pthread */
  OPT_quiet = 1351,                          /* -quiet */
  OPT_r = 1352,                              /* -r */
  OPT_rdynamic = 1353,                       /* -rdynamic */
  OPT_remap = 1354,                          /* -remap */
  OPT_s = 1355,                              /* -s */
  OPT_s_bc_abi = 1356,                       /* -s-bc-abi */
  OPT_save_temps = 1357,                     /* -save-temps */
  OPT_save_temps_ = 1358,                    /* -save-temps= */
  OPT_shared = 1359,                         /* -shared */
  OPT_shared_libgcc = 1360,                  /* -shared-libgcc */
  /* OPT_specs = 1361, */                    /* -specs */
  OPT_specs_ = 1362,                         /* -specs= */
  OPT_static = 1363,                         /* -static */
  OPT_static_libasan = 1364,                 /* -static-libasan */
  OPT_static_libgcc = 1365,                  /* -static-libgcc */
  OPT_static_libgcj = 1366,                  /* -static-libgcj */
  ...
  OPT_static_libstdc__ = 1372,               /* -static-libstdc++ */
  OPT_static_libtsan = 1373,                 /* -static-libtsan */
  OPT_static_libubsan = 1374,                /* -static-libubsan */
  /* OPT_std_c__03 = 1375, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1376, */                /* -std=c++0x */
  OPT_std_c__11 = 1377,                      /* -std=c++11 */
  OPT_std_c__14 = 1378,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1379, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1380, */                /* -std=c++1y */
  OPT_std_c__1z = 1381,                      /* -std=c++1z */
  OPT_std_c__98 = 1382,                      /* -std=c++98 */
  OPT_std_c11 = 1383,                        /* -std=c11 */
  /* OPT_std_c1x = 1384, */                  /* -std=c1x */
  /* OPT_std_c89 = 1385, */                  /* -std=c89 */
  OPT_std_c90 = 1386,                        /* -std=c90 */
  OPT_std_c99 = 1387,                        /* -std=c99 */
  /* OPT_std_c9x = 1388, */                  /* -std=c9x */
  OPT_std_f2003 = 1389,                      /* -std=f2003 */
  OPT_std_f2008 = 1390,                      /* -std=f2008 */
  OPT_std_f2008ts = 1391,                    /* -std=f2008ts */
  OPT_std_f95 = 1392,                        /* -std=f95 */
  OPT_std_gnu = 1393,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1394, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1395, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1396,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1397,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1398, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1399, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1400,                    /* -std=gnu++1z */
  OPT_std_gnu__98 = 1401,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1402,                      /* -std=gnu11 */
  ...
  OPT_time = 1416,                           /* -time */
  OPT_time_ = 1417,                          /* -time= */
  OPT_tno_android_cc = 1418,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1419,                 /* -tno-android-ld */
